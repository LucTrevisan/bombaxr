...
import { l as AbstractAudioNode, n as _AudioAnalyzer, o as _GetVolumeAudioProperty, s as _GetVolumeAudioSubNode, u as AbstractNamedAudioNode } from "./webAudioBaseSubGraph-DlOLx-lf.js";
//#region node_modules/@babylonjs/core/AudioV2/abstractAudio/abstractSound.js
/**
...
var AbstractSound = class extends AbstractNamedAudioNode {
	...
	*/
	resume() {
		...
		const it = this._instances.values();
		for (let next = it.next(); !next.done; next = it.next()) next.value.resume();
		this._state = 3;
	}
	...
	_stopExcessInstances() {
		if (this.maxInstances < Infinity) {
			...
			const it = this._instances.values();
			for (let i = 0; i < numberOfInstancesToStop; i++) it.next().value.stop();
		}
	}
};
//#endregion
//#region node_modules/@babylonjs/core/AudioV2/abstractAudio/abstractSoundInstance.js
/** @internal */
...
//#endregion
//#region node_modules/@babylonjs/core/AudioV2/audioUtils.js
...
//#endregion
export { AbstractSound as i, _FileExtensionRegex as n, _AbstractSoundInstance as r, _CleanUrl as t };

//# sourceMappingURL=audioUtils-DASASPG-.js.map