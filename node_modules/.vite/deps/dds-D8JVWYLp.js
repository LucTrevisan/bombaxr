...
import { i as FromHalfFloat, s as ToHalfFloat, t as CubeMapToSphericalPolynomialTools } from "./cubemapToSphericalPolynomial-CYDqs8Y8.js";
import "./abstractEngine.cubeTexture-EyIwYqvD.js";
...
var DDSTools = class DDSTools {
	...
	*/
	...
	static _GetLuminanceArrayBuffer(width, height, dataOffset, dataLength, arrayBuffer) {
		...
		let index = 0;
		for (let y = 0; y < height; y++) for (let x = 0; x < width; x++) {
			byteArray[index] = srcData[x + y * width];
			index++;
		}
		return byteArray;
	}
...
//#endregion
export { DDSTools as t };

//# sourceMappingURL=dds-D8JVWYLp.js.map