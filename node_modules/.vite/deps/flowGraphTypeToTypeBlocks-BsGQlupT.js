...
import { A as FlowGraphInteger, d as RichTypeBoolean, m as RichTypeFlowGraphInteger, v as RichTypeNumber } from "./flowGraphBlock-Cu7z1xvN.js";
	...
	constructor(config) {
		super(RichTypeNumber, RichTypeFlowGraphInteger, (a) => {
			switch (config?.roundingMode) {
				case "floor": return FlowGraphInteger.FromValue(Math.floor(a));
				case "ceil": return FlowGraphInteger.FromValue(Math.ceil(a));
				case "round": return FlowGraphInteger.FromValue(Math.round(a));
				default: return FlowGraphInteger.FromValue(a);
			}
...
//#endregion
export { FlowGraphIntToBoolean as a, FlowGraphFloatToInt as i, FlowGraphBooleanToInt as n, FlowGraphIntToFloat as o, FlowGraphFloatToBoolean as r, FlowGraphBooleanToFloat as t };

//# sourceMappingURL=flowGraphTypeToTypeBlocks-BsGQlupT.js.map