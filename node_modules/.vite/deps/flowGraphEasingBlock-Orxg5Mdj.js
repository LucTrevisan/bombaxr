...
import { a as CubicEase, c as ExponentialEase, i as CircleEase, n as BezierCurveEase, r as BounceEase, s as ElasticEase, t as BackEase } from "./easing-BYmJpgDJ.js";
import { t as FlowGraphBlock, u as RichTypeAny, v as RichTypeNumber } from "./flowGraphBlock-Cu7z1xvN.js";
...
function CreateEasingFunction(type, ...parameters) {
	switch (type) {
		case 11: return new BezierCurveEase(...parameters);
		case 0: return new CircleEase();
		case 1: return new BackEase(...parameters);
		case 2: return new BounceEase(...parameters);
		case 3: return new CubicEase();
		case 4: return new ElasticEase(...parameters);
		case 5: return new ExponentialEase(...parameters);
		default: throw new Error("Easing type not yet implemented");
	}
}
/**
...
var FlowGraphEasingBlock = class extends FlowGraphBlock {
	constructor(config) {
		...
		*/
		...
		this.parameters = this.registerDataInput("parameters", RichTypeAny, [
			1,
			0,
			0,
			1
	...
	_updateOutputs(context) {
		...
		if (type === void 0 || mode === void 0) return;
...
//#endregion
export { FlowGraphEasingBlock as n, EasingFunctionType as t };

//# sourceMappingURL=flowGraphEasingBlock-Orxg5Mdj.js.map