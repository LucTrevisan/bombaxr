...
import { a as IsNavigatorAvailable, o as IsWindowObjectExist, r as GetDOMTextContent, t as PrecisionDate } from "./precisionDate-CuAZ8wH-.js";
import { a as FileToolsOptions, c as LoadFile, f as ReadFile, g as SetCorsBehavior, n as DecodeBase64UrlToBinary, o as IsBase64DataUrl, t as InstantiationTools, u as LoadImage } from "./instantiationTools-4RwH0ysD.js";
import { M as TimingTools, i as Mix, r as IsExponentOfTwo } from "./tools.functions-Bl8BhFJU.js";
...
var Tools = class Tools {
	...
	*/
	static GetBabylonScriptURL(scriptUrl, forceAbsoluteUrl) {
		...
		if (forceAbsoluteUrl) scriptUrl = Tools.GetAbsoluteUrl(scriptUrl);
		return scriptUrl;
	}
	/**
	...
	*/
	static ToBlob(canvas, successCallback, mimeType = "image/png", quality) {
		if (!Tools._IsOffScreenCanvas(canvas) && !canvas.toBlob) canvas.toBlob = function(callback, type, quality) {
			setTimeout(() => {
		...
		if (Tools._IsOffScreenCanvas(canvas)) canvas.convertToBlob({
			type: mimeType,
			quality
	...
	*/
	static EncodeScreenshotCanvasData(canvas, successCallback, mimeType = "image/png", fileName, quality) {
		if (typeof fileName === "string" || !successCallback) this.ToBlob(canvas, function(blob) {
			if (blob) Tools.DownloadBlob(blob, fileName);
	...
	*/
	...
	static _StartUserMark(counterName, condition = true) {
		...
		if (!condition || !Tools._Performance.mark) return;
...
//#endregion
export { DeepCopier as i, Tools as n, className as r, AsyncLoop as t };

//# sourceMappingURL=tools-B3Kj9lR8.js.map