import { a as Lerp, n as Hermite } from "./math.scalar.functions-7SKaVf9_.js";
import { n as Observable } from "./observable-BbxUYwsH.js";
import { a as Vector3, i as Vector2, n as Quaternion, r as TmpVectors, t as Matrix } from "./math.vector-Clv1Vglo.js";
...
var Node = class Node {
	...
	*/
	...
	_syncParentEnabledState() {
		...
		if (this._children) this._children.forEach((c) => {
...
__decorate([serialize()], Node.prototype, "metadata", void 0);
//#endregion
//#region node_modules/@babylonjs/core/Animations/animation.js
...
var Animation = class Animation {
	...
	*/
	...
	static MakeAnimationAdditive(sourceAnimation, referenceFrameOrOptions, range, cloneOriginal = false, clonedName) {
		...
		if (!animation._keys.length) return animation;
	...
	*/
	_interpolate(currentFrame, state, searchClosestKeyOnly = false) {
		...
		if (startKey.interpolation === 1) if (endKey.frame > currentFrame) return startValue;
	...
	*/
	clone() {
		...
		if (this._keys) clone.setKeys(this._keys);
		if (this._ranges) {
			clone._ranges = {};
			for (const name in this._ranges) {
				const range = this._ranges[name];
		...
		for (index = 0; index < parsedAnimation.keys.length; index++) {
			...
			switch (dataType) {
				...
				case Animation.ANIMATIONTYPE_COLOR4:
					...
					if (key.values[6]) interpolation = Color4.FromArray(key.values[6]);
					break;
				case Animation.ANIMATIONTYPE_VECTOR3:
				default:
			...
			request.addEventListener("readystatechange", () => {
				if (request.readyState == 4) if (request.status == 200) {
					...
					if (serializationObject.length) {
						const output = [];
						for (const serializedAnimation of serializationObject) output.push(this.Parse(serializedAnimation));
						resolve(output);
					} else {
...
//#endregion
export { _staticOffsetValueSize as a, Node as c, _staticOffsetValueQuaternion as i, AnimationRange as l, _staticOffsetValueColor3 as n, _staticOffsetValueVector2 as o, _staticOffsetValueColor4 as r, _staticOffsetValueVector3 as s, Animation as t };

//# sourceMappingURL=animation-CFnPGTxf.js.map