...
import { a as Vector3, r as TmpVectors, t as Matrix } from "./math.vector-Clv1Vglo.js";
import { r as RegisterClass, t as GetClass } from "./typeStore-DHv0TG1U.js";
import { t as EngineStore } from "./engineStore-Hebxz09y.js";
import { _ as __decorate, p as serializeAsTexture, r as serialize } from "./decorators-C2fLRD2d.js";
import { t as _WarnImport } from "./devTools-OD6ut7ms.js";
import { n as SerializationHelper, t as Size } from "./math.size-BVAjfZt2.js";
import { S as EncodeArrayBufferToBase64, t as InstantiationTools } from "./instantiationTools-4RwH0ysD.js";
import { M as TimingTools } from "./tools.functions-Bl8BhFJU.js";
...
var ThinTexture = class ThinTexture {
	...
	*/
	constructor(internalTexture) {
		...
		*/
		...
		if (this._texture) this._engine = this._texture.getEngine();
	}
	/**
	...
	*/
	updateSamplingMode(samplingMode) {
		if (this._texture && this._engine) this._engine.updateTextureSamplingMode(samplingMode, this._texture);
	}
	/**
...
//#endregion
//#region node_modules/@babylonjs/core/Materials/Textures/baseTexture.js
/**
* Base class of all the textures in babylon.
* It groups all the common properties the materials, post process, lights... might need
* in order to make a correct use of the texture.
*/
var BaseTexture = class BaseTexture extends ThinTexture {
	/**
	...
	*/
	constructor(sceneOrEngine, internalTexture = null) {
		...
		*/
		...
		if (sceneOrEngine) if (BaseTexture._IsScene(sceneOrEngine)) this._scene = sceneOrEngine;
	...
	*/
	readPixels(faceIndex = 0, level = 0, buffer = null, flushRenderer = true, noDataConversion = false, x = 0, y = 0, width = Number.MAX_VALUE, height = Number.MAX_VALUE) {
		...
		try {
			if (this._texture.isCube) return engine._readTexturePixels(this._texture, width, height, faceIndex, level, buffer, flushRenderer, noDataConversion, x, y);
...
*/
var Texture = class Texture extends BaseTexture {
	/**
	* @internal
	*/
	...
	*/
	constructor(url, sceneOrEngine, noMipmapOrOptions, invertY, samplingMode = Texture.TRILINEAR_SAMPLINGMODE, onLoad = null, onError = null, buffer = null, deleteBuffer = false, format, mimeType, loaderOptions, creationFlags, forcedExtension) {
		...
		*/
		...
		if (!this._texture) if (!scene || !scene.useDelayedTextureLoading) {
			try {
	...
	*/
	updateURL(url, buffer = null, onLoad, forcedExtension) {
		...
		this._forcedExtension = forcedExtension;
		this.delayLoadState = 4;
		if (onLoad) this._delayedOnLoad = onLoad;
		this.delayLoad();
	}
	/**
	...
	*/
	delayLoad() {
		...
		} else if (this._delayedOnLoad) if (this._texture.isReady) TimingTools.SetImmediate(this._delayedOnLoad);
	...
	*/
	getReflectionTextureMatrix() {
		...
		if (this.uOffset === this._cachedReflectionUOffset && this.vOffset === this._cachedReflectionVOffset && this.uScale === this._cachedReflectionUScale && this.vScale === this._cachedReflectionVScale && this.coordinatesMode === this._cachedReflectionCoordinatesMode) if (this.coordinatesMode === Texture.PROJECTION_MODE) {
	...
	*/
	serialize() {
		...
		if (Texture.SerializeBuffers || Texture.ForceSerializeBuffers) {
			...
			} else if (this.url && this.url.startsWith("data:") && this._buffer instanceof Uint8Array) serializationObject.base64String = "data:image/png;base64," + EncodeArrayBufferToBase64(this._buffer);
			else if (Texture.ForceSerializeBuffers || this.url && this.url.startsWith("blob:") || this._forceSerialize) serializationObject.base64String = !this._engine || this._engine._features.supportSyncTextureRead ? GenerateBase64StringFromTexture(this) : GenerateBase64StringFromTextureAsync(this);
		}
		serializationObject.invertY = this._invertY;
		serializationObject.samplingMode = this.samplingMode;
		serializationObject._creationFlags = this._creationFlags;
		serializationObject._useSRGBBuffer = this._useSRGBBuffer;
		if (Texture._SerializeInternalTextureUniqueId) serializationObject.internalTextureUniqueId = this._texture?.uniqueId;
	...
	*/
	static Parse(parsedTexture, scene, rootUrl) {
		...
		if (parsedTexture.isCube && !parsedTexture.isRenderTarget) return Texture._CubeTextureParser(parsedTexture, scene, rootUrl);
		...
		return SerializationHelper.Parse(() => {
			...
			if (parsedTexture.mirrorPlane) {
				...
				if (parsedTexture.base64String && !internalTexture) {
					...
					if (parsedTexture.url && (parsedTexture.url.startsWith("data:") || Texture.UseSerializedUrlIfAny)) url = parsedTexture.url;
					const options = {
	...
	*/
	static CreateFromBase64String(data, name, scene, noMipmapOrOptions, invertY, samplingMode = Texture.TRILINEAR_SAMPLINGMODE, onLoad = null, onError = null, format = 5, creationFlags, forcedExtension) {
		return new Texture("data:" + name, scene, noMipmapOrOptions, invertY, samplingMode, onLoad, onError, data, false, format, void 0, void 0, creationFlags, forcedExtension);
	}
	/**
	...
	*/
	static LoadFromDataString(name, buffer, scene, deleteBuffer = false, noMipmapOrOptions, invertY = true, samplingMode = Texture.TRILINEAR_SAMPLINGMODE, onLoad = null, onError = null, format = 5, creationFlags, forcedExtension) {
		...
		return new Texture(name, scene, noMipmapOrOptions, invertY, samplingMode, onLoad, onError, buffer, deleteBuffer, format, void 0, void 0, creationFlags, forcedExtension);
	}
};
/**
...
//#endregion
export { GenerateBase64StringFromTextureAsync as a, CompatibilityOptions as c, GenerateBase64StringFromTexture as i, setOpenGLOrientationForUV as l, CopyTools as n, BaseTexture as o, GenerateBase64StringFromPixelData as r, ThinTexture as s, Texture as t, useOpenGLOrientationForUV as u };

//# sourceMappingURL=texture-BC46D7N_.js.map