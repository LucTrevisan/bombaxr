...
//#region node_modules/@babylonjs/core/Misc/tga.js
var _TYPE_INDEXED = 1;
var _TYPE_RGB = 2;
var _TYPE_GREY = 3;
...
function UploadContent(texture, data) {
	...
	switch (header.image_type) {
		case _TYPE_RLE_INDEXED: use_rle = true;
		case _TYPE_INDEXED:
			use_pal = true;
			break;
		case _TYPE_RLE_RGB: use_rle = true;
		case _TYPE_RGB: break;
		case _TYPE_RLE_GREY: use_rle = true;
		case _TYPE_GREY:
			use_grey = true;
			break;
	}
	...
	if (use_rle) {
		...
		while (offset < pixel_total && localOffset < pixel_total) {
			...
			if (c & 128) {
				...
				for (i = 0; i < count; ++i) pixel_data.set(pixels, localOffset + i * pixel_size);
				localOffset += pixel_size * count;
			} else {
				count *= pixel_size;
				for (i = 0; i < count; ++i) pixel_data[localOffset + i] = data[offset++];
				localOffset += count;
			}
		}
	} else pixel_data = data.subarray(offset, offset += use_pal ? header.width * header.height : pixel_total);
	...
	const imageData = TGATools["_getImageData" + (use_grey ? "Grey" : "") + header.pixel_size + "bits"](header, palettes, pixel_data, y_start, y_step, y_end, x_start, x_step, x_end);
	texture.getEngine()._uploadDataToTextureDirectly(texture, imageData);
}
/**
* @internal
*/
...
//#endregion
//#region node_modules/@babylonjs/core/Materials/Textures/Loaders/tgaTextureLoader.js
var tgaTextureLoader_exports = /* @__PURE__ */ __exportAll({ _TGATextureLoader: () => _TGATextureLoader });
/**
...
//#endregion
export { UploadContent as a, TGATools as i, tgaTextureLoader_exports as n, GetTGAHeader as r, _TGATextureLoader as t };

//# sourceMappingURL=tgaTextureLoader-DcahcqF-.js.map