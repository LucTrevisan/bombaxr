...
import { A as FlowGraphInteger, t as FlowGraphBlock, u as RichTypeAny } from "./flowGraphBlock-Cu7z1xvN.js";
import { o as getNumericValue } from "./utils-IXO60KEn.js";
...
var FlowGraphArrayIndexBlock = class extends FlowGraphBlock {
	...
	*/
	_updateOutputs(context) {
		...
		if (array && index >= 0 && index < array.length) this.value.setValue(array[index], context);
		else this.value.setValue(null, context);
	}
	/**
...
//#endregion
export { FlowGraphArrayIndexBlock as t };

//# sourceMappingURL=flowGraphArrayIndexBlock-BPHlWypH.js.map