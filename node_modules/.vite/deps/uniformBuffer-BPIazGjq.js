...
var UniformBuffer = class UniformBuffer {
	...
	*/
	...
	_rebuild() {
		...
		if (this._dynamic) this._buffer = this._engine.createDynamicUniformBuffer(this._bufferData, this._name + "_UniformList:" + this._getNames());
		else this._buffer = this._engine.createUniformBuffer(this._bufferData, this._name + "_UniformList:" + this._getNames());
		if (this._engine._features.trackUbosInFrame) {
	...
	*/
	update() {
		...
		if (this._engine._features._collectUbosUpdatedInFrame) {
			if (!UniformBuffer._UpdatedUbosInFrame[this._name]) UniformBuffer._UpdatedUbosInFrame[this._name] = 0;
	...
	*/
	dispose() {
		...
		if (this._engine._features.trackUbosInFrame && this._buffers) for (let i = 0; i < this._buffers.length; ++i) {
...
//# sourceMappingURL=uniformBuffer-BPIazGjq.js.map