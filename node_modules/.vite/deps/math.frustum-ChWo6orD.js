...
//#endregion
//#region node_modules/@babylonjs/core/Rendering/renderingGroup.js
/**
...
var RenderingGroup = class RenderingGroup {
	...
	*/
	render(customRenderFunction, renderSprites, renderParticles, activeMeshes) {
		...
		if (this._opaqueSubMeshes.length !== 0) this._renderOpaque(this._opaqueSubMeshes);
		if (this._alphaTestSubMeshes.length !== 0) this._renderAlphaTest(this._alphaTestSubMeshes);
	...
	*/
	dispatch(subMesh, mesh, material) {
		...
		if (material.needAlphaBlendingForMesh(mesh)) this._transparentSubMeshes.push(subMesh);
			...
			if (material.needDepthPrePass) this._depthOnlySubMeshes.push(subMesh);
...
var RenderingManager = class RenderingManager {
	...
	*/
	...
	_prepareRenderingGroup(renderingGroupId) {
		if (this._renderingGroups[renderingGroupId] === void 0) this._renderingGroups[renderingGroupId] = new RenderingGroup(renderingGroupId, this._scene, this._customOpaqueSortCompareFn[renderingGroupId], this._customAlphaTestSortCompareFn[renderingGroupId], this._customTransparentSortCompareFn[renderingGroupId]);
	}
	/**
...
//#endregion
export { PostProcessManager as a, RenderingGroup as i, RenderingGroupInfo as n, SmartArray as o, RenderingManager as r, SmartArrayNoDuplicate as s, Frustum as t };

//# sourceMappingURL=math.frustum-ChWo6orD.js.map