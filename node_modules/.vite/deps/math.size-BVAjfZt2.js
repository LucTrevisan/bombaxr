...
import { g as GetMergedStore } from "./decorators-C2fLRD2d.js";
...
var Size = class Size {
	...
	*/
	static Lerp(start, end, amount) {
		return new Size(start.width + (end.width - start.width) * amount, start.height + (end.height - start.height) * amount);
	}
};
//#endregion
export { AndOrNotEvaluator as i, SerializationHelper as n, Tags as r, Size as t };

//# sourceMappingURL=math.size-BVAjfZt2.js.map