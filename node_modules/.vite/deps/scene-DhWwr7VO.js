...
import { a as Vector3, c as _ObserveArray, i as Vector2, r as TmpVectors, t as Matrix } from "./math.vector-Clv1Vglo.js";
...
import { _ as __decorate, o as serializeAsColor4, p as serializeAsTexture, r as serialize, s as serializeAsColorCurves } from "./decorators-C2fLRD2d.js";
import { t as _WarnImport } from "./devTools-OD6ut7ms.js";
import { n as SerializationHelper, r as Tags } from "./math.size-BVAjfZt2.js";
import { a as IsNavigatorAvailable, o as IsWindowObjectExist, t as PrecisionDate } from "./precisionDate-CuAZ8wH-.js";
import { c as LoadFile, f as ReadFile, m as RequestFile } from "./instantiationTools-4RwH0ysD.js";
import { i as Mix } from "./tools.functions-Bl8BhFJU.js";
import { a as PostProcessManager, o as SmartArray, r as RenderingManager, s as SmartArrayNoDuplicate, t as Frustum } from "./math.frustum-ChWo6orD.js";
import { t as UniformBuffer } from "./uniformBuffer-BPIazGjq.js";
import { n as VertexBuffer } from "./buffer-C0-cMmV_.js";
import { i as PointerInfoPre, n as PointerInfo, t as PointerEventTypes } from "./pointerEvents-B7MggvzM.js";
import { t as PerfCounter } from "./perfCounter-Dm2UVeVl.js";
import { t as UniqueIdGenerator } from "./uniqueIdGenerator-B36lntm6.js";
import { t as LightConstants } from "./lightConstants-DkROIVvt.js";
//#region node_modules/@babylonjs/core/Actions/abstractActionManager.js
/**
...
//#endregion
//#region node_modules/@babylonjs/core/Actions/actionEvent.js
/**
...
*/
var ColorCurves = class ColorCurves {
	constructor() {
		this._dirty = true;
	...
	*/
	_getColorGradingDataToRef(hue, density, saturation, exposure, result) {
		...
		ColorCurves._FromHSBToRef(hue, density, 50 + .25 * exposure, result);
...
* or not.
*/
var ImageProcessingConfiguration = class ImageProcessingConfiguration {
	constructor() {
		/**
	...
	*/
	bind(effect, overrideAspectRatio) {
		if (this._colorCurvesEnabled && this.colorCurves) ColorCurves.Bind(this.colorCurves, effect);
...
//#endregion
//#region node_modules/@babylonjs/core/Collisions/pickingInfo.js
/**
	...
	getNormal(useWorldCoordinates = false, useVerticesNormals = true) {
		...
		const transformNormalToWorld = (pickedMesh, n) => {
			if (this.thinInstanceIndex !== -1) {
				...
				if (tm) Vector3.TransformNormalToRef(n, tm, n);
			}
...
//#endregion
//#region node_modules/@babylonjs/core/sceneComponent.js
/**
...
//#endregion
//#region node_modules/@babylonjs/core/DeviceInput/InputDevices/deviceEnums.js
/**
...
//#endregion
//#region node_modules/@babylonjs/core/DeviceInput/nativeDeviceInputSystem.js
/** @internal */
...
//#endregion
//#region node_modules/@babylonjs/core/DeviceInput/webDeviceInputSystem.js
...
var WebDeviceInputSystem = class {
	...
	*/
	_handlePointerActions() {
		...
		this._pointerUpEvent = (evt) => {
			...
			if (deviceType === DeviceType.Touch) if (deviceSlot === -1) return;
	...
	*/
	_getGamepadDeviceType(deviceName) {
		...
		else if (deviceName.indexOf("Xbox One") !== -1 || deviceName.search("Xbox 360") !== -1 || deviceName.search("xinput") !== -1) return DeviceType.Xbox;
...
//#endregion
//#region node_modules/@babylonjs/core/DeviceInput/InputDevices/deviceSource.js
/**
...
//#endregion
//#region node_modules/@babylonjs/core/DeviceInput/internalDeviceSourceManager.js
/** @internal */
...
//#endregion
//#region node_modules/@babylonjs/core/DeviceInput/InputDevices/deviceSourceManager.js
/**
...
var DeviceSourceManager = class {
	...
	*/
	_addDevice(deviceSource) {
		if (!this._devices[deviceSource.deviceType]) this._devices[deviceSource.deviceType] = new Array();
...
//#endregion
//#region node_modules/@babylonjs/core/import.helper.js
/** @internal */
	...
	*/
	attachControl(attachUp = true, attachDown = true, attachMove = true, elementToAttachTo = null) {
		...
		this._initClickEvent = (obs1, obs2, evt, cb) => {
			...
			if (checkPicking) {
				...
				if (!clickInfo.hasSwiped) {
					...
					if (checkDoubleClick) if (btn === this._previousButtonPressed && Date.now() - this._previousStartingPointerTime < InputManager.DoubleClickDelay && !this._doubleClickOccured) {
		...
		this._onPointerDown = (evt) => {
			...
			this._meshPickProceed = false;
			if (InputManager.ExclusiveDoubleClickMode) {
				for (let i = 0; i < this._delayedClicks.length; i++) if (this._delayedClicks[i]) if (evt.button === i) clearTimeout(this._delayedClicks[i]?.timeoutId);
				else {
...
//#endregion
//#region node_modules/@babylonjs/core/scene.js
/**
...
var Scene = class Scene {
	...
	*/
	bindEyePosition(effect, variableName = "vEyePosition", isVector3 = false) {
		...
		if (effect) if (isVector3) effect.setFloat3(variableName, TmpVectors.Vector4[0].x, TmpVectors.Vector4[0].y, TmpVectors.Vector4[0].z);
		else effect.setVector4(variableName, TmpVectors.Vector4[0]);
	...
	*/
	setTransformMatrix(viewL, projectionL, viewR, projectionR) {
		...
		if (this._multiviewSceneUbo && this._multiviewSceneUbo.useUbo) this._updateMultiviewUbo(viewR, projectionR);
	...
	*/
	addMesh(newMesh, recursive = false) {
		...
		if (recursive) newMesh.getChildMeshes().forEach((m) => {
			this.addMesh(m);
		});
	}
	/**
	...
	*/
	removeMesh(toRemove, recursive = false) {
		...
		if (recursive) toRemove.getChildMeshes().forEach((m) => {
			this.removeMesh(m);
		});
		return index;
	}
	...
	*/
	removeCamera(toRemove) {
		...
		if (this.activeCamera === toRemove) if (this.cameras.length > 0) this.activeCamera = this.cameras[0];
	...
	*/
	unfreezeActiveMeshes() {
		...
		for (let index = 0; index < this._activeMeshes.length; index++) this._activeMeshes.data[index]._unFreeze();
		this._activeMeshesFrozen = false;
		return this;
	}
	...
	*/
	_renderForCamera(camera, rigParent, bindFrameBuffer = true) {
		...
		if (engine.snapshotRendering && engine.snapshotRenderingMode === 1) this.finalizeSceneUbo();
				...
				if (action.trigger === 12 || action.trigger === 13) {
					...
					if (areIntersecting && currentIntersectionInProgress === -1) {
						...
						if (!sourceMesh.actionManager.hasSpecificTrigger(13, (parameter) => {
							return otherMesh === (parameter.mesh ? parameter.mesh : parameter);
	...
	*/
	render(updateCameras = true, ignoreAnimations = false) {
		...
		if (this.activeCameras?.length) this.activeCameras.forEach(this._checkCameraRenderTarget);
		this._registerTransientComponents();
	...
	*/
	getWorldExtends(filterPredicate) {
		...
		this.meshes.filter(filterPredicate).forEach((mesh) => {
			...
			if (!mesh.subMeshes || mesh.subMeshes.length === 0 || mesh.infiniteDistance) return;
...
//#endregion
export { PrepareUniformsForImageProcessing as C, AbstractActionManager as D, ActionEvent as E, PrepareSamplersForImageProcessing as S, StringDictionary as T, KeyboardInfoPre as _, DeviceSource as a, PickingInfo as b, DeviceType as c, NativePointerInput as d, PointerInput as f, KeyboardInfo as g, KeyboardEventTypes as h, DeviceSourceManager as i, DualSenseInput as l, XboxInput as m, ScenePerformancePriority as n, DeviceInputEventType as o, SwitchInput as p, _ImportHelper as r, EventConstants as s, Scene as t, DualShockInput as u, SceneComponentConstants as v, ColorCurves as w, ImageProcessingConfiguration as x, Stage as y };

//# sourceMappingURL=scene-DhWwr7VO.js.map