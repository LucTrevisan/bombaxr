import { a as Lerp, c as RandomRange, o as NormalizeRadians, t as Clamp, u as WithinEpsilon } from "./math.scalar.functions-7SKaVf9_.js";
...
var Vector2 = class Vector2 {
	...
	*/
	static CatmullRom(value1, value2, value3, value4, amount) {
		...
		return new Vector2(.5 * (2 * value2.x + (-value1.x + value3.x) * amount + (2 * value1.x - 5 * value2.x + 4 * value3.x - value4.x) * squared + (-value1.x + 3 * value2.x - 3 * value3.x + value4.x) * cubed), .5 * (2 * value2.y + (-value1.y + value3.y) * amount + (2 * value1.y - 5 * value2.y + 4 * value3.y - value4.y) * squared + (-value1.y + 3 * value2.y - 3 * value3.y + value4.y) * cubed));
	}
	/**
	...
	*/
	static Hermite(value1, tangent1, value2, tangent2, amount) {
		...
		return new Vector2(value1.x * part1 + value2.x * part2 + tangent1.x * part3 + tangent2.x * part4, value1.y * part1 + value2.y * part2 + tangent1.y * part3 + tangent2.y * part4);
	}
	/**
	...
	*/
	static Minimize(left, right) {
		return new Vector2(left.x < right.x ? left.x : right.x, left.y < right.y ? left.y : right.y);
	}
	/**
...
*/
Vector2._V8PerformanceHack = new Vector2(.5, .5);
...
var Vector3 = class Vector3 {
	...
	*/
	static GetAngleBetweenVectorsOnPlane(vector0, vector1, normal) {
		...
		return NormalizeRadians(Math.atan2(Vector3.Dot(v1, right), Vector3.Dot(v1, forward)));
	}
	/**
	...
	*/
	static CatmullRom(value1, value2, value3, value4, amount) {
		const squared = amount * amount;
		const cubed = amount * squared;
		return new Vector3(.5 * (2 * value2._x + (-value1._x + value3._x) * amount + (2 * value1._x - 5 * value2._x + 4 * value3._x - value4._x) * squared + (-value1._x + 3 * value2._x - 3 * value3._x + value4._x) * cubed), .5 * (2 * value2._y + (-value1._y + value3._y) * amount + (2 * value1._y - 5 * value2._y + 4 * value3._y - value4._y) * squared + (-value1._y + 3 * value2._y - 3 * value3._y + value4._y) * cubed), .5 * (2 * value2._z + (-value1._z + value3._z) * amount + (2 * value1._z - 5 * value2._z + 4 * value3._z - value4._z) * squared + (-value1._z + 3 * value2._z - 3 * value3._z + value4._z) * cubed));
	}
	/**
	...
	*/
	static Hermite(value1, tangent1, value2, tangent2, amount) {
		...
		const part3 = cubed - 2 * squared + amount;
		const part4 = cubed - squared;
		return new Vector3(value1._x * part1 + value2._x * part2 + tangent1._x * part3 + tangent2._x * part4, value1._y * part1 + value2._y * part2 + tangent1._y * part3 + tangent2._y * part4, value1._z * part1 + value2._z * part2 + tangent1._z * part3 + tangent2._z * part4);
	}
	/**
	...
	*/
	static _UnprojectFromInvertedMatrixToRef(source, matrix, result) {
		...
		if (WithinEpsilon(num, 1)) result.scaleInPlace(1 / num);
		return result;
	}
	/**
...
*/
Vector3._V8PerformanceHack = new Vector3(.5, .5, .5);
...
*/
Vector4._V8PerformanceHack = new Vector4(.5, .5, .5, .5);
...
var Quaternion = class Quaternion {
	...
	*/
	static FromUnitVectorsToRef(vecFrom, vecTo, result, epsilon = Epsilon) {
		...
		if (r < epsilon) if (Math.abs(vecFrom.x) > Math.abs(vecFrom.z)) result.set(-vecFrom.y, vecFrom.x, 0, 0);
	...
	*/
	static Hermite(value1, tangent1, value2, tangent2, amount) {
		...
		const part3 = cubed - 2 * squared + amount;
		const part4 = cubed - squared;
		return new Quaternion(value1._x * part1 + value2._x * part2 + tangent1._x * part3 + tangent2._x * part4, value1._y * part1 + value2._y * part2 + tangent1._y * part3 + tangent2._y * part4, value1._z * part1 + value2._z * part2 + tangent1._z * part3 + tangent2._z * part4, value1._w * part1 + value2._w * part2 + tangent1._w * part3 + tangent2._w * part4);
	}
	/**
...
*/
Quaternion._V8PerformanceHack = new Quaternion(.5, .5, .5, .5);
...
var Matrix = class Matrix {
	...
	*/
	getHashCode() {
		...
		for (let i = 1; i < 16; i++) hash = hash * 397 ^ _ExtractAsInt(this._m[i]);
		return hash;
	}
	/**
...
//#endregion
export { Vector3 as a, _ObserveArray as c, ToGammaSpace as d, ToLinearSpace as f, Vector2 as i, Epsilon as l, Quaternion as n, Vector4 as o, TmpVectors as r, BuildArray as s, Matrix as t, PHI as u };

//# sourceMappingURL=math.vector-Clv1Vglo.js.map