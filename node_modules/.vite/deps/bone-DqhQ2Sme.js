import { a as Vector3, n as Quaternion, r as TmpVectors, s as BuildArray, t as Matrix } from "./math.vector-Clv1Vglo.js";
...
var Bone = class Bone extends Node {
	...
	getPositionToRef(space = 0, tNode, result) {
		if (space == 0) {
			...
			if (tNode && wm) {
				...
				tmat.multiplyToRef(wm, tmat);
			} else tmat = this.getAbsoluteMatrix();
			result.x = tmat.m[12];
			result.y = tmat.m[13];
			result.z = tmat.m[14];
		}
	...
	*/
	getDirectionToRef(localAxis, tNode = null, result) {
		...
		if (tNode && wm) mat.multiplyToRef(wm, mat);
	...
	*/
	getAbsolutePositionFromLocalToRef(position, tNode = null, result) {
		...
		const tmat = Bone._TmpMats[0];
		tmat.copyFrom(this.getAbsoluteMatrix());
		if (tNode && wm) tmat.multiplyToRef(wm, tmat);
...
//# sourceMappingURL=bone-DqhQ2Sme.js.map