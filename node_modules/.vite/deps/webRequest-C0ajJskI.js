...
var WebRequest = class WebRequest {
	...
	*/
	send(body) {
		if (WebRequest.CustomRequestHeaders) this._injectCustomRequestHeaders();
		this._xhr.send(body);
	}
	/**
	...
	*/
	open(method, url) {
		for (const update of WebRequest.CustomRequestModifiers) {
			if (this._shouldSkipRequestModifications(url)) return;
...
//# sourceMappingURL=webRequest-C0ajJskI.js.map