...
import { E as getRichTypeByFlowGraphType, S as RichTypeVector3, d as RichTypeBoolean, h as RichTypeMatrix, t as FlowGraphBlock, v as RichTypeNumber, y as RichTypeQuaternion } from "./flowGraphBlock-Cu7z1xvN.js";
...
var FlowGraphTransposeBlock = class extends FlowGraphUnaryOperationBlock {
	...
	*/
	constructor(config) {
		super(getRichTypeByFlowGraphType(config?.matrixType || "Matrix"), getRichTypeByFlowGraphType(config?.matrixType || "Matrix"), (a) => a.transpose ? a.transpose() : Matrix.Transpose(a), "FlowGraphTransposeBlock", config);
	}
};
...
var FlowGraphDeterminantBlock = class extends FlowGraphUnaryOperationBlock {
	...
	*/
	constructor(config) {
		super(getRichTypeByFlowGraphType(config?.matrixType || "Matrix"), RichTypeNumber, (a) => a.determinant(), "FlowGraphDeterminantBlock", config);
	}
};
...
var FlowGraphInvertMatrixBlock = class extends FlowGraphUnaryOperationBlock {
	...
	*/
	constructor(config) {
		super(getRichTypeByFlowGraphType(config?.matrixType || "Matrix"), getRichTypeByFlowGraphType(config?.matrixType || "Matrix"), (a) => a.inverse ? a.inverse() : Matrix.Invert(a), "FlowGraphInvertMatrixBlock", config);
	}
};
...
var FlowGraphMatrixMultiplicationBlock = class extends FlowGraphBinaryOperationBlock {
	...
	*/
	constructor(config) {
		super(getRichTypeByFlowGraphType(config?.matrixType || "Matrix"), getRichTypeByFlowGraphType(config?.matrixType || "Matrix"), getRichTypeByFlowGraphType(config?.matrixType || "Matrix"), (a, b) => b.multiply(a), "FlowGraphMatrixMultiplicationBlock", config);
	}
};
...
var FlowGraphMatrixComposeBlock = class extends FlowGraphBlock {
	...
	_updateOutputs(context) {
		...
		if (cachedExecutionId === context.executionId && cachedMatrix) this.value.setValue(cachedMatrix, context);
		else {
...
//#endregion
export { FlowGraphMatrixMultiplicationBlock as a, FlowGraphMatrixDecomposeBlock as i, FlowGraphInvertMatrixBlock as n, FlowGraphTransposeBlock as o, FlowGraphMatrixComposeBlock as r, FlowGraphDeterminantBlock as t };

//# sourceMappingURL=flowGraphMatrixMathBlocks-DPyYPv78.js.map