	...
	_getMessageValue(context) {
		if (this.config?.messageTemplate) {
			...
			for (const match of matches) {
				...
				if (value !== void 0) template = template.replace(new RegExp(`\\{${match}\\}`, "g"), value.toString());
			}
			return template;
...
//#endregion
export { FlowGraphConsoleLogBlock as t };

//# sourceMappingURL=flowGraphConsoleLogBlock-BVi8Eqoy.js.map