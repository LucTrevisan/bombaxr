import { a as Vector3, t as Matrix } from "./math.vector-Clv1Vglo.js";
...
var Plane = class Plane {
	...
	*/
	transform(transformation) {
		...
		const d = this.d;
		return new Plane(x * m[0] + y * m[1] + z * m[2] + d * m[3], x * m[4] + y * m[5] + z * m[6] + d * m[7], x * m[8] + y * m[9] + z * m[10] + d * m[11], x * m[12] + y * m[13] + z * m[14] + d * m[15]);
	}
	/**
...
//# sourceMappingURL=math.plane-BRy-nYZY.js.map