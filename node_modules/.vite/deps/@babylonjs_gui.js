import { h as KeyboardEventTypes } from "./scene-DhWwr7VO.js";
import { n as Observable } from "./observable-BbxUYwsH.js";
import { a as Vector3, i as Vector2, l as Epsilon, n as Quaternion, o as Vector4, r as TmpVectors, t as Matrix } from "./math.vector-Clv1Vglo.js";
import { r as RegisterClass, t as GetClass } from "./typeStore-DHv0TG1U.js";
import { t as EngineStore } from "./engineStore-Hebxz09y.js";
import { n as Color4, r as TmpColors, t as Color3 } from "./math.color-CXYOFsIw.js";
import { t as Logger } from "./logger-BsklRjyg.js";
import { n as Tools } from "./tools-B3Kj9lR8.js";
import { t as Animation } from "./animation-CFnPGTxf.js";
import { _ as __decorate, a as serializeAsColor3, h as serializeAsVector3, o as serializeAsColor4, p as serializeAsTexture, r as serialize, t as expandToProperty } from "./decorators-C2fLRD2d.js";
import { n as SerializationHelper } from "./math.size-BVAjfZt2.js";
import { t as WebRequest } from "./webRequest-C0ajJskI.js";
import { t as AnimationGroup } from "./animationGroup-CzzbFKCv.js";
import { i as IsDocumentAvailable } from "./precisionDate-CuAZ8wH-.js";
import { b as DecodeBase64ToBinary } from "./instantiationTools-4RwH0ysD.js";
import { t as ShaderStore } from "./shaderStore-BoBVIqas.js";
import { n as RandomGUID } from "./guid-C8GtW-rp.js";
import { n as VertexBuffer } from "./buffer-C0-cMmV_.js";
import { t as PointerEventTypes } from "./pointerEvents-B7MggvzM.js";
import { t as PerfCounter } from "./perfCounter-Dm2UVeVl.js";
import { A as PushMaterial, N as Mesh, O as EffectFallbacks, V as TransformNode, W as VertexData, _ as StandardMaterial, c as SceneLoader, g as ShaderMaterial, h as HemisphericLight, j as MaterialDefines, z as AbstractMesh } from "./sceneLoader-Ctf8smxJ.js";
import { n as Viewport } from "./drawWrapper-C2T00pD9.js";
import { M as PrepareUniformsAndSamplersList, d as HandleFallbacksForShadows, m as PrepareAttributesForInstances, v as PrepareDefinesForAttributes } from "./materialHelper.functions-CIQmMgLa.js";
import { t as Texture } from "./texture-BC46D7N_.js";
import { t as Axis } from "./math.axis-C5-58YhX.js";
import { t as Constants } from "./constants-DXxR-C23.js";
import { B as SixDofDragBehavior, H as PointerDragBehavior, K as PivotTools, M as HandConstraintBehavior, R as FollowBehavior, S as UtilityLayerRenderer, U as CreatePlane, V as BaseSixDofDragBehavior, c as NodeRenderGraphBlock, g as CreateBox, i as FrameGraphTask, j as DynamicTexture, m as ClipboardInfo, n as Layer, p as ClipboardEventTypes, st as FadeInOutBehavior, t as Scalar, u as NodeRenderGraphBlockConnectionPointTypes, y as Gizmo, z as SurfaceMagnetismBehavior } from "./math.scalar-Bf1lFsGh.js";
import "./math-Bfz083oo.js";
//#region node_modules/@babylonjs/gui/2D/valueAndUnit.js
/**
* Class used to specific a value and its associated unit
*/
var ValueAndUnit = class ValueAndUnit {
	/**
	...
	*/
	constructor(value, unit = ValueAndUnit.UNITMODE_PIXEL, negativeValueAllowed = true) {
	...
	*/
	getValueInPixel(host, refValue) {
		if (this.isPixel) return this.getValue(host);
	...
	*/
	getValue(host) {
		if (host && !this.ignoreAdaptiveScaling && this.unit !== ValueAndUnit.UNITMODE_PERCENTAGE) {
			let width = 0;
			let height = 0;
			if (host.idealWidth) width = Math.ceil(this._value * host.getSize().width / host.idealWidth);
			if (host.idealHeight) height = Math.ceil(this._value * host.getSize().height / host.idealHeight);
			if (host.useSmallestIdeal && host.idealWidth && host.idealHeight) return window.innerWidth < window.innerHeight ? width : height;
			if (host.idealWidth) return width;
			if (host.idealHeight) return height;
		}
		return this._value;
	}
	/**
	...
	*/
	fromString(source) {
		...
		if (match.length === 4) switch (match[3]) {
			case "px":
		...
		if (sourceValue === this._value && sourceUnit === this._unit) return false;
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/measure.js
var tmpRect = [
	new Vector2(0, 0),
	new Vector2(0, 0),
	new Vector2(0, 0),
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/math2D.js
/**
...
var Matrix2D = class Matrix2D {
	...
	*/
	static ComposeToRef(tx, ty, angle, scaleX, scaleY, parentMatrix, result) {
		...
		} else Matrix2D._TempCompose1.multiplyToRef(Matrix2D._TempPostTranslationMatrix, result);
	}
};
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/control.js
/**
...
var Control = class Control {
	...
	*/
	...
	set highlightLineWidth(value) {
		if (this._highlightLineWidth === value) return;
	...
	*/
	...
	set transformCenterY(value) {
		if (this._transformCenterY === value) return;
	...
	*/
	...
	set transformCenterX(value) {
		if (this._transformCenterX === value) return;
	...
	*/
	...
	set fixedRatio(value) {
		if (this._fixedRatio === value) return;
	...
	*/
	...
	set fixedRatioMasterIsWidth(value) {
		if (this._fixedRatioMasterIsWidth === value) return;
	...
	*/
	...
	set width(value) {
		...
		if (this._width.toString(this._host) === value) return;
		if (this._width.fromString(value)) this._markAsDirty();
	}
	/**
	...
	*/
	...
	set height(value) {
		...
		if (this._height.toString(this._host) === value) return;
		if (this._height.fromString(value)) this._markAsDirty();
	}
	/**
	...
	*/
	...
	set style(value) {
		...
		this._style = value;
		if (this._style) this._styleObserver = this._style.onChangedObservable.add(() => {
			this._markAsDirty();
			this._resetFontCache();
		});
		this._markAsDirty();
	...
	get fontSizeInPixels() {
		...
		if (fontSizeToUse.isPixel) return fontSizeToUse.getValue(this._host);
	...
	set fontSize(value) {
		if (this._fontSize.toString(this._host) === value) return;
	...
	set zIndex(value) {
		...
		this._zIndex = value;
		if (this.parent) this.parent._reOrderControl(this);
	}
	...
	set notRenderable(value) {
		if (this._doNotRender === value) return;
	...
	*/
	...
	set descendantsOnlyPadding(value) {
		if (this._descendantsOnlyPadding === value) return;
	...
	*/
	...
	set paddingLeft(value) {
		if (this._paddingLeft.fromString(value)) this._markAsDirty();
	}
	/**
	...
	*/
	...
	get _paddingLeftInPixels() {
		if (this._descendantsOnlyPadding) return 0;
	...
	*/
	...
	set paddingRight(value) {
		if (this._paddingRight.fromString(value)) this._markAsDirty();
	}
	/**
	...
	*/
	...
	set paddingTop(value) {
		if (this._paddingTop.fromString(value)) this._markAsDirty();
	}
	/**
	...
	*/
	...
	set paddingBottom(value) {
		if (this._paddingBottom.fromString(value)) this._markAsDirty();
	}
	/**
	...
	*/
	...
	set left(value) {
		if (this._left.fromString(value)) this._markAsDirty();
	}
	/**
	...
	*/
	...
	set top(value) {
		if (this._top.fromString(value)) this._markAsDirty();
	}
	/**
	...
	*/
	...
	set linkOffsetX(value) {
		if (this._linkOffsetX.fromString(value)) this._markAsDirty();
	}
	/**
	...
	*/
	...
	set linkOffsetY(value) {
		if (this._linkOffsetY.fromString(value)) this._markAsDirty();
	}
	/**
	...
	*/
	...
	set isEnabled(value) {
		...
		const recursivelyFirePointerOut = (control) => {
			...
			for (const pointer in control.host._lastControlOver) if (control === this.host._lastControlOver[pointer]) {
				control._onPointerOut(control, null, true);
				delete control.host._lastControlOver[pointer];
			}
			if (control.children !== void 0) control.children.forEach(recursivelyFirePointerOut);
		};
	...
	set disabledColor(value) {
		if (this._disabledColor === value) return;
	...
	set disabledColorItem(value) {
		if (this._disabledColorItem === value) return;
	...
	*/
	...
	onBlur() {
		if (this._isFocused) {
			...
			if (this.focusedColor && this._unfocusedColor != null) this.color = this._unfocusedColor;
	...
	*/
	processKeyboard(evt) {
		if (evt.key === "Enter") this.onEnterPressedObservable.notifyObservers(this);
	...
	*/
	getAscendantOfClass(className) {
		...
		if (this.parent.getClassName() === className) return this.parent;
	...
	*/
	linkWithMesh(mesh) {
		if (!this._host || this.parent && this.parent !== this._host._rootContainer) {
			if (mesh) Tools.Error("Cannot link a control to a mesh if the control is not at root level");
			return;
		}
		const index = this._host._linkedControls.indexOf(this);
		if (index !== -1) {
			this._linkedMesh = mesh;
			if (!mesh) this._host._linkedControls.splice(index, 1);
			return;
		} else if (!mesh) return;
		this.horizontalAlignment = Control.HORIZONTAL_ALIGNMENT_LEFT;
		this.verticalAlignment = Control.VERTICAL_ALIGNMENT_TOP;
	...
	*/
	_moveToProjectedPosition(projectedPosition) {
		...
		if (parentMeasure) this._processMeasures(parentMeasure, this._host.getContext());
		...
		if (leftAndTopIgnoreAdaptiveScaling) {
			if (Math.abs(newLeft - oldLeft) < .5) newLeft = oldLeft;
			if (Math.abs(newTop - oldTop) < .5) newTop = oldTop;
		}
		if (!leftAndTopIgnoreAdaptiveScaling && oldLeft === newLeft && oldTop === newTop) return;
	...
	*/
	_intersectsRect(rect, context) {
		...
		if (this._evaluatedMeasure.left >= rect.left + rect.width) return false;
		if (this._evaluatedMeasure.top >= rect.top + rect.height) return false;
		if (this._evaluatedMeasure.left + this._evaluatedMeasure.width <= rect.left) return false;
		if (this._evaluatedMeasure.top + this._evaluatedMeasure.height <= rect.top) return false;
		return true;
	}
	/** @internal */
	...
	*/
	_markAsDirty(force = false) {
		...
		this._isDirty = true;
		this._markMatrixAsDirty();
		if (this._host) this._host.markAsDirty();
	}
	/** @internal */
	_markAllAsDirty() {
		this._markAsDirty();
		if (this._font) this._prepareFont();
	}
	/**
	* @internal
	*/
	_link(host) {
		this._host = host;
		if (this._host) this.uniqueId = this._host.getScene().getUniqueId();
	}
	/**
	* @internal
	*/
	_transform(context) {
		if (!this._isMatrixDirty && this._scaleX === 1 && this._scaleY === 1 && this._rotation === 0) return;
	...
	*/
	_applyStates(context) {
		if (this._isFontSizeInPercentage) this._fontSet = true;
		if (this._host && this._host.useSmallestIdeal && !this._font) this._fontSet = true;
		if (this._fontSet) {
			this._prepareFont();
			this._fontSet = false;
		}
		if (this._font) context.font = this._font;
		if (this._color || this.gradient) context.fillStyle = this._getColor(context);
		if (Control.AllowAlphaInheritance) context.globalAlpha *= this._alpha;
		else if (this._alphaSet) context.globalAlpha = this.parent && !this.parent.renderToIntermediateTexture ? this.parent.alpha * this._alpha : this._alpha;
	}
	/**
	* @internal
	*/
	_layout(parentMeasure, context) {
		...
		if (this._isDirty || !this._cachedParentMeasure.isEqualsTo(parentMeasure)) {
			...
			if (rebuildCount >= 3) Logger.Error(`Layout cycle detected in GUI (Control name=${this.name}, uniqueId=${this.uniqueId})`);
			context.restore();
			this.invalidateRect();
	...
	*/
	_processMeasures(parentMeasure, context) {
		...
		this._currentMeasure.transformToRef(this._transformMatrix, this._evaluatedMeasure);
		if (this.onDirtyObservable.hasObservers()) this.onDirtyObservable.notifyObservers(this);
	}
	...
	/** @internal */
	_measure() {
		if (this._width.isPixel) this._currentMeasure.width = this._width.getValue(this._host);
		else this._currentMeasure.width *= this._width.getValue(this._host);
		if (this._height.isPixel) this._currentMeasure.height = this._height.getValue(this._host);
		else this._currentMeasure.height *= this._height.getValue(this._host);
		if (this._fixedRatio !== 0) if (this._fixedRatioMasterIsWidth) this._currentMeasure.height = this._currentMeasure.width * this._fixedRatio;
		else this._currentMeasure.width = this._currentMeasure.height * this._fixedRatio;
	}
	/**
	* @internal
	*/
	_computeAlignment(parentMeasure, context) {
		...
		if (!this.descendantsOnlyPadding) {
			...
			if (this._paddingRight.isPixel) this._currentMeasure.width -= this._paddingRight.getValue(this._host);
			else this._currentMeasure.width -= parentWidth * this._paddingRight.getValue(this._host);
			...
			if (this._paddingBottom.isPixel) this._currentMeasure.height -= this._paddingBottom.getValue(this._host);
			else this._currentMeasure.height -= parentHeight * this._paddingBottom.getValue(this._host);
		}
		if (this._left.isPixel) this._currentMeasure.left += this._left.getValue(this._host);
		else this._currentMeasure.left += parentWidth * this._left.getValue(this._host);
		if (this._top.isPixel) this._currentMeasure.top += this._top.getValue(this._host);
		else this._currentMeasure.top += parentHeight * this._top.getValue(this._host);
	...
	*/
	...
	_clip(context, invalidatedRectangle) {
		...
		} else context.rect(Control._ClipMeasure.left, Control._ClipMeasure.top, Control._ClipMeasure.width, Control._ClipMeasure.height);
		context.clip();
	}
	/**
	* @internal
	*/
	_render(context, invalidatedRectangle) {
		...
		this._applyStates(context);
		this._transform(context);
		if (this.clipContent) this._clip(context, invalidatedRectangle);
		if (this.onBeforeDrawObservable.hasObservers()) this.onBeforeDrawObservable.notifyObservers(this);
		if (this.useBitmapCache && !this._wasDirty && this._cacheData) context.putImageData(this._cacheData, this._currentMeasure.left, this._currentMeasure.top);
		else this._draw(context, invalidatedRectangle);
		if (this.useBitmapCache && this._wasDirty) this._cacheData = context.getImageData(this._currentMeasure.left, this._currentMeasure.top, this._currentMeasure.width, this._currentMeasure.height);
		this._renderHighlight(context);
		if (this.onAfterDrawObservable.hasObservers()) this.onAfterDrawObservable.notifyObservers(this);
		context.restore();
		return true;
	}
	/**
	...
	*/
	contains(x, y) {
		...
		if (x < this._currentMeasure.left) return false;
		if (x > this._currentMeasure.left + this._currentMeasure.width) return false;
		if (y < this._currentMeasure.top) return false;
		if (y > this._currentMeasure.top + this._currentMeasure.height) return false;
		if (this.isPointerBlocker) this._host._shouldBlockPointer = true;
		return true;
	}
	/**
	* @internal
	*/
	_processPicking(x, y, pi, type, pointerId, buttonIndex, deltaX, deltaY) {
		...
		if (!this.isHitTestVisible || !this.isVisible || this._doNotRender) return false;
	...
	*/
	_onPointerMove(target, coordinates, pointerId, pi) {
		if (this.onPointerMoveObservable.notifyObservers(coordinates, -1, target, this, pi) && this.parent != null && !this.isPointerBlocker) this.parent._onPointerMove(target, coordinates, pointerId, pi);
	}
	/**
	* @internal
	*/
	_onPointerEnter(target, pi) {
		if (!this._isEnabled) return false;
		if (this._enterCount > 0) return false;
		if (this._enterCount === -1) this._enterCount = 0;
		this._enterCount++;
		if (this.onPointerEnterObservable.notifyObservers(this, -1, target, this, pi) && this.parent != null && !this.isPointerBlocker) this.parent._onPointerEnter(target, pi);
		return true;
	}
	/**
	* @internal
	*/
	_onPointerOut(target, pi, force = false) {
		if (!force && !this._isEnabled) return;
		this._enterCount = 0;
		let canNotify = true;
		if (!target.isAscendant(this)) canNotify = this.onPointerOutObservable.notifyObservers(this, -1, target, this, pi);
		if (canNotify && this.parent != null && !this.isPointerBlocker) this.parent._onPointerOut(target, pi, force);
	}
	/**
	* @internal
	*/
	_onPointerDown(target, coordinates, pointerId, buttonIndex, pi) {
		...
		if (this.tabIndex !== -1) this.host.focusedControl = this;
		if (this._downCount !== 0) return false;
		this._downCount++;
		this._downPointerIds[pointerId] = true;
		if (this.onPointerDownObservable.notifyObservers(new Vector2WithInfo(coordinates, buttonIndex), -1, target, this, pi) && this.parent != null && !this.isPointerBlocker) this.parent._onPointerDown(target, coordinates, pointerId, buttonIndex, pi);
		if (pi && this.uniqueId !== this._host.rootContainer.uniqueId) this._host._capturedPointerIds.add(pi.event.pointerId);
		return true;
	}
	/**
	* @internal
	*/
	_onPointerUp(target, coordinates, pointerId, buttonIndex, notifyClick, pi) {
		...
		if (notifyClick && (this._enterCount > 0 || this._enterCount === -1)) {
			if (!this._host.usePointerTapForClickEvent) canNotifyClick = this.onPointerClickObservable.notifyObservers(new Vector2WithInfo(coordinates, buttonIndex), -1, target, this, pi);
		}
		if (this.onPointerUpObservable.notifyObservers(new Vector2WithInfo(coordinates, buttonIndex), -1, target, this, pi) && this.parent != null && !this.isPointerBlocker) this.parent._onPointerUp(target, coordinates, pointerId, buttonIndex, canNotifyClick, pi);
		if (pi && this.uniqueId !== this._host.rootContainer.uniqueId) this._host._capturedPointerIds.delete(pi.event.pointerId);
		if (this._host.usePointerTapForClickEvent && this.isPointerBlocker) this._host._shouldBlockPointer = false;
	}
	_onPointerPick(target, coordinates, pointerId, buttonIndex, notifyClick, pi) {
		...
		let canNotifyClick = notifyClick;
		if (notifyClick && (this._enterCount > 0 || this._enterCount === -1)) canNotifyClick = this.onPointerClickObservable.notifyObservers(new Vector2WithInfo(coordinates, buttonIndex), -1, target, this, pi);
		if (this.onPointerUpObservable.notifyObservers(new Vector2WithInfo(coordinates, buttonIndex), -1, target, this, pi) && this.parent != null && !this.isPointerBlocker) this.parent._onPointerPick(target, coordinates, pointerId, buttonIndex, canNotifyClick, pi);
		if (this._host.usePointerTapForClickEvent && this.isPointerBlocker) this._host._shouldBlockPointer = true;
		return true;
	}
	/**
	* @internal
	*/
	_forcePointerUp(pointerId = null) {
		if (pointerId !== null) this._onPointerUp(this, Vector2.Zero(), pointerId, 0, true);
		else for (const key in this._downPointerIds) this._onPointerUp(this, Vector2.Zero(), +key, 0, true);
	}
	/**
	* @internal
	*/
	_onWheelScroll(deltaX, deltaY) {
		if (!this._isEnabled) return;
		if (this.onWheelObservable.notifyObservers(new Vector2(deltaX, deltaY)) && this.parent != null) this.parent._onWheelScroll(deltaX, deltaY);
	}
	/** @internal */
	_onCanvasBlur() {}
	/**
	...
	*/
	_processObservables(type, x, y, pi, pointerId, buttonIndex, deltaX, deltaY) {
		...
		if (type === PointerEventTypes.POINTERMOVE) {
			...
			if (previousControlOver && previousControlOver !== this) previousControlOver._onPointerOut(this, pi);
			if (previousControlOver !== this) this._onPointerEnter(this, pi);
			...
			if (this._host._lastControlDown[pointerId]) this._host._lastControlDown[pointerId]._onPointerUp(this, this._dummyVector2, pointerId, buttonIndex, true, pi);
			if (!this._host.usePointerTapForClickEvent) delete this._host._lastControlDown[pointerId];
			return true;
			...
			if (this._host._lastControlDown[pointerId]) this._host._lastControlDown[pointerId]._onPointerPick(this, this._dummyVector2, pointerId, buttonIndex, true, pi);
	...
	_getStyleProperty(propName, defaultValue) {
		...
		if (!prop && this.parent) return this.parent._getStyleProperty(propName, defaultValue);
		else if (!this.parent) return defaultValue;
		else return prop;
	}
	_prepareFont() {
		if (!this._font && !this._fontSet) return;
	...
	*/
	getDimension(dim) {
		if (dim === "width") return this._width;
	...
	*/
	clone(host) {
		...
		const cloned = new (Tools.Instantiate("BABYLON.GUI." + serialization.className))();
	...
	*/
	serialize(serializationObject, force = false, allowCanvas = true) {
		if (!this.isSerializable && !force) return;
		let idealWidth = 0;
		let idealHeight = 0;
		if (this.host) {
		...
		if (allowCanvas) this._prepareFont();
		if (this._fontFamily) serializationObject.fontFamily = this._fontFamily;
		if (this.fontSize) serializationObject.fontSize = this.fontSize;
		if (this.fontWeight) serializationObject.fontWeight = this.fontWeight;
		if (this.fontStyle) serializationObject.fontStyle = this.fontStyle;
		if (this._gradient) {
	...
	*/
	_parseFromContent(serializedObject, host, urlRewriter) {
		if (serializedObject.fontFamily) this.fontFamily = serializedObject.fontFamily;
		if (serializedObject.fontSize) this.fontSize = serializedObject.fontSize;
		if (serializedObject.fontWeight) this.fontWeight = serializedObject.fontWeight;
		if (serializedObject.fontStyle) this.fontStyle = serializedObject.fontStyle;
		if (serializedObject.gradient) {
			this._gradient = new (Tools.Instantiate("BABYLON.GUI." + serializedObject.gradient.className))();
		...
		if (serializedObject.animations) {
			...
			for (let animationIndex = 0; animationIndex < serializedObject.animations.length; animationIndex++) {
				...
				if (internalClass) this.animations.push(internalClass.Parse(parsedAnimation));
			}
			if (serializedObject.autoAnimate && this._host && this._host.getScene()) this._host.getScene().beginAnimation(this, serializedObject.autoAnimateFrom, serializedObject.autoAnimateTo, serializedObject.autoAnimateLoop, serializedObject.autoAnimateSpeed || 1);
		}
	...
	dispose() {
		...
		if (this._host) {
			if (this._host._linkedControls.indexOf(this) > -1) this.linkWithMesh(null);
		}
	...
	*/
	static _GetFontOffset(font, engineToUse) {
		if (Control._FontHeightSizes[font]) return Control._FontHeightSizes[font];
		const engine = engineToUse || EngineStore.LastCreatedEngine;
		if (!engine) throw new Error("Invalid engine. Unable to create a canvas.");
...
__decorate([serialize()], Control.prototype, "isSerializable", void 0);
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/container.js
/**
...
var Container = class extends Control {
	...
	set renderToIntermediateTexture(value) {
		if (this._renderToIntermediateTexture === value) return;
	...
	set adaptHeightToChildren(value) {
		if (this._adaptHeightToChildren === value) return;
		this._adaptHeightToChildren = value;
		if (value) this.height = "100%";
		this._markAsDirty();
	}
	...
	set adaptWidthToChildren(value) {
		if (this._adaptWidthToChildren === value) return;
	...
	set backgroundGradient(value) {
		if (this._backgroundGradient === value) return;
	...
	set isReadOnly(value) {
		this._isReadOnly = value;
		for (const child of this._children) child.isReadOnly = value;
	}
	/**
	...
	*/
	getChildByType(name, type) {
		for (const child of this.children) if (child.typeName === type) return child;
		return null;
	}
	/**
	...
	*/
	addControl(control) {
		...
		if (this._children.indexOf(control) !== -1) return this;
	...
	*/
	clearControls() {
		...
		for (const child of children) this.removeControl(child);
		return this;
	}
	/**
	...
	*/
	removeControl(control) {
		...
		if (this._host) this._host._cleanControlAfterRemoval(control);
		this._markAsDirty();
	...
	*/
	_reOrderControl(control) {
		...
		let wasAdded = false;
		for (let index = 0; index < this._children.length; index++) if (this._children[index].zIndex > control.zIndex) {
			this._children.splice(index, 0, control);
			wasAdded = true;
			break;
		}
		if (!wasAdded) this._children.push(control);
		control.parent = this;
		if (linkedMesh) control.linkWithMesh(linkedMesh);
		this._markAsDirty();
	}
	/**
	* @internal
	*/
	_offsetLeft(offset) {
		...
		for (const child of this._children) child._offsetLeft(offset);
	}
	/**
	* @internal
	*/
	_offsetTop(offset) {
		...
		for (const child of this._children) child._offsetTop(offset);
	}
	/** @internal */
	_markAllAsDirty() {
		super._markAllAsDirty();
		for (let index = 0; index < this._children.length; index++) this._children[index]._markAllAsDirty();
	}
	...
	*/
	_link(host) {
		super._link(host);
		for (const child of this._children) child._link(host);
	}
	/** @internal */
	_beforeLayout() {}
	/**
	...
	_processMeasures(parentMeasure, context) {
		if (this._isDirty || !this._cachedParentMeasure.isEqualsTo(parentMeasure)) {
			...
			if (this._renderToIntermediateTexture) {
				...
				} else this._intermediateTexture.scaleTo(this._currentMeasure.width, this._currentMeasure.height);
			}
		}
	}
	/**
	...
	*/
	_layout(parentMeasure, context) {
		if (!this.isDirty && (!this.isVisible || this.notRenderable)) return false;
		this.host._numLayoutCalls++;
		if (this._isDirty) this._currentMeasure.transformToRef(this._transformMatrix, this._prevCurrentMeasureTransformedIntoGlobalSpace);
		let rebuildCount = 0;
		context.save();
		this._applyStates(context);
		this._beforeLayout();
				...
				for (const child of this._children) {
					...
					if (child._layout(this._measureForChildren, context)) {
						if (child.isVisible && !child.notRenderable) {
							if (this.adaptWidthToChildren && child._width.isPixel) computedWidth = Math.max(computedWidth, child._currentMeasure.width + child._paddingLeftInPixels + child._paddingRightInPixels);
							if (this.adaptHeightToChildren && child._height.isPixel) computedHeight = Math.max(computedHeight, child._currentMeasure.height + child._paddingTopInPixels + child._paddingBottomInPixels);
						}
					}
				}
		...
		if (rebuildCount >= 3 && this.logLayoutCycleErrors) Logger.Error(`Layout cycle detected in GUI (Container name=${this.name}, uniqueId=${this.uniqueId})`);
		context.restore();
		if (this._isDirty) {
			this.invalidateRect();
			this._isDirty = false;
	...
	*/
	_draw(context, invalidatedRectangle) {
		...
		if (renderToIntermediateTextureThisDraw) {
			...
			} else contextToDrawTo.clearRect(this._currentMeasure.left, this._currentMeasure.top, this._currentMeasure.width, this._currentMeasure.height);
		}
		this._localDraw(contextToDrawTo);
		context.save();
		if (this.clipChildren) this._clipForChildren(contextToDrawTo);
		for (const child of this._children) {
			if (invalidatedRectangle) {
				if (!child._intersectsRect(invalidatedRectangle)) continue;
			}
	...
	getDescendantsToRef(results, directDescendantsOnly = false, predicate) {
		...
		for (let index = 0; index < this.children.length; index++) {
			...
			if (!directDescendantsOnly) item.getDescendantsToRef(results, false, predicate);
		}
	}
	/**
	* @internal
	*/
	_processPicking(x, y, pi, type, pointerId, buttonIndex, deltaX, deltaY) {
		...
		if (!contains && this.clipChildren) return false;
		...
		for (let index = this._children.length - 1; index >= 0; index--) {
			...
			if (child._processPicking(x, y, pi, type, pointerId, buttonIndex, deltaX, deltaY)) {
				if (child.hoverCursor) this._host._changeCursor(child.hoverCursor);
				return true;
			}
		}
		if (!contains) return false;
	...
	*/
	...
	_getAdaptDimTo(dim) {
		if (dim === "width") return this.adaptWidthToChildren;
		else return this.adaptHeightToChildren;
	}
	isDimensionFullyDefined(dim) {
		if (this._getAdaptDimTo(dim)) {
			for (const child of this.children) if (!child.isDimensionFullyDefined(dim)) return false;
			return true;
		}
	...
	*/
	serialize(serializationObject, force = false, allowCanvas = true) {
		...
		for (const child of this.children) if (child.isSerializable || force) {
	...
	dispose() {
		super.dispose();
		for (let index = this.children.length - 1; index >= 0; index--) this.children[index].dispose();
		this._intermediateTexture?.dispose();
	}
	/**
	* @internal
	*/
	_parseFromContent(serializedObject, host, urlRewriter) {
		...
		if (serializedObject.backgroundGradient) {
			this._backgroundGradient = new (Tools.Instantiate("BABYLON.GUI." + serializedObject.backgroundGradient.className))();
			this._backgroundGradient?.parse(serializedObject.backgroundGradient);
		}
		if (!serializedObject.children) return;
		for (const childData of serializedObject.children) this.addControl(Control.Parse(childData, host, urlRewriter));
	}
	isReady() {
		for (const child of this.children) if (!child.isReady()) return false;
		return true;
	}
};
__decorate([serialize()], Container.prototype, "delegatePickingToChildren", void 0);
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/rectangle.js
...
var Rectangle = class extends Container {
	...
	set cornerRadius(value) {
		if (value < 0) value = 0;
		if (this._cornerRadius[0] === value && this._cornerRadius[1] === value && this._cornerRadius[2] === value && this._cornerRadius[3] === value) return;
	...
	set cornerRadiusX(value) {
		if (this._cornerRadius[0] === value) return;
	...
	set cornerRadiusY(value) {
		if (this._cornerRadius[1] === value) return;
	...
	set cornerRadiusZ(value) {
		if (this._cornerRadius[2] === value) return;
	...
	set cornerRadiusW(value) {
		if (this._cornerRadius[3] === value) return;
	...
	*/
	...
	_computeAdditionalOffsetX() {
		...
		if (this._cornerRadius[0] !== 0 || this._cornerRadius[1] !== 0 || this._cornerRadius[2] !== 0 || this._cornerRadius[3] !== 0) additionalWidth += 1;
		if (this.thickness) additionalWidth += this.thickness / 2;
		return additionalWidth;
	}
	/** @internal */
	_computeAdditionalOffsetY() {
		let additionalHeight = 0;
		if (this._cornerRadius[0] !== 0 || this._cornerRadius[1] !== 0 || this._cornerRadius[2] !== 0 || this._cornerRadius[3] !== 0) additionalHeight += 1;
		if (this.thickness) additionalHeight += this.thickness / 2;
	...
	_localDraw(context) {
		...
		if (this._background || this._backgroundGradient) {
			...
			if (this._cornerRadius[0] !== 0 || this._cornerRadius[1] !== 0 || this._cornerRadius[2] !== 0 || this._cornerRadius[3] !== 0) {
				...
				context.fill();
			} else context.fillRect(this._currentMeasure.left, this._currentMeasure.top, this._currentMeasure.width, this._currentMeasure.height);
		}
		if (this._thickness) {
			if (this.shadowBlur || this.shadowOffsetX || this.shadowOffsetY) {
			...
			if (this.color || this.gradient) context.strokeStyle = this.gradient ? this.gradient.getCanvasGradient(context) : this.color;
			context.lineWidth = this._thickness;
			if (this._cornerRadius[0] !== 0 || this._cornerRadius[1] !== 0 || this._cornerRadius[2] !== 0 || this._cornerRadius[3] !== 0) {
				this._drawRoundedRect(context, this._thickness / 2);
				context.stroke();
			} else context.strokeRect(this._currentMeasure.left + this._thickness / 2, this._currentMeasure.top + this._thickness / 2, this._currentMeasure.width - this._thickness, this._currentMeasure.height - this._thickness);
		}
		context.restore();
	}
	_additionalProcessing(parentMeasure, context) {
	...
	_drawRoundedRect(context, offset = 0) {
		...
		for (let index = 0; index < this._cornerRadius.length; index++) this._cachedRadius[index] = Math.abs(Math.min(height / 2, Math.min(width / 2, this._cornerRadius[index])));
		context.beginPath();
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/textBlock.js
/**
...
var TextBlock = class extends Control {
	...
	*/
	set resizeToFit(value) {
		if (this._resizeToFit === value) return;
	...
	*/
	set textWrapping(value) {
		if (this._textWrapping === value) return;
	...
	*/
	set textHorizontalAlignment(value) {
		if (this._textHorizontalAlignment === value) return;
	...
	*/
	set textVerticalAlignment(value) {
		if (this._textVerticalAlignment === value) return;
	...
	*/
	set lineSpacing(value) {
		if (this._lineSpacing.fromString(value)) this._markAsDirty();
	}
	/**
	* Gets or sets line spacing value
	*/
	...
	*/
	set lineThrough(value) {
		if (this._lineThrough === value) return;
	...
	*/
	...
	set applyOutlineToUnderline(value) {
		if (this._applyOutlineToUnderline === value) return;
	...
	*/
	set wordDivider(value) {
		if (this._wordDivider === value) return;
	...
	*/
	...
	set forceResizeWidth(value) {
		if (this._forceResizeWidth === value) return;
	...
	*/
	...
	_processMeasures(parentMeasure, context) {
		if (!this._fontOffset || this.isDirty) this._fontOffset = Control._GetFontOffset(context.font, this._host.getScene()?.getEngine());
		super._processMeasures(parentMeasure, context);
		...
		if (this._resizeToFit) {
			...
			if (this._lines.length > 0 && this._lineSpacing.internalValue !== 0) {
				let lineSpacing = 0;
				if (this._lineSpacing.isPixel) lineSpacing = this._lineSpacing.getValue(this._host);
				else lineSpacing = this._lineSpacing.getValue(this._host) * this._height.getValueInPixel(this._host, this._cachedParentMeasure.height);
	...
	_drawText(text, textWidth, y, context) {
		...
		if (this.outlineWidth) context.strokeText(text, this._currentMeasure.left + x, y);
		context.fillText(text, this._currentMeasure.left + x, y);
		if (this._underline) this._drawLine(this._currentMeasure.left + x, y + 3, this._currentMeasure.left + x + textWidth, y + 3, context);
		if (this._lineThrough) this._drawLine(this._currentMeasure.left + x, y - this.fontSizeInPixels / 3, this._currentMeasure.left + x + textWidth, y - this.fontSizeInPixels / 3, context);
	}
	_drawLine(xFrom, yFrom, xTo, yTo, context) {
		context.beginPath();
		context.lineWidth = Math.round(this.fontSizeInPixels * .05);
	...
	*/
	...
	_breakLines(refWidth, refHeight, context) {
		...
		switch (this._textWrapping) {
			case 1:
				for (const _line of _lines) this._linesTemp.push(...this._parseLineWordWrap(_line, refWidth, context));
				break;
			case 2:
				for (const _line of _lines) this._linesTemp.push(this._parseLineEllipsis(_line, refWidth, context));
				break;
			case 3:
				for (const _line of _lines) this._linesTemp.push(...this._parseLineWordWrapEllipsis(_line, refWidth, refHeight, context));
				break;
			default:
				for (const _line of _lines) this._linesTemp.push(this._parseLine(_line, context));
				break;
		}
	...
	_getCharsToRemove(lineWidth, width, lineLength) {
		...
		return Math.max(Math.floor(diff / charWidth), 1);
	}
	_parseLineEllipsis(line = "", width, context) {
		...
		if (!characters) {
			...
			line += "…";
		} else while (characters.length && lineWidth > width) {
	...
	_getTextMetricsWidth(textMetrics) {
		if (textMetrics.actualBoundingBoxLeft !== void 0) return Math.abs(textMetrics.actualBoundingBoxLeft) + Math.abs(textMetrics.actualBoundingBoxRight);
	...
	_parseLineWordWrapEllipsis(line = "", width, height, context) {
		...
		for (let n = 1; n <= lines.length; n++) if (this._computeHeightForLinesOf(n) > height && n > 1) {
			...
			for (let i = 0; i < linesToRemove; i++) lines.pop();
			return lines;
		}
		return lines;
	}
	_renderLines(context) {
		if (!this._fontOffset || !this._lines) return;
		const height = this._currentMeasure.height;
		let rootY = 0;
		...
		for (let i = 0; i < this._lines.length; i++) {
			const line = this._lines[i];
			if (i !== 0 && this._lineSpacing.internalValue !== 0) if (this._lineSpacing.isPixel) rootY += this._lineSpacing.getValue(this._host);
			else rootY = rootY + this._lineSpacing.getValue(this._host) * this._height.getValueInPixel(this._host, this._cachedParentMeasure.height);
	...
	isDimensionFullyDefined(dim) {
		if (this.resizeToFit) return true;
		return super.isDimensionFullyDefined(dim);
	}
	/**
	...
	*/
	computeExpectedHeight() {
		if (this.text && this.widthInPixels) {
			...
			if (context) {
				this._applyStates(context);
				if (!this._fontOffset) this._fontOffset = Control._GetFontOffset(context.font, this._host.getScene()?.getEngine());
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/image.js
/**
* Class used to create 2D images
*/
var Image = class Image extends Control {
	/**
	...
	*/
	...
	set detectPointerOnOpaqueOnly(value) {
		if (this._detectPointerOnOpaqueOnly === value) return;
	...
	*/
	...
	set sliceLeft(value) {
		if (this._sliceLeft === value) return;
	...
	*/
	...
	set sliceRight(value) {
		if (this._sliceRight === value) return;
	...
	*/
	...
	set sliceTop(value) {
		if (this._sliceTop === value) return;
	...
	*/
	...
	set sliceBottom(value) {
		if (this._sliceBottom === value) return;
	...
	*/
	...
	set sourceLeft(value) {
		if (this._sourceLeft === value) return;
	...
	*/
	...
	set sourceTop(value) {
		if (this._sourceTop === value) return;
	...
	*/
	...
	set sourceWidth(value) {
		if (this._sourceWidth === value) return;
	...
	*/
	...
	set sourceHeight(value) {
		if (this._sourceHeight === value) return;
	...
	*/
	...
	set populateNinePatchSlicesFromImage(value) {
		if (this._populateNinePatchSlicesFromImage === value) return;
		this._populateNinePatchSlicesFromImage = value;
		if (this._populateNinePatchSlicesFromImage && this._loaded) this._extractNinePatchSliceDataFromImage();
	}
	...
	*/
	...
	set autoScale(value) {
		if (this._autoScale === value) return;
		this._autoScale = value;
		if (value && this._loaded) this.synchronizeSizeWithContent();
	}
	...
	_rotate90SourceProperties(srcImage, dstImage, n) {
		...
		if (n != 0) {
			...
			for (let i = 0; i < Math.abs(n); ++i) {
				...
				if (n < 0) dstTop -= dstHeight;
				else dstLeft -= dstWidth;
				srcLeft = dstLeft;
				srcTop = dstTop;
	...
	*/
	set domImage(value) {
		...
		this._loaded = false;
		this._imageDataCache.data = null;
		if (this._domImage.width) this._onImageLoaded();
		else this._domImage.onload = () => {
			this._onImageLoaded();
		};
	}
	get domImage() {
	...
	_onImageLoaded() {
		...
		this._loaded = true;
		if (this._populateNinePatchSlicesFromImage) this._extractNinePatchSliceDataFromImage();
	...
	*/
	...
	_removeCacheUsage(source) {
		...
		if (value) {
			...
			if (value.timesUsed === 0) Image.SourceImgCache.delete(source);
		}
	}
	/**
	...
	*/
	set source(value) {
		if (this._urlRewriter && value) value = this._urlRewriter(value);
		if (this._source === value) return;
		this._removeCacheUsage(this._source);
		this._loaded = false;
		this._source = value;
		this._imageDataCache.data = null;
		if (value) value = this._svgCheck(value);
		const engine = this._host?.getScene()?.getEngine() || EngineStore.LastCreatedEngine;
		if (!engine) throw new Error("Invalid engine. Unable to create a canvas.");
		if (value && Image.SourceImgCache.has(value)) {
			...
			if (cachedData.loaded) this._onImageLoaded();
			else cachedData.waitingForLoadCallback.push(this._onImageLoaded.bind(this));
			return;
		}
		...
		if (value) Image.SourceImgCache.set(value, {
			img: this._domImage,
			timesUsed: 1,
			loaded: false,
		...
		this._domImage.onload = () => {
			if (value) {
				...
				if (cachedData) {
					...
					for (const waitingCallback of cachedData.waitingForLoadCallback) waitingCallback();
		...
		if (window.SVGSVGElement && value.search(/(\.svg|\.svg?[?|#].*)$/gi) !== -1 && value.indexOf("#") === value.lastIndexOf("#")) {
			...
			if (svgExist) {
				...
				if (svgDoc && svgDoc.documentElement) {
					...
					if (svgDoc.getElementById(elemid) && vb && docwidth && docheight) {
				...
				svgImage.onload = () => {
					...
					if (svgobj) this._getSVGAttribs(svgobj, elemid);
				};
			}
			return svgsrc;
		} else return value;
	...
	*/
	contains(x, y) {
		...
		return imageData[(x + y * width) * 4 + 3] > 0;
	}
	_getTypeName() {
		return "Image";
	}
	...
	_processMeasures(parentMeasure, context) {
		if (this._loaded) switch (this._stretch) {
			case Image.STRETCH_NONE: break;
			case Image.STRETCH_FILL: break;
			case Image.STRETCH_UNIFORM: break;
			case Image.STRETCH_NINE_PATCH: break;
	...
	_prepareWorkingCanvasForOpaqueDetection() {
		if (!this._detectPointerOnOpaqueOnly) return;
		const width = this._currentMeasure.width;
		const height = this._currentMeasure.height;
		if (!this._workingCanvas) {
			const engine = this._host?.getScene()?.getEngine() || EngineStore.LastCreatedEngine;
		...
		this._workingCanvas.getContext("2d").clearRect(0, 0, width, height);
	}
	_drawImage(context, sx, sy, sw, sh, tx, ty, tw, th) {
		context.drawImage(this._domImage, sx, sy, sw, sh, tx, ty, tw, th);
		if (!this._detectPointerOnOpaqueOnly) return;
		const transform = context.getTransform();
		const workingCanvasContext = this._workingCanvas.getContext("2d");
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/button.js
/**
...
var Button = class extends Rectangle {
	...
	*/
	constructor(name) {
		...
		this.pointerOutAnimation = () => {
			if (alphaStore !== null) this.alpha = alphaStore;
		};
	...
	*/
	_onPointerEnter(target, pi) {
		if (!super._onPointerEnter(target, pi)) return false;
		if (!this.isReadOnly && this.pointerEnterAnimation) this.pointerEnterAnimation();
		return true;
	}
	/**
	* @internal
	*/
	_onPointerOut(target, pi, force = false) {
		if (!this.isReadOnly && this.pointerOutAnimation) this.pointerOutAnimation();
	...
	*/
	_onPointerDown(target, coordinates, pointerId, buttonIndex, pi) {
		if (!super._onPointerDown(target, coordinates, pointerId, buttonIndex, pi)) return false;
		if (!this.isReadOnly && this.pointerDownAnimation) this.pointerDownAnimation();
		return true;
	}
	_getRectangleFill(context) {
		if (this.isEnabled) return this._getBackgroundColor(context);
		else return this._disabledColor;
	}
	/**
	* @internal
	*/
	_onPointerUp(target, coordinates, pointerId, buttonIndex, notifyClick, pi) {
		if (!this.isReadOnly && this.pointerUpAnimation) this.pointerUpAnimation();
	...
	*/
	serialize(serializationObject, force) {
		...
		if (!this.isSerializable && !force) return;
		if (this._textBlock) serializationObject.textBlockName = this._textBlock.name;
		if (this._image) serializationObject.imageName = this._image.name;
	}
	/**
	* @internal
	*/
	_parseFromContent(serializedObject, host) {
		...
		if (serializedObject.textBlockName) this._textBlock = this.getChildByName(serializedObject.textBlockName);
		if (serializedObject.imageName) this._image = this.getChildByName(serializedObject.imageName);
	}
	/**
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/stackPanel.js
/**
...
var StackPanel = class extends Container {
	...
	*/
	set width(value) {
		if (!this._doNotTrackManualChanges) this._manualWidth = true;
		if (this._width.toString(this._host) === value) return;
		if (this._width.fromString(value)) this._markAsDirty();
	}
	get width() {
	...
	*/
	set height(value) {
		if (!this._doNotTrackManualChanges) this._manualHeight = true;
		if (this._height.toString(this._host) === value) return;
		if (this._height.fromString(value)) this._markAsDirty();
	}
	get height() {
	...
	*/
	_preMeasure(parentMeasure, context) {
		for (const child of this._children) if (this._isVertical) child.verticalAlignment = Control.VERTICAL_ALIGNMENT_TOP;
		else child.horizontalAlignment = Control.HORIZONTAL_ALIGNMENT_LEFT;
	...
	_additionalProcessing(parentMeasure, context) {
		...
		if (!this.isVertical || this._manualWidth) this._measureForChildren.width = this._currentMeasure.width;
		if (this.isVertical || this._manualHeight) this._measureForChildren.height = this._currentMeasure.height;
	}
	_postMeasure() {
		let stackWidth = 0;
		let stackHeight = 0;
		...
		for (let index = 0; index < childrenCount; index++) {
			...
			if (this._isVertical) {
				...
				if (!this.ignoreLayoutWarnings && !child.isDimensionFullyDefined("height")) Logger.Warn(`Control (Name:${child.name}, UniqueId:${child.uniqueId}) is using height in percentage mode inside a vertical StackPanel`, 1);
				else stackHeight += child._currentMeasure.height + child._paddingTopInPixels + child._paddingBottomInPixels + (index < childrenCount - 1 ? this._spacing : 0);
			} else {
				...
				if (!this.ignoreLayoutWarnings && !child.isDimensionFullyDefined("width")) Logger.Warn(`Control (Name:${child.name}, UniqueId:${child.uniqueId}) is using width in percentage mode inside a horizontal StackPanel`, 1);
				else stackWidth += child._currentMeasure.width + child._paddingLeftInPixels + child._paddingRightInPixels + (index < childrenCount - 1 ? this._spacing : 0);
			}
		}
		...
		if (panelHeightChanged) this._height.ignoreAdaptiveScaling = true;
		if (panelWidthChanged) this._width.ignoreAdaptiveScaling = true;
		this._doNotTrackManualChanges = false;
		if (panelWidthChanged || panelHeightChanged) this._rebuildLayout = true;
		super._postMeasure();
	}
	_getManualDim(dim) {
		if (dim === "width") return this._manualWidth;
		else return this._manualHeight;
	}
	isDimensionFullyDefined(dim) {
		if (dim === "height" ? this.isVertical : !this.isVertical && !this._getManualDim(dim)) {
			for (const child of this._children) if (!child.isDimensionFullyDefined(dim)) return false;
			return true;
		}
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/checkbox.js
/**
* Class used to represent a 2D checkbox
*/
var Checkbox = class Checkbox extends Control {
	/** Gets or sets border thickness  */
	get thickness() {
		return this._thickness;
	}
	...
	set checkSizeRatio(value) {
		...
		if (this._checkSizeRatio === value) return;
	...
	*/
	_onPointerDown(target, coordinates, pointerId, buttonIndex, pi) {
		if (!super._onPointerDown(target, coordinates, pointerId, buttonIndex, pi)) return false;
		if (!this.isReadOnly) this.isChecked = !this.isChecked;
		return true;
	}
	/**
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/textWrapper.js
/** @internal */
var TextWrapper = class {
	...
	substr(from, length) {
		if (this._characters) {
			...
			else if (from >= 0) from = Math.min(from, this._characters.length);
			else from = this._characters.length + Math.max(from, -this._characters.length);
			if (length === void 0) length = this._characters.length - from;
			else if (isNaN(length)) length = 0;
			else if (length < 0) length = 0;
			const temp = [];
			while (--length >= 0) temp[length] = this._characters[from + length];
			return temp.join("");
		}
	...
	substring(from, to) {
		if (this._characters) {
			if (isNaN(from)) from = 0;
			else if (from > this._characters.length) from = this._characters.length;
			else if (from < 0) from = 0;
			if (to === void 0) to = this._characters.length;
			else if (isNaN(to)) to = 0;
			else if (to > this._characters.length) to = this._characters.length;
			else if (to < 0) to = 0;
			const temp = [];
			let idx = 0;
			while (from < to) temp[idx++] = this._characters[from++];
			return temp.join("");
		}
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/inputText.js
/**
...
var InputText = class extends Control {
	...
	*/
	...
	set maxWidth(value) {
		if (this._maxWidth.toString(this._host) === value) return;
		if (this._maxWidth.fromString(value)) this._markAsDirty();
	}
	...
	set highligherOpacity(value) {
		if (this._highligherOpacity === value) return;
	...
	set onFocusSelectAll(value) {
		if (this._onFocusSelectAll === value) return;
	...
	set textHighlightColor(value) {
		if (this._textHighlightColor === value) return;
	...
	set margin(value) {
		if (this._margin.toString(this._host) === value) return;
		if (this._margin.fromString(value)) this._markAsDirty();
	}
	...
	set autoStretchWidth(value) {
		if (this._autoStretchWidth === value) return;
	...
	set focusedBackground(value) {
		if (this._focusedBackground === value) return;
		this._focusedBackground = value;
		this._markAsDirty();
	}
	/** Gets or sets the background color when focused */
	set focusedColor(value) {
		if (this._focusedColor === value) return;
		this._focusedColor = value;
		this._markAsDirty();
	}
	...
	set placeholderColor(value) {
		if (this._placeholderColor === value) return;
	...
	set placeholderText(value) {
		if (this._placeholderText === value) return;
	...
	set highlightedText(text) {
		if (this._highlightedText === text) return;
	...
	set text(value) {
		...
		if (!this._textWrapper) this._textWrapper = new TextWrapper();
		if (this._textWrapper.text === valueAsString) return;
	...
	set width(value) {
		if (this._width.toString(this._host) === value && !this._autoStretchWidth) return;
		if (this._width.fromString(value)) this._markAsDirty();
	...
	*/
	...
	onBlur() {
		...
		if (this._onClipboardObserver) this._host.onClipboardObservable.remove(this._onClipboardObserver);
		const scene = this._host.getScene();
		if (this._onPointerDblTapObserver && scene) scene.onPointerObservable.remove(this._onPointerDblTapObserver);
	}
	/** @internal */
	onFocus() {
		if (!this._isEnabled) return;
		...
		const scene = this._host.getScene();
		if (scene) this._onPointerDblTapObserver = scene.onPointerObservable.add((pointerInfo) => {
			if (!this._isFocused) return;
			if (pointerInfo.type === PointerEventTypes.POINTERDOUBLETAP) this._processDblClick(pointerInfo);
		});
		if (this._onFocusSelectAll) this.selectAllText();
	}
	_getTypeName() {
		return "InputText";
	}
	...
	*/
	keepsFocusWith() {
		if (!this._connectedVirtualKeyboard) return null;
	...
	*/
	processKey(keyCode, key, evt) {
		...
		if (evt && (evt.ctrlKey || evt.metaKey) && (keyCode === 67 || keyCode === 86 || keyCode === 88)) return;
		...
		switch (keyCode) {
			...
			case 8:
				if (this._textWrapper.text && this._textWrapper.length > 0) {
					...
					if (this._cursorOffset === 0) this.text = this._textWrapper.substring(0, this._textWrapper.length - 1);
					else {
			...
			case 37:
				this._cursorOffset++;
				if (this._cursorOffset > this._textWrapper.length) this._cursorOffset = this._textWrapper.length;
				if (evt && evt.shiftKey) {
					this._blinkIsEven = false;
					if (evt.ctrlKey || evt.metaKey) {
						if (!this.isTextHighlightOn) if (this._textWrapper.length === this._cursorOffset) return;
						else this._endHighlightIndex = this._textWrapper.length - this._cursorOffset + 1;
						this._startHighlightIndex = 0;
					...
					} else this.isTextHighlightOn = false;
					this._markAsDirty();
					return;
				}
				if (this.isTextHighlightOn) {
			...
			case 39:
				this._cursorOffset--;
				if (this._cursorOffset < 0) this._cursorOffset = 0;
				if (evt && evt.shiftKey) {
					this._blinkIsEven = false;
					if (evt.ctrlKey || evt.metaKey) {
						if (!this.isTextHighlightOn) if (this._cursorOffset === 0) return;
						else this._startHighlightIndex = this._textWrapper.length - this._cursorOffset - 1;
		...
		if (keyCode === 32) key = evt?.key ?? " ";
		this._deadKey = key === "Dead";
		if (key && (keyCode === -1 || keyCode === 32 || keyCode === 34 || keyCode === 39 || keyCode > 47 && keyCode < 64 || keyCode > 64 && keyCode < 91 || keyCode > 159 && keyCode < 193 || keyCode > 218 && keyCode < 223 || keyCode > 95 && keyCode < 112)) {
			this._currentKey = key;
			this.onBeforeKeyAddObservable.notifyObservers(this);
			key = this._currentKey;
			if (this._addKey && !this._deadKey) if (this.isTextHighlightOn) {
				...
				this._blinkIsEven = false;
				this._markAsDirty();
			} else if (this._cursorOffset === 0) this.text += this._deadKey && evt?.key ? evt.key : key;
			else {
	...
	*/
	_updateValueFromCursorIndex(offset) {
		this._blinkIsEven = false;
		if (this._cursorIndex === -1) this._cursorIndex = offset;
		else if (this._cursorIndex < this._cursorOffset) {
			this._endHighlightIndex = this._textWrapper.length - this._cursorIndex;
			this._startHighlightIndex = this._textWrapper.length - this._cursorOffset;
		} else if (this._cursorIndex > this._cursorOffset) {
	...
	*/
	_onCutText(ev) {
		if (!this._highlightedText) return;
		this._textWrapper.removePart(this._startHighlightIndex, this._endHighlightIndex);
		this._textHasChanged();
		this.isTextHighlightOn = false;
		this._cursorOffset = this._textWrapper.length - this._startHighlightIndex;
	...
	*/
	_onPasteText(ev) {
		let data = "";
		if (ev.clipboardData && ev.clipboardData.types.indexOf("text/plain") !== -1) data = ev.clipboardData.getData("text/plain");
		else data = this._host.clipboardData;
		const insertPosition = this._textWrapper.length - this._cursorOffset;
	...
	_draw(context) {
		...
		if (!this._fontOffset || this._wasDirty) this._fontOffset = Control._GetFontOffset(context.font, this._host.getScene()?.getEngine());
		...
		if (!this._isFocused && !this._textWrapper.text && this._placeholderText) {
			...
			if (this._placeholderColor) context.fillStyle = this._placeholderColor;
		}
		...
		if (this._isFocused && this._textWidth > availableWidth) {
			...
			if (!this._scrollLeft) this._scrollLeft = textLeft;
		} else this._scrollLeft = clipTextLeft;
		if (this.outlineWidth) context.strokeText(text.text, this._scrollLeft, this._currentMeasure.top + rootY);
		context.fillText(text.text, this._scrollLeft, this._currentMeasure.top + rootY);
		if (this._isFocused) {
			if (this._clickedCoordinate) {
				const absoluteCursorPosition = this._scrollLeft + this._textWidth - this._clickedCoordinate;
				let currentSize = 0;
				this._cursorOffset = 0;
				let previousDist = 0;
				do {
					if (this._cursorOffset) previousDist = Math.abs(absoluteCursorPosition - currentSize);
					this._cursorOffset++;
					currentSize = context.measureText(text.substr(text.length - this._cursorOffset, this._cursorOffset)).width;
				} while (currentSize < absoluteCursorPosition && text.length >= this._cursorOffset);
				if (Math.abs(absoluteCursorPosition - currentSize) > previousDist) this._cursorOffset--;
				this._blinkIsEven = false;
				this._clickedCoordinate = null;
			}
			if (!this._blinkIsEven) {
				...
				if (!this.isTextHighlightOn) context.fillRect(cursorLeft, this._currentMeasure.top + (this._currentMeasure.height - this._fontOffset.height) / 2, 2, this._fontOffset.height);
			}
			clearTimeout(this._blinkTimeout);
			...
			if (this.isTextHighlightOn) {
				...
				if (highlightCursorLeft < clipTextLeft) {
					...
					if (!width) width = context.measureText(text.charAt(text.length - this._cursorOffset)).width;
		...
		if (this._thickness) {
			if (this._isFocused) {
				if (this.focusedColor) context.strokeStyle = this.focusedColor;
			} else if (this.color) context.strokeStyle = this.color;
			context.lineWidth = this._thickness;
	...
	set isTextHighlightOn(value) {
		if (this._isTextHighlightOn === value) return;
		if (value) this.onTextHighlightObservable.notifyObservers(this);
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/grid.js
/**
...
var Grid = class extends Container {
	...
	*/
	set clipContent(value) {
		this._clipContent = value;
		for (const key in this._cells) this._cells[key].clipContent = value;
	}
	get clipContent() {
		return this._clipContent;
	}
	...
	*/
	set clipChildren(value) {
		this._clipChildren = value;
		for (const key in this._cells) this._cells[key].clipChildren = value;
	}
	get clipChildren() {
		return this._clipChildren;
	}
	...
	*/
	getRowDefinition(index) {
		if (index < 0 || index >= this._rowDefinitions.length) return null;
	...
	*/
	getColumnDefinition(index) {
		if (index < 0 || index >= this._columnDefinitions.length) return null;
	...
	*/
	setRowDefinition(index, height, isPixel = false) {
		if (index < 0 || index >= this._rowDefinitions.length) return this;
		const current = this._rowDefinitions[index];
		if (current && current.isPixel === isPixel && current.value === height) return this;
	...
	*/
	setColumnDefinition(index, width, isPixel = false) {
		if (index < 0 || index >= this._columnDefinitions.length) return this;
		const current = this._columnDefinitions[index];
		if (current && current.isPixel === isPixel && current.value === width) return this;
	...
	*/
	...
	_removeCell(cell, key) {
		...
		for (const control of cell.children) {
			...
			if (childIndex !== -1) this._childControls.splice(childIndex, 1);
		}
		delete this._cells[key];
	}
	_offsetCell(previousKey, key) {
		if (!this._cells[key]) return;
		this._cells[previousKey] = this._cells[key];
		for (const control of this._cells[previousKey].children) control._tag = previousKey;
		delete this._cells[key];
	}
	/**
	...
	*/
	removeColumnDefinition(index) {
		...
		for (let x = 0; x < this._rowDefinitions.length; x++) for (let y = index + 1; y < this._columnDefinitions.length; y++) {
	...
	*/
	removeRowDefinition(index) {
		...
		for (let y = 0; y < this._columnDefinitions.length; y++) for (let x = index + 1; x < this._rowDefinitions.length; x++) {
	...
	*/
	addControl(control, row = 0, column = 0) {
		if (this._rowDefinitions.length === 0) this.addRowDefinition(1, false);
		if (this._columnDefinitions.length === 0) this.addColumnDefinition(1, false);
		...
		const key = `${Math.min(row, this._rowDefinitions.length - 1)}:${Math.min(column, this._columnDefinitions.length - 1)}`;
	...
	*/
	removeControl(control) {
		...
		if (index !== -1) this._childControls.splice(index, 1);
	...
	*/
	...
	_getGridDefinitions(definitionCallback) {
		...
		for (const rowDefinition of this._rowDefinitions) {
			...
			} else globalHeightPercentage += rowDefinition.value;
			index++;
		}
		let top = 0;
		index = 0;
		for (const rowDefinition of this._rowDefinitions) {
			...
			if (!rowDefinition.isPixel) {
				...
				top += height;
				heights[index] = height;
			} else top += rowDefinition.getValue(this._host);
			index++;
		}
		index = 0;
		for (const columnDefinition of this._columnDefinitions) {
			if (columnDefinition.isPixel) {
				...
				widths[index] = width;
			} else globalWidthPercentage += columnDefinition.value;
			index++;
		}
		let left = 0;
		index = 0;
		for (const columnDefinition of this._columnDefinitions) {
			...
			if (!columnDefinition.isPixel) {
				...
				left += width;
				widths[index] = width;
			} else left += columnDefinition.getValue(this._host);
			index++;
		}
	...
	_additionalProcessing(parentMeasure, context) {
		this._getGridDefinitions((lefts, tops, widths, heights) => {
			for (const key in this._cells) {
				if (!Object.prototype.hasOwnProperty.call(this._cells, key)) continue;
	...
	_flagDescendantsAsMatrixDirty() {
		for (const key in this._cells) {
			if (!Object.prototype.hasOwnProperty.call(this._cells, key)) continue;
			this._cells[key]._markMatrixAsDirty();
		}
	}
	_renderHighlightSpecific(context) {
	...
	dispose() {
		super.dispose();
		for (const control of this._childControls) control.dispose();
		for (let index = 0; index < this._rowDefinitions.length; index++) this._rowDefinitions[index].onChangedObservable.remove(this._rowDefinitionObservers[index]);
		for (let index = 0; index < this._columnDefinitions.length; index++) this._columnDefinitions[index].onChangedObservable.remove(this._columnDefinitionObservers[index]);
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/colorpicker.js
/** Class used to create color pickers */
var ColorPicker = class ColorPicker extends Control {
	...
	set value(value) {
		...
		this._markAsDirty();
		if (this._value.r <= ColorPicker._Epsilon) this._value.r = 0;
		if (this._value.g <= ColorPicker._Epsilon) this._value.g = 0;
		if (this._value.b <= ColorPicker._Epsilon) this._value.b = 0;
		if (this._value.r >= 1 - ColorPicker._Epsilon) this._value.r = 1;
		if (this._value.g >= 1 - ColorPicker._Epsilon) this._value.g = 1;
		if (this._value.b >= 1 - ColorPicker._Epsilon) this._value.b = 1;
	...
	*/
	_preMeasure(parentMeasure) {
		if (parentMeasure.width < parentMeasure.height) this._currentMeasure.height = parentMeasure.width;
		else this._currentMeasure.width = parentMeasure.height;
	}
	_updateSquareProps() {
		const radius = Math.min(this._currentMeasure.width, this._currentMeasure.height) * .5;
		const squareSize = (radius - radius * .2) * 2 / Math.sqrt(2);
		const offset = radius - squareSize * .5;
	...
	_createColorWheelCanvas(radius, thickness) {
		...
		for (let x = -radius; x < radius; x++) for (let y = -radius; y < radius; y++) {
			...
			if (distSq > maxDistSq || distSq < minDistSq) continue;
			...
			if (radius < lowerRadius) alphaAmount = maxAlpha;
			else if (radius > upperRadius) alphaAmount = minAlpha;
			else alphaAmount = (minAlpha - maxAlpha) * (radius - lowerRadius) / (upperRadius - lowerRadius) + maxAlpha;
			alphaRatio = (dist - innerRadius) / (radius - innerRadius);
			if (alphaRatio < alphaAmount) data[index + 3] = 255 * (alphaRatio / alphaAmount);
			else if (alphaRatio > 1 - alphaAmount) data[index + 3] = 255 * (1 - (alphaRatio - (1 - alphaAmount)) / alphaAmount);
	...
	*/
	_draw(context) {
		...
		this._applyStates(context);
		const radius = Math.min(this._currentMeasure.width, this._currentMeasure.height) * .5;
		const wheelThickness = radius * .2;
		const left = this._currentMeasure.left;
		const top = this._currentMeasure.top;
		if (!this._colorWheelCanvas || this._colorWheelCanvas.width != radius * 2) this._colorWheelCanvas = this._createColorWheelCanvas(radius, wheelThickness);
		...
		const dist = radius - wheelThickness * .5;
	...
	_isPointOnWheel(x, y) {
		...
		if (distSq <= radiusSq && distSq >= innerRadiusSq) return true;
		return false;
	}
	_onPointerDown(target, coordinates, pointerId, buttonIndex, pi) {
		if (!super._onPointerDown(target, coordinates, pointerId, buttonIndex, pi)) return false;
		...
		if (this._isPointOnSquare(x, y)) this._pointerStartedOnSquare = true;
		else if (this._isPointOnWheel(x, y)) this._pointerStartedOnWheel = true;
	...
	_onPointerMove(target, coordinates, pointerId, pi) {
		...
		if (!this.isReadOnly) {
			...
			const x = this._transformedPosition.x;
			const y = this._transformedPosition.y;
			if (this._pointerIsDown) this._updateValueFromPointer(x, y);
		}
		super._onPointerMove(target, coordinates, pointerId, pi);
	}
	_onPointerUp(target, coordinates, pointerId, buttonIndex, notifyClick, pi) {
	...
	*/
	static ShowPickerDialogAsync(advancedTexture, options) {
		return new Promise((resolve) => {
			...
			const gutterSize = Math.floor(rawSwatchSize * .25);
			...
			const containerSize = (parseInt(options.pickerHeight) + drawerMaxSize + Math.floor(swatchSize * .25)).toString() + "px";
			...
			if (options.savedColors) {
				...
				let gutterCount;
				if (initialRows == 0) gutterCount = 0;
				else gutterCount = initialRows + 1;
				swatchDrawer.height = (swatchSize * initialRows + gutterCount * gutterSize).toString() + "px";
				swatchDrawer.top = Math.floor(swatchSize * .25).toString() + "px";
				for (let i = 0; i < Math.ceil(options.savedColors.length / options.numSwatchesPerLine) * 2 + 1; i++) if (i % 2 != 0) swatchDrawer.addRowDefinition(swatchSize, true);
				else swatchDrawer.addRowDefinition(gutterSize, true);
				for (let i = 0; i < options.numSwatchesPerLine * 2 + 1; i++) if (i % 2 != 0) swatchDrawer.addColumnDefinition(swatchSize, true);
				else swatchDrawer.addColumnDefinition(gutterSize, true);
			...
			closeButton.fontSize = Math.floor(parseInt(options.headerHeight) * .6);
			...
			const dialogBodyCols = [.4375, .5625];
			...
			pickerGrid.addRowDefinition(.85, false);
			pickerGrid.addRowDefinition(.15, false);
			dialogBody.addControl(pickerGrid, 0, 0);
			const picker = new ColorPicker();
			picker.name = "GUI Color Picker";
			if (options.pickerHeight < options.pickerWidth) picker.width = .89;
			else picker.height = .89;
			...
			picker.onValueChangedObservable.add(function(value) {
				if (activeField == picker.name) updateValues(value, picker.name);
			});
			...
			const pickerBodyRightRows = [.514, .486];
			...
			const pickerButtonsCol = [.417, .583];
			...
			activeSwatches.width = .67;
			activeSwatches.addRowDefinition(.5, false);
			activeSwatches.addRowDefinition(.5, false);
			pickerSwatches.addControl(activeSwatches, 2, 0);
			const labelWidth = Math.floor(parseInt(options.pickerWidth) * dialogBodyCols[1] * pickerButtonsCol[0] * .11);
			const labelHeight = Math.floor(parseInt(options.pickerHeight) * pickerPanelRows[1] * pickerBodyRightRows[0] * pickeSwatchesRows[1] * .5);
			let labelTextSize;
			if (options.pickerWidth > options.pickerHeight) labelTextSize = labelHeight;
			else labelTextSize = labelWidth;
			...
			currentSwatch.onPointerClickObservable.add(() => {
				updateValues(Color3.FromHexString(currentSwatch.background), currentSwatch.name);
				editSwatches(false);
			});
			...
			const buttonWidth = Math.floor(parseInt(options.pickerWidth) * dialogBodyCols[1] * pickerButtonsCol[1] * .67).toString() + "px";
			const buttonHeight = Math.floor(parseInt(options.pickerHeight) * pickerPanelRows[1] * pickerBodyRightRows[0] * (parseFloat(buttonGrid.height.toString()) / 100) * buttonGridRows * .7).toString() + "px";
			if (parseFloat(buttonWidth) > parseFloat(buttonHeight)) buttonFontSize = Math.floor(parseFloat(buttonHeight) * .45);
			else buttonFontSize = Math.floor(parseFloat(buttonWidth) * .11);
			...
			if (options.savedColors) {
				...
				} else disableButton(butSave, true);
				butSave.onPointerEnterObservable.add(() => {
					if (options.savedColors) {
						if (options.savedColors.length < options.swatchLimit) butSave.background = buttonBackgroundHoverColor;
					}
				});
				butSave.onPointerOutObservable.add(() => {
					if (options.savedColors) {
						if (options.savedColors.length < options.swatchLimit) butSave.background = buttonBackgroundColor;
					}
				});
				butSave.pointerDownAnimation = () => {
					if (options.savedColors) {
						if (options.savedColors.length < options.swatchLimit) butSave.background = buttonBackgroundClickColor;
					}
				};
				...
				butSave.onPointerClickObservable.add(() => {
					if (options.savedColors) {
						if (options.savedColors.length == 0) setEditButtonVisibility(true);
						if (options.savedColors.length < options.swatchLimit) updateSwatches(newSwatch.background, butSave);
						editSwatches(false);
					}
				});
				if (options.savedColors.length > 0) setEditButtonVisibility(true);
			...
			pickerColorValues.addRowDefinition(.02, false);
			pickerColorValues.addRowDefinition(.63, false);
			pickerColorValues.addRowDefinition(.21, false);
			pickerColorValues.addRowDefinition(.14, false);
			...
			rgbValuesQuadrant.width = .82;
			rgbValuesQuadrant.verticalAlignment = Control.VERTICAL_ALIGNMENT_CENTER;
			rgbValuesQuadrant.addRowDefinition(1 / 3, false);
			rgbValuesQuadrant.addRowDefinition(1 / 3, false);
			rgbValuesQuadrant.addRowDefinition(1 / 3, false);
			rgbValuesQuadrant.addColumnDefinition(.1, false);
			rgbValuesQuadrant.addColumnDefinition(.2, false);
			rgbValuesQuadrant.addColumnDefinition(.7, false);
			...
			rValInt.onBlurObservable.add(() => {
				if (rValInt.text == "") rValInt.text = "0";
				updateInt(rValInt, "r");
				if (activeField == rValInt.name) activeField = "";
			});
			rValInt.onTextChangedObservable.add(() => {
				if (activeField == rValInt.name) updateInt(rValInt, "r");
			});
			...
			gValInt.onBlurObservable.add(() => {
				if (gValInt.text == "") gValInt.text = "0";
				updateInt(gValInt, "g");
				if (activeField == gValInt.name) activeField = "";
			});
			gValInt.onTextChangedObservable.add(() => {
				if (activeField == gValInt.name) updateInt(gValInt, "g");
			});
			...
			bValInt.onBlurObservable.add(() => {
				if (bValInt.text == "") bValInt.text = "0";
				updateInt(bValInt, "b");
				if (activeField == bValInt.name) activeField = "";
			});
			bValInt.onTextChangedObservable.add(() => {
				if (activeField == bValInt.name) updateInt(bValInt, "b");
			});
			...
			rValDec.onBlurObservable.add(() => {
				...
				if (activeField == rValDec.name) activeField = "";
			});
			rValDec.onTextChangedObservable.add(() => {
				if (activeField == rValDec.name) updateFloat(rValDec, "r");
			});
			...
			gValDec.onBlurObservable.add(() => {
				...
				if (activeField == gValDec.name) activeField = "";
			});
			gValDec.onTextChangedObservable.add(() => {
				if (activeField == gValDec.name) updateFloat(gValDec, "g");
			});
			...
			bValDec.onBlurObservable.add(() => {
				...
				if (activeField == bValDec.name) activeField = "";
			});
			bValDec.onTextChangedObservable.add(() => {
				if (activeField == bValDec.name) updateFloat(bValDec, "b");
			});
			rgbValuesQuadrant.addControl(bValDec, 2, 2);
			const hexValueQuadrant = new Grid();
			hexValueQuadrant.name = "Hex Value";
			hexValueQuadrant.width = .82;
			hexValueQuadrant.addRowDefinition(1, false);
			hexValueQuadrant.addColumnDefinition(.1, false);
			hexValueQuadrant.addColumnDefinition(.9, false);
			...
			hexVal.text = options.lastColor.split("#")[1];
			...
			hexVal.onBlurObservable.add(() => {
				...
				if (activeField == hexVal.name) activeField = "";
			});
			hexVal.onTextChangedObservable.add(() => {
				let newHexValue = hexVal.text;
				const checkHex = /[^0-9A-F]/i.test(newHexValue);
				if ((hexVal.text.length > 6 || checkHex) && activeField == hexVal.name) hexVal.text = lastVal;
				else {
					if (hexVal.text.length < 6) {
						const leadingZero = 6 - hexVal.text.length;
						for (let i = 0; i < leadingZero; i++) newHexValue = "0" + newHexValue;
					}
					if (hexVal.text.length == 3) {
						const val = hexVal.text.split("");
			...
			if (options.savedColors && options.savedColors.length > 0) updateSwatches("", butSave);
			/**
			...
			*/
			function updateValues(value, inputField) {
				...
				if (rValInt.name != activeField) rValInt.text = Math.floor(value.r * 255).toString();
				if (gValInt.name != activeField) gValInt.text = Math.floor(value.g * 255).toString();
				if (bValInt.name != activeField) bValInt.text = Math.floor(value.b * 255).toString();
				if (rValDec.name != activeField) rValDec.text = value.r.toString();
				if (gValDec.name != activeField) gValDec.text = value.g.toString();
				if (bValDec.name != activeField) bValDec.text = value.b.toString();
				if (hexVal.name != activeField) hexVal.text = pickedColor.split("#")[1];
				if (picker.name != activeField) picker.value = value;
			}
			function updateInt(field, channel) {
				...
				if (/[^0-9]/g.test(newValue)) {
					...
					if (newValue != "") {
						if (Math.floor(parseInt(newValue)) < 0) newValue = "0";
						else if (Math.floor(parseInt(newValue)) > 255) newValue = "255";
						else if (isNaN(parseInt(newValue))) newValue = "0";
					}
					if (activeField == field.name) lastVal = newValue;
				}
				if (newValue != "") {
					newValue = parseInt(newValue).toString();
					field.text = newValue;
					const newSwatchRGB = Color3.FromHexString(newSwatch.background);
					if (activeField == field.name) if (channel == "r") updateValues(new Color3(parseInt(newValue) / 255, newSwatchRGB.g, newSwatchRGB.b), field.name);
					else if (channel == "g") updateValues(new Color3(newSwatchRGB.r, parseInt(newValue) / 255, newSwatchRGB.b), field.name);
					else updateValues(new Color3(newSwatchRGB.r, newSwatchRGB.g, parseInt(newValue) / 255), field.name);
				}
			}
			function updateFloat(field, channel) {
				...
				if (/[^0-9.]/g.test(newValue)) {
					...
					if (newValue != "" && newValue != "." && parseFloat(newValue) != 0) {
						if (parseFloat(newValue) < 0) newValue = "0.0";
						else if (parseFloat(newValue) > 1) newValue = "1.0";
						else if (isNaN(parseFloat(newValue))) newValue = "0.0";
					}
					if (activeField == field.name) lastVal = newValue;
				}
				if (newValue != "" && newValue != "." && parseFloat(newValue) != 0) {
				...
				const newSwatchRGB = Color3.FromHexString(newSwatch.background);
				if (activeField == field.name) if (channel == "r") updateValues(new Color3(parseFloat(newValue), newSwatchRGB.g, newSwatchRGB.b), field.name);
				else if (channel == "g") updateValues(new Color3(newSwatchRGB.r, parseFloat(newValue), newSwatchRGB.b), field.name);
				else updateValues(new Color3(newSwatchRGB.r, newSwatchRGB.g, parseFloat(newValue)), field.name);
			}
			function deleteSwatch(index) {
				if (options.savedColors) options.savedColors.splice(index, 1);
			...
			function createSwatch() {
				if (options.savedColors && options.savedColors[swatchNumber]) {
					...
					if (swatchColor.r + swatchColor.g + swatchColor.b > luminanceLimit) swatch.color = iconColorDark;
					else swatch.color = iconColorLight;
					swatch.fontSize = Math.floor(swatchSize * .7);
					...
					swatch.onPointerClickObservable.add(() => {
						if (!editSwatchMode) {
							if (options.savedColors) updateValues(Color3.FromHexString(options.savedColors[metadata]), swatch.name);
						} else {
			...
			function editSwatches(mode) {
				if (mode !== void 0) editSwatchMode = mode;
				let thisButton;
				if (editSwatchMode) {
					...
					if (butEdit !== void 0) butEdit.textBlock.text = "Done";
				} else {
					for (let i = 0; i < swatchDrawer.children.length; i++) {
						thisButton = swatchDrawer.children[i];
						thisButton.textBlock.text = "";
					}
					if (butEdit !== void 0) butEdit.textBlock.text = "Edit";
				}
			}
			/**
			...
			*/
			function updateSwatches(color, button) {
				if (options.savedColors) {
					if (color != "") options.savedColors.push(color);
					swatchNumber = 0;
					swatchDrawer.clearControls();
					const rowCount = Math.ceil(options.savedColors.length / options.numSwatchesPerLine);
					let gutterCount;
					if (rowCount == 0) gutterCount = 0;
					else gutterCount = rowCount + 1;
					if (swatchDrawer.rowCount != rowCount + gutterCount) {
						const currentRows = swatchDrawer.rowCount;
						for (let i = 0; i < currentRows; i++) swatchDrawer.removeRowDefinition(0);
						for (let i = 0; i < rowCount + gutterCount; i++) if (i % 2) swatchDrawer.addRowDefinition(swatchSize, true);
						else swatchDrawer.addRowDefinition(gutterSize, true);
					}
					...
					for (let y = 1, thisRow = 1; y < rowCount + gutterCount; y += 2, thisRow++) {
						...
						if (options.savedColors.length > thisRow * options.numSwatchesPerLine) totalButtonsThisRow = options.numSwatchesPerLine;
						else totalButtonsThisRow = options.savedColors.length - (thisRow - 1) * options.numSwatchesPerLine;
						...
						for (let x = 0, w = 1; x < buttonIterations; x++) {
							if (x > options.numSwatchesPerLine) continue;
					...
					if (options.savedColors.length >= options.swatchLimit) disableButton(button, true);
					else disableButton(button, false);
				}
			}
			function setEditButtonVisibility(enableButton) {
				if (enableButton) {
					...
					butEdit.left = Math.floor(parseInt(buttonWidth) * .1).toString() + "px";
					...
					butEdit.onPointerClickObservable.add(() => {
						if (editSwatchMode) editSwatchMode = false;
						else editSwatchMode = true;
						editSwatches();
					});
					pickerGrid.addControl(butEdit, 1, 0);
				} else pickerGrid.removeControl(butEdit);
			}
			...
			function closePicker(color) {
				if (options.savedColors && options.savedColors.length > 0) resolve({
					savedColors: options.savedColors,
					pickedColor: color
				});
				else resolve({ pickedColor: color });
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/ellipse.js
...
__decorate([serialize()], Ellipse.prototype, "arc", null);
RegisterClass("BABYLON.GUI.Ellipse", Ellipse);
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/focusableButton.js
/**
...
var FocusableButton = class extends Button {
	...
	*/
	_onPointerDown(target, coordinates, pointerId, buttonIndex, pi) {
		if (!this.isReadOnly) this.focus();
		return super._onPointerDown(target, coordinates, pointerId, buttonIndex, pi);
	}
};
RegisterClass("BABYLON.GUI.FocusableButton", FocusableButton);
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/inputTextArea.js
/**
* Class used to create input text control
*/
var InputTextArea = class extends InputText {
	...
	set autoStretchHeight(value) {
		if (this._autoStretchHeight === value) return;
	...
	set maxHeight(value) {
		if (this._maxHeight.toString(this._host) === value) return;
		if (this._maxHeight.fromString(value)) this._markAsDirty();
	}
	/**
	...
	*/
	alternativeProcessKey(code, key, evt) {
		if (evt && (evt.ctrlKey || evt.metaKey) && (key === "c" || key === "v" || key === "x")) return;
		switch (code) {
			case "Period":
				if (evt && evt.shiftKey) evt.preventDefault();
				break;
			case "Backspace":
				...
				break;
			case "Delete":
				if (!this._isTextHighlightOn && this._cursorInfo.globalEndIndex < this.text.length) this._cursorInfo.globalEndIndex = this._cursorInfo.globalStartIndex + 1;
				this._prevText = this._textWrapper.text;
				this._textWrapper.removePart(this._cursorInfo.globalStartIndex, this._cursorInfo.globalEndIndex);
				this._cursorInfo.globalEndIndex = this._cursorInfo.globalStartIndex;
				if (evt) evt.preventDefault();
			...
			case "ArrowLeft":
				...
				if (evt && evt.shiftKey) {
					...
					} else if (this._cursorInfo.globalEndIndex > this._highlightCursorInfo.initialStartIndex) this._cursorInfo.globalEndIndex--;
					else this._cursorInfo.globalStartIndex--;
					this._blinkIsEven = true;
					evt.preventDefault();
					return;
				}
				if (this._isTextHighlightOn) this._cursorInfo.globalEndIndex = this._cursorInfo.globalStartIndex;
				else if (evt && (evt.ctrlKey || evt.metaKey)) {
					this._cursorInfo.globalStartIndex -= this._cursorInfo.relativeStartIndex;
					evt.preventDefault();
				} else if (this._cursorInfo.globalStartIndex > 0) this._cursorInfo.globalStartIndex--;
				this._blinkIsEven = false;
				this._isTextHighlightOn = false;
				return;
			case "ArrowRight":
				...
				if (evt && evt.shiftKey) {
					...
					if (!this._isTextHighlightOn) {
						...
						this._isTextHighlightOn = true;
					} else if (this._cursorInfo.globalStartIndex < this._highlightCursorInfo.initialStartIndex) this._cursorInfo.globalStartIndex++;
					else this._cursorInfo.globalEndIndex++;
					this._blinkIsEven = true;
					evt.preventDefault();
					return;
				}
				if (this._isTextHighlightOn) this._cursorInfo.globalStartIndex = this._cursorInfo.globalEndIndex;
				else if (evt && (evt.ctrlKey || evt.metaKey)) {
				...
				} else if (this._cursorInfo.globalStartIndex < this.text.length) this._cursorInfo.globalStartIndex++;
				this._blinkIsEven = false;
				this._isTextHighlightOn = false;
				return;
			case "ArrowUp":
				...
				if (evt) {
					if (evt.shiftKey) {
						...
						this._isTextHighlightOn = true;
						this._blinkIsEven = true;
					} else this._isTextHighlightOn = false;
					evt.preventDefault();
				}
				if (this._cursorInfo.currentLineIndex === 0) this._cursorInfo.globalStartIndex = 0;
				else {
					...
					if (Math.abs(currentWidth - upperWidth) > previousWidth && upperLineRelativeIndex > 0) tmpIndex--;
					if (!this._isTextHighlightOn) this._cursorInfo.globalStartIndex = tmpIndex;
					...
					} else this._cursorInfo.globalEndIndex = tmpIndex;
				}
				this._markAsDirty();
				return;
			case "ArrowDown":
				...
				if (this._cursorInfo.currentLineIndex === this._lines.length - 1) this._cursorInfo.globalStartIndex = this.text.length;
				else {
					const currentLine = this._lines[this._cursorInfo.currentLineIndex];
					...
					if (Math.abs(currentWidth - underWidth) > previousWidth && underLineRelativeIndex > 0) tmpIndex--;
					if (!this._isTextHighlightOn) this._cursorInfo.globalStartIndex = tmpIndex;
					else if (this._cursorInfo.currentLineIndex < this._highlightCursorInfo.initialLineIndex) {
						this._cursorInfo.globalStartIndex = tmpIndex;
	...
	_breakLines(refWidth, context) {
		...
		if (this.clipContent) for (const _line of _lines) lines.push(...this._parseLineWordWrap(_line, refWidth, context));
		else for (const _line of _lines) lines.push(this._parseLine(_line, context));
	...
	*/
	_preMeasure(parentMeasure, context) {
		...
		if (!this.text && this._placeholderText) text = this._placeholderText;
		this._textWidth = context.measureText(text).width;
		const marginWidth = this._margin.getValueInPixel(this._host, parentMeasure.width) * 2;
		if (this._autoStretchWidth) {
			const longerString = text.split("\n").reduce((acc, val) => {
				return context.measureText(val).width > context.measureText(acc).width ? val : acc;
			}, "");
		...
		if (this._autoStretchHeight) {
			const totalHeight = this._lines.length * this._fontOffset.height + this._margin.getValueInPixel(this._host, parentMeasure.height) * 2;
	...
	_computeScroll() {
		...
		if (this._isFocused) {
			...
			if (!this._scrollTop) this._scrollTop = textTop;
	...
	*/
	...
	_draw(context) {
		...
		if (!this._textWrapper.text && this.placeholderText) context.fillStyle = this._placeholderColor;
		...
		if (this._isFocused) {
			if (!this._blinkIsEven || this._isTextHighlightOn) {
				...
				if (!this._isTextHighlightOn) context.fillRect(cursorLeft, cursorTop, 2, this._fontOffset.height);
			}
			this._resetBlinking();
			if (this._isTextHighlightOn) {
				clearTimeout(this._blinkTimeout);
				...
				if (this._cursorInfo.globalEndIndex === this._cursorInfo.globalStartIndex) this._resetBlinking();
			}
		}
		context.restore();
		if (this._thickness) {
	...
	_onPointerMove(target, coordinates, pointerId, pi) {
		if (pi.event.movementX === 0 && pi.event.movementY === 0) return;
		if (this._host.focusedControl === this && this._isPointerDown && !this.isReadOnly) {
			this._clickedCoordinateX = coordinates.x;
			this._clickedCoordinateY = coordinates.y;
			if (!this._isTextHighlightOn) {
	...
	*/
	_updateCursorPosition() {
		...
		if (!this._textWrapper.text && this.placeholderText) {
			...
			if (!this._isTextHighlightOn) this._cursorInfo = {
				globalStartIndex: 0,
				globalEndIndex: 0,
				relativeStartIndex: 0,
				relativeEndIndex: 0,
			...
			if (Math.abs(relativeXPosition - currentSize) > previousDist && relativeIndex > 0) relativeIndex--;
			...
			} else if (globalIndex < this._highlightCursorInfo.initialStartIndex) {
				this._cursorInfo.globalStartIndex = globalIndex;
				this._cursorInfo.relativeStartIndex = relativeIndex;
				this._cursorInfo.globalEndIndex = this._highlightCursorInfo.initialStartIndex;
				this._cursorInfo.relativeEndIndex = this._highlightCursorInfo.initialRelativeStartIndex;
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/inputPassword.js
/**
...
var InputPassword = class extends InputText {
	...
	_beforeRenderText(textWrapper) {
		...
		let txt = "";
		for (let i = 0; i < textWrapper.length; i++) txt += "•";
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/line.js
...
var Line = class extends Control {
	...
	set connectedControl(value) {
		if (this._connectedControl === value) return;
		if (this._connectedControlDirtyObserver && this._connectedControl) {
			this._connectedControl.onDirtyObservable.remove(this._connectedControlDirtyObserver);
			this._connectedControlDirtyObserver = null;
		}
		if (value) this._connectedControlDirtyObserver = value.onDirtyObservable.add(() => this._markAsDirty());
	...
	set x1(value) {
		if (this._x1.toString(this._host) === value) return;
		if (this._x1.fromString(value)) this._markAsDirty();
	}
	...
	set y1(value) {
		if (this._y1.toString(this._host) === value) return;
		if (this._y1.fromString(value)) this._markAsDirty();
	}
	...
	set x2(value) {
		if (this._x2.toString(this._host) === value) return;
		if (this._x2.fromString(value)) this._markAsDirty();
	}
	...
	set y2(value) {
		if (this._y2.toString(this._host) === value) return;
		if (this._y2.fromString(value)) this._markAsDirty();
	}
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/multiLinePoint.js
/**
...
var MultiLinePoint = class {
	...
	*/
	...
	set x(value) {
		if (this._x.toString(this._multiLine._host) === value) return;
		if (this._x.fromString(value)) this._multiLine._markAsDirty();
	}
	...
	set y(value) {
		if (this._y.toString(this._multiLine._host) === value) return;
		if (this._y.fromString(value)) this._multiLine._markAsDirty();
	}
	...
	set control(value) {
		if (this._control === value) return;
		if (this._control && this._controlObserver) {
			this._control.onDirtyObservable.remove(this._controlObserver);
			this._controlObserver = null;
		}
		this._control = value;
		if (this._control) this._controlObserver = this._control.onDirtyObservable.add(this._multiLine.onPointUpdate);
	...
	set mesh(value) {
		...
		if (this._mesh && this._meshObserver) this._mesh.getScene().onAfterCameraRenderObservable.remove(this._meshObserver);
		this._mesh = value;
		if (this._mesh) this._meshObserver = this._mesh.getScene().onAfterCameraRenderObservable.add(this._multiLine.onPointUpdate);
		this._multiLine._markAsDirty();
	}
	/** Resets links */
	resetLinks() {
	...
	*/
	...
	_translatePoint() {
		if (this._mesh != null) return this._multiLine._host.getProjectedPositionWithZ(this._mesh.getBoundingInfo().boundingSphere.center, this._mesh.getWorldMatrix());
		else if (this._control != null) return new Vector3(this._control.centerX, this._control.centerY, 1 - Epsilon);
		else {
			const host = this._multiLine._host;
			return new Vector3(this._x.getValueInPixel(host, Number(host._canvas.width)), this._y.getValueInPixel(host, Number(host._canvas.height)), 1 - Epsilon);
		}
	}
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/multiLine.js
/**
...
var MultiLine = class extends Control {
	...
	*/
	getAt(index) {
		if (!this._points[index]) this._points[index] = new MultiLinePoint(this);
	...
	*/
	push(item) {
		...
		if (item instanceof AbstractMesh) point.mesh = item;
		else if (item instanceof Control) point.control = item;
	...
	*/
	reset() {
		while (this._points.length > 0) this.remove(this._points.length - 1);
	}
	/**
	* Resets all links
	*/
	...
	_draw(context) {
		...
		this._points.forEach((point) => {
			...
			if (first) {
				...
				first = false;
			} else if (point._point.z < 1 && previousPoint.z < 1) context.lineTo(point._point.x, point._point.y);
			else context.moveTo(point._point.x, point._point.y);
	...
	_measure() {
		if (this._minX == null || this._maxX == null || this._minY == null || this._maxY == null) return;
		this._currentMeasure.width = Math.abs(this._maxX - this._minX) + this._lineWidth;
		this._currentMeasure.height = Math.abs(this._maxY - this._minY) + this._lineWidth;
	}
	_computeAlignment() {
		if (this._minX == null || this._minY == null) return;
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/radioButton.js
/**
* Class used to create radio button controls
*/
var RadioButton = class RadioButton extends Control {
	/** Gets or sets border thickness */
	get thickness() {
		return this._thickness;
	}
	...
	set isChecked(value) {
		...
		this._markAsDirty();
		this.onIsCheckedChangedObservable.notifyObservers(value);
		if (this._isChecked && this._host) this._host.executeOnAllControls((control) => {
			if (control === this) return;
			if (control.group === void 0) return;
			const childRadio = control;
			if (childRadio.group === this.group) childRadio.isChecked = false;
		});
	}
	/**
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/sliders/baseSlider.js
/**
...
var BaseSlider = class extends Control {
	...
	set displayThumb(value) {
		if (this._displayThumb === value) return;
	...
	set barOffset(value) {
		if (this._barOffset.toString(this._host) === value) return;
		if (this._barOffset.fromString(value)) this._markAsDirty();
	}
	...
	set thumbWidth(value) {
		if (this._thumbWidth.toString(this._host) === value) return;
		if (this._thumbWidth.fromString(value)) this._markAsDirty();
	}
	...
	set isThumbClamped(value) {
		if (this._isThumbClamped === value) return;
	...
	*/
	...
	_getThumbPosition() {
		if (this.isVertical) return (this.maximum - this.value) / (this.maximum - this.minimum) * this._backgroundBoxLength;
	...
	_getThumbThickness(type) {
		...
		switch (type) {
			case "circle":
				if (this._thumbWidth.isPixel) thumbThickness = Math.max(this._thumbWidth.getValue(this._host), this._backgroundBoxThickness);
				else thumbThickness = this._backgroundBoxThickness * this._thumbWidth.getValue(this._host);
				break;
			case "rectangle": if (this._thumbWidth.isPixel) thumbThickness = Math.min(this._thumbWidth.getValue(this._host), this._backgroundBoxThickness);
			else thumbThickness = this._backgroundBoxThickness * this._thumbWidth.getValue(this._host);
		}
	...
	_prepareRenderingData(type) {
		...
		if (this.displayThumb) this._backgroundBoxLength -= this._effectiveThumbThickness;
		if (this.isVertical && this._currentMeasure.height < this._currentMeasure.width) {
			Logger.Error("Height should be greater than width");
			return;
		}
		if (this._barOffset.isPixel) this._effectiveBarOffset = Math.min(this._barOffset.getValue(this._host), this._backgroundBoxThickness);
		else this._effectiveBarOffset = this._backgroundBoxThickness * this._barOffset.getValue(this._host);
		this._backgroundBoxThickness -= this._effectiveBarOffset * 2;
		if (this.isVertical) {
			this._renderLeft += this._effectiveBarOffset;
			if (!this.isThumbClamped && this.displayThumb) this._renderTop += this._effectiveThumbThickness / 2;
			this._renderHeight = this._backgroundBoxLength;
			this._renderWidth = this._backgroundBoxThickness;
		} else {
			this._renderTop += this._effectiveBarOffset;
			if (!this.isThumbClamped && this.displayThumb) this._renderLeft += this._effectiveThumbThickness / 2;
	...
	*/
	_updateValueFromPointer(x, y) {
		...
		let value;
		if (this._isVertical) value = this._minimum + (1 - (y - this._currentMeasure.top) / this._currentMeasure.height) * (this._maximum - this._minimum);
		else value = this._minimum + (x - this._currentMeasure.left) / this._currentMeasure.width * (this._maximum - this._minimum);
	...
	_onPointerMove(target, coordinates, pointerId, pi) {
		if (pointerId != this._lastPointerDownId) return;
		if (this._pointerIsDown && !this.isReadOnly) this._updateValueFromPointer(coordinates.x, coordinates.y);
		super._onPointerMove(target, coordinates, pointerId, pi);
	}
	_onPointerUp(target, coordinates, pointerId, buttonIndex, notifyClick) {
		this._pointerIsDown = false;
...
__decorate([serialize()], BaseSlider.prototype, "isThumbClamped", null);
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/sliders/slider.js
/**
* Class used to create slider controls
*/
var Slider = class extends BaseSlider {
	...
	set displayValueBar(value) {
		if (this._displayValueBar === value) return;
	...
	set thumbColor(value) {
		if (this._thumbColor === value) return;
	...
	set isThumbCircle(value) {
		if (this._isThumbCircle === value) return;
	...
	*/
	...
	_draw(context) {
		...
		if (this.isThumbClamped && this.isThumbCircle) {
			if (this.isVertical) top += this._effectiveThumbThickness / 2;
			else left += this._effectiveThumbThickness / 2;
			radius = this._backgroundBoxThickness / 2;
		} else radius = (this._effectiveThumbThickness - this._effectiveBarOffset) / 2;
		...
		context.fillStyle = this._getBackgroundColor(context);
		if (this.isVertical) if (this.isThumbClamped) if (this.isThumbCircle) {
			context.beginPath();
			context.arc(left + this._backgroundBoxThickness / 2, top, radius, Math.PI, 2 * Math.PI);
			context.fill();
			context.fillRect(left, top, width, height);
		} else context.fillRect(left, top, width, height + this._effectiveThumbThickness);
		else context.fillRect(left, top, width, height);
		else if (this.isThumbClamped) if (this.isThumbCircle) {
			context.beginPath();
			context.arc(left + this._backgroundBoxLength, top + this._backgroundBoxThickness / 2, radius, 0, 2 * Math.PI);
			context.fill();
			context.fillRect(left, top, width, height);
		} else context.fillRect(left, top, width + this._effectiveThumbThickness, height);
		else context.fillRect(left, top, width, height);
		if (this.shadowBlur || this.shadowOffsetX || this.shadowOffsetY) {
			context.shadowBlur = 0;
			context.shadowOffsetX = 0;
		...
		if (this._displayValueBar) if (this.isVertical) if (this.isThumbClamped) if (this.isThumbCircle) {
			context.beginPath();
			context.arc(left + this._backgroundBoxThickness / 2, top + this._backgroundBoxLength, radius, 0, 2 * Math.PI);
			context.fill();
			context.fillRect(left, top + thumbPosition, width, height - thumbPosition);
		} else context.fillRect(left, top + thumbPosition, width, height - thumbPosition + this._effectiveThumbThickness);
		else context.fillRect(left, top + thumbPosition, width, height - thumbPosition);
		else if (this.isThumbClamped) if (this.isThumbCircle) {
			context.beginPath();
			context.arc(left, top + this._backgroundBoxThickness / 2, radius, 0, 2 * Math.PI);
			context.fill();
			context.fillRect(left, top, thumbPosition, height);
		} else context.fillRect(left, top, thumbPosition, height);
		else context.fillRect(left, top, thumbPosition, height);
		...
		if (this.displayThumb) {
			...
			if (this._isThumbCircle) {
				context.beginPath();
				if (this.isVertical) context.arc(left + this._backgroundBoxThickness / 2, top + thumbPosition, radius, 0, 2 * Math.PI);
				else context.arc(left + thumbPosition, top + this._backgroundBoxThickness / 2, radius, 0, 2 * Math.PI);
				context.fill();
				if (this.shadowBlur || this.shadowOffsetX || this.shadowOffsetY) {
					context.shadowBlur = 0;
					context.shadowOffsetX = 0;
				...
				if (this.isVertical) context.fillRect(left - this._effectiveBarOffset, this._currentMeasure.top + thumbPosition, this._currentMeasure.width, this._effectiveThumbThickness);
				else context.fillRect(this._currentMeasure.left + thumbPosition, this._currentMeasure.top, this._effectiveThumbThickness, this._currentMeasure.height);
				if (this.shadowBlur || this.shadowOffsetX || this.shadowOffsetY) {
					context.shadowBlur = 0;
					context.shadowOffsetX = 0;
					context.shadowOffsetY = 0;
				...
				context.strokeStyle = this._borderColor;
				if (this.isVertical) context.strokeRect(left - this._effectiveBarOffset, this._currentMeasure.top + thumbPosition, this._currentMeasure.width, this._effectiveThumbThickness);
				else context.strokeRect(this._currentMeasure.left + thumbPosition, this._currentMeasure.top, this._effectiveThumbThickness, this._currentMeasure.height);
			}
		}
		context.restore();
	}
	...
	_parseFromContent(serializedObject, host) {
		super._parseFromContent(serializedObject, host);
		if (serializedObject.backgroundGradient) {
			this.backgroundGradient = new (Tools.Instantiate("BABYLON.GUI." + serializedObject.backgroundGradient.className))();
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/selector.js
...
var SelectorGroup = class {
	...
	*/
	...
	set header(label) {
		if (this._groupHeader.text === "label") return;
	...
	*/
	_getSelector(selectorNb) {
		if (selectorNb < 0 || selectorNb >= this._selectors.length) return;
...
var SliderGroup = class extends SelectorGroup {
	...
	*/
	addSlider(label, func = (v) => {}, unit = "Units", min = 0, max = 0, value = 0, onValueChange = (v) => {
		return v | 0;
	}) {
...
var SelectionPanel = class extends Rectangle {
	...
	*/
	...
	set headerColor(color) {
		if (this._headerColor === color) return;
		this._headerColor = color;
		this._setHeaderColor();
	}
	_setHeaderColor() {
		for (let i = 0; i < this._groups.length; i++) this._groups[i].groupPanel.children[0].color = this._headerColor;
	}
	...
	set buttonColor(color) {
		if (this._buttonColor === color) return;
		this._buttonColor = color;
		this._setbuttonColor();
	}
	_setbuttonColor() {
		for (let i = 0; i < this._groups.length; i++) for (let j = 0; j < this._groups[i].selectors.length; j++) this._groups[i]._setSelectorButtonColor(j, this._buttonColor);
	}
	...
	set labelColor(color) {
		if (this._labelColor === color) return;
		this._labelColor = color;
		this._setLabelColor();
	}
	_setLabelColor() {
		for (let i = 0; i < this._groups.length; i++) for (let j = 0; j < this._groups[i].selectors.length; j++) this._groups[i]._setSelectorLabelColor(j, this._labelColor);
	}
	...
	set buttonBackground(color) {
		if (this._buttonBackground === color) return;
		this._buttonBackground = color;
		this._setButtonBackground();
	}
	_setButtonBackground() {
		for (let i = 0; i < this._groups.length; i++) for (let j = 0; j < this._groups[i].selectors.length; j++) this._groups[i]._setSelectorButtonBackground(j, this._buttonBackground);
	}
	...
	set barColor(color) {
		if (this._barColor === color) return;
		this._barColor = color;
		this._setBarColor();
	}
	_setBarColor() {
		for (let i = 0; i < this._bars.length; i++) this._bars[i].children[0].background = this._barColor;
	}
	...
	set barHeight(value) {
		if (this._barHeight === value) return;
		this._barHeight = value;
		this._setBarHeight();
	}
	_setBarHeight() {
		for (let i = 0; i < this._bars.length; i++) this._bars[i].children[0].height = this._barHeight;
	}
	...
	set spacerHeight(value) {
		if (this._spacerHeight === value) return;
		this._spacerHeight = value;
		this._setSpacerHeight();
	}
	_setSpacerHeight() {
		for (let i = 0; i < this._bars.length; i++) this._bars[i].height = this._spacerHeight;
	}
	...
	*/
	addGroup(group) {
		if (this._groups.length > 0) this._addSpacer();
	...
	*/
	removeGroup(groupNb) {
		if (groupNb < 0 || groupNb >= this._groups.length) return;
	...
	* */
	relabel(label, groupNb, selectorNb) {
		if (groupNb < 0 || groupNb >= this._groups.length) return;
		const group = this._groups[groupNb];
		if (selectorNb < 0 || selectorNb >= group.selectors.length) return;
	...
	*/
	addToGroupCheckbox(groupNb, label, func = () => {}, checked = false) {
		if (groupNb < 0 || groupNb >= this._groups.length) return;
		this._groups[groupNb].addCheckbox(label, func, checked);
	}
	...
	*/
	addToGroupRadio(groupNb, label, func = () => {}, checked = false) {
		if (groupNb < 0 || groupNb >= this._groups.length) return;
		this._groups[groupNb].addRadio(label, func, checked);
	}
	/**
	...
	*/
	addToGroupSlider(groupNb, label, func = () => {}, unit = "Units", min = 0, max = 0, value = 0, onVal = (v) => {
		...
		if (groupNb < 0 || groupNb >= this._groups.length) return;
		this._groups[groupNb].addSlider(label, func, unit, min, max, value, onVal);
	}
};
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/scrollViewers/scrollViewerWindow.js
/**
...
var _ScrollViewerWindow = class extends Container {
	...
	set freezeControls(value) {
		...
		if (!value) this._restoreMeasures();
		...
		if (value) {
			...
			if (this._useBuckets()) this._makeBuckets();
		}
	...
	setBucketSizes(width, height) {
		...
		if (this._useBuckets()) {
			if (this._freezeControls) this._makeBuckets();
		} else this._buckets = {};
	}
	_useBuckets() {
	...
	_dispatchInBuckets(children) {
		for (let i = 0; i < children.length; ++i) {
			...
			if (child instanceof Container && child._children.length > 0) this._dispatchInBuckets(child._children);
		}
	}
	_updateMeasures() {
	...
	_updateChildrenMeasures(children, left, top) {
		for (let i = 0; i < children.length; ++i) {
			...
			if (child instanceof Container && child._children.length > 0) this._updateChildrenMeasures(child._children, left, top);
		}
	}
	_restoreMeasures() {
		const left = this.leftInPixels | 0, top = this.topInPixels | 0;
	...
	*/
	...
	_scrollChildren(children, left, top) {
		for (let i = 0; i < children.length; ++i) {
			...
			child._isClipped = false;
			if (child instanceof Container && child._children.length > 0) this._scrollChildren(child._children, left, top);
		}
	}
	_scrollChildrenWithBuckets(left, top, scrollLeft, scrollTop) {
		...
		while (bStartY <= bEndY) {
			for (let x = bStartX; x <= bEndX; ++x) {
				...
				if (lstc) for (let i = 0; i < lstc.length; ++i) {
					const child = lstc[i];
	...
	*/
	_draw(context, invalidatedRectangle) {
		...
		if (this.clipChildren) this._clipForChildren(context);
		const left = this.leftInPixels | 0, top = this.topInPixels | 0;
		if (this._useBuckets()) if (this._oldLeft !== null && this._oldTop !== null) {
			this._scrollChildrenWithBuckets(this._oldLeft, this._oldTop, left, top);
			this._scrollChildrenWithBuckets(left, top, left, top);
		} else this._scrollChildren(this._children, left, top);
		else this._scrollChildren(this._children, left, top);
		this._oldLeft = left;
		this._oldTop = top;
		for (const child of this._children) {
			if (!child._intersectsRect(this._parentMeasure)) continue;
	...
	_postMeasure() {
		...
		for (const child of this.children) {
			if (!child.isVisible || child.notRenderable) continue;
			if (child.horizontalAlignment === Control.HORIZONTAL_ALIGNMENT_CENTER) child._offsetLeft(this._currentMeasure.left - child._currentMeasure.left);
			if (child.verticalAlignment === Control.VERTICAL_ALIGNMENT_CENTER) child._offsetTop(this._currentMeasure.top - child._currentMeasure.top);
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/sliders/scrollBar.js
/**
* Class used to create slider controls
*/
var ScrollBar = class extends BaseSlider {
	...
	*/
	...
	_getThumbThickness() {
		let thumbThickness = 0;
		if (this._thumbWidth.isPixel) thumbThickness = this._thumbWidth.getValue(this._host);
		else thumbThickness = this._backgroundBoxThickness * this._thumbWidth.getValue(this._host);
		return thumbThickness;
	}
	_getBackgroundColor(context) {
	...
	*/
	_updateValueFromPointer(x, y) {
		...
		if (this._first) {
			...
			this._originX = x;
			this._originY = y;
			if (x < this._tempMeasure.left || x > this._tempMeasure.left + this._tempMeasure.width || y < this._tempMeasure.top || y > this._tempMeasure.top + this._tempMeasure.height) if (this.isVertical) this.value = this.minimum + (1 - (y - this._currentMeasure.top) / this._currentMeasure.height) * (this.maximum - this.minimum);
			else this.value = this.minimum + (x - this._currentMeasure.left) / this._currentMeasure.width * (this.maximum - this.minimum);
		}
		let delta = 0;
		if (this.isVertical) delta = -((y - this._originY) / (this._currentMeasure.height - this._effectiveThumbThickness));
		else delta = (x - this._originX) / (this._currentMeasure.width - this._effectiveThumbThickness);
	...
	_parseFromContent(serializationObject, host) {
		...
		if (serializationObject.backgroundGradient) {
			this.backgroundGradient = new (Tools.Instantiate("BABYLON.GUI." + serializationObject.backgroundGradient.className))();
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/sliders/imageScrollBar.js
/**
* Class used to create slider controls
*/
var ImageScrollBar = class extends BaseSlider {
	...
	*/
	...
	set backgroundImage(value) {
		if (this._backgroundBaseImage === value) return;
		this._backgroundBaseImage = value;
		if (this.isVertical && this.num90RotationInVerticalMode !== 0) if (!value.isLoaded) value.onImageLoadedObservable.addOnce(() => {
			const rotatedValue = value._rotate90(this.num90RotationInVerticalMode, true);
			this._backgroundImage = rotatedValue;
			if (!rotatedValue.isLoaded) rotatedValue.onImageLoadedObservable.addOnce(() => {
				this._markAsDirty();
			});
			this._markAsDirty();
		});
			...
			if (value && !value.isLoaded) value.onImageLoadedObservable.addOnce(() => {
				this._markAsDirty();
			});
			this._markAsDirty();
		}
	...
	*/
	...
	set thumbImage(value) {
		if (this._thumbBaseImage === value) return;
	...
	*/
	...
	set thumbLength(value) {
		if (this._thumbLength === value) return;
	...
	*/
	...
	set barImageHeight(value) {
		if (this._barImageHeight === value) return;
	...
	*/
	...
	_draw(context) {
		...
		if (this._backgroundImage) {
			...
			if (this.isVertical) {
				this._tempMeasure.copyFromFloats(left + width * (1 - this._barImageHeight) * .5, this._currentMeasure.top, width * this._barImageHeight, height);
				this._tempMeasure.height += this._effectiveThumbThickness;
				this._backgroundImage._currentMeasure.copyFrom(this._tempMeasure);
			} else {
				this._tempMeasure.copyFromFloats(this._currentMeasure.left, top + height * (1 - this._barImageHeight) * .5, width, height * this._barImageHeight);
				this._tempMeasure.width += this._effectiveThumbThickness;
				this._backgroundImage._currentMeasure.copyFrom(this._tempMeasure);
			}
			this._backgroundImage._draw(context);
		}
		if (this.isVertical) this._tempMeasure.copyFromFloats(left - this._effectiveBarOffset + this._currentMeasure.width * (1 - this._thumbHeight) * .5, this._currentMeasure.top + thumbPosition, this._currentMeasure.width * this._thumbHeight, this._effectiveThumbThickness);
		else this._tempMeasure.copyFromFloats(this._currentMeasure.left + thumbPosition, this._currentMeasure.top + this._currentMeasure.height * (1 - this._thumbHeight) * .5, this._effectiveThumbThickness, this._currentMeasure.height * this._thumbHeight);
		if (this._thumbImage) {
...
__decorate([serialize()], ImageScrollBar.prototype, "invertScrollDirection", null);
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/scrollViewers/scrollViewer.js
/**
...
var ScrollViewer = class extends Rectangle {
	...
	*/
	...
	_flagDescendantsAsMatrixDirty() {
		for (const child of this._children) child._markMatrixAsDirty();
	}
	/**
	...
	* */
	...
	set wheelPrecision(value) {
		if (this._wheelPrecision === value) return;
		if (value < 0) value = 0;
		if (value > 1) value = 1;
	...
	set scrollBackground(color) {
		if (this._horizontalBarSpace.background === color) return;
	...
	set thumbImage(value) {
		if (this._barImage === value) return;
	...
	set horizontalThumbImage(value) {
		if (this._horizontalBarImage === value) return;
	...
	set verticalThumbImage(value) {
		if (this._verticalBarImage === value) return;
	...
	set barSize(value) {
		if (this._barSize === value) return;
		this._barSize = value;
		this._markAsDirty();
		if (this._horizontalBar.isVisible) this._grid.setRowDefinition(1, this._barSize, true);
		if (this._verticalBar.isVisible) this._grid.setColumnDefinition(1, this._barSize, true);
	}
	/** Gets or sets the length of the thumb */
	get thumbLength() {
		return this._thumbLength;
	...
	set thumbHeight(value) {
		if (this._thumbHeight === value) return;
		if (value <= 0) value = .1;
		if (value > 1) value = 1;
		this._thumbHeight = value;
		const hb = this._horizontalBar;
	...
	set horizontalBarImageHeight(value) {
		if (this._horizontalBarImageHeight === value) return;
		if (value <= 0) value = .1;
		if (value > 1) value = 1;
	...
	set verticalBarImageHeight(value) {
		if (this._verticalBarImageHeight === value) return;
		if (value <= 0) value = .1;
		if (value > 1) value = 1;
	...
	set barBackground(color) {
		if (this._barBackground === color) return;
	...
	_setWindowPosition(force = true) {
		...
		if (!force && this._oldWindowContentsWidth === windowContentsWidth && this._oldWindowContentsHeight === windowContentsHeight) return;
		...
		if (newLeft !== this._window.left) {
			...
			if (!this.freezeControls) this._rebuildLayout = true;
		}
	...
	_updateScroller() {
		...
		this._buildClientSizes();
		const ratio = this.host.idealRatio;
		this._horizontalBar.thumbWidth = this._thumbLength * .9 * (this._clientWidth / ratio) + "px";
		this._verticalBar.thumbWidth = this._thumbLength * .9 * (this._clientHeight / ratio) + "px";
	}
	_link(host) {
		super._link(host);
		this._attachWheel();
	...
	*/
	...
	/** @internal */
	_attachWheel() {
		if (!this._host || this._onWheelObserver) return;
		this._onWheelObserver = this.onWheelObservable.add((pi) => {
			if (!this._pointerIsOver || this.isReadOnly) return;
			if (this._verticalBar.isVisible == true) {
				if (pi.y < 0 && this._verticalBar.value > 0) this._verticalBar.value -= this._wheelPrecision;
				else if (pi.y > 0 && this._verticalBar.value < this._verticalBar.maximum) this._verticalBar.value += this._wheelPrecision;
			}
			if (this._horizontalBar.isVisible == true) {
				if (pi.x < 0 && this._horizontalBar.value < this._horizontalBar.maximum) this._horizontalBar.value += this._wheelPrecision;
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/toggleButton.js
/**
...
var ToggleButton = class extends Rectangle {
	...
	set isActive(value) {
		...
		if (this._isActive) this.toActiveAnimation?.();
		else this.toInactiveAnimation?.();
		this._markAsDirty();
		this.onIsActiveChangedObservable.notifyObservers(value);
		if (this._isActive && this._host && this._group) this._host.executeOnAllControls((control) => {
			if (control.typeName === "ToggleButton") {
				if (control === this) return;
				const childToggle = control;
				if (childToggle.group === this.group) childToggle.isActive = false;
			}
		});
	}
	/**
	...
	*/
	_onPointerEnter(target, pi) {
		...
		if (this.isReadOnly) return true;
		if (this._isActive) {
			if (this.pointerEnterActiveAnimation) this.pointerEnterActiveAnimation();
		} else if (this.pointerEnterInactiveAnimation) this.pointerEnterInactiveAnimation();
		return true;
	}
	/**
	* @internal
	*/
	_onPointerOut(target, pi, force = false) {
		if (!this.isReadOnly) {
			if (this._isActive) {
				if (this.pointerOutActiveAnimation) this.pointerOutActiveAnimation();
			} else if (this.pointerOutInactiveAnimation) this.pointerOutInactiveAnimation();
		}
		super._onPointerOut(target, pi, force);
	}
	/**
	...
	*/
	_onPointerDown(target, coordinates, pointerId, buttonIndex, pi) {
		...
		if (this.isReadOnly) return true;
		if (this._isActive) {
			if (this.pointerDownActiveAnimation) this.pointerDownActiveAnimation();
		} else if (this.pointerDownInactiveAnimation) this.pointerDownInactiveAnimation();
		return true;
	}
	/**
	* @internal
	*/
	_onPointerUp(target, coordinates, pointerId, buttonIndex, notifyClick, pi) {
		if (!this.isReadOnly) {
			if (this._isActive) {
				if (this.pointerUpActiveAnimation) this.pointerUpActiveAnimation();
			} else if (this.pointerUpInactiveAnimation) this.pointerUpInactiveAnimation();
		}
		super._onPointerUp(target, coordinates, pointerId, buttonIndex, notifyClick, pi);
	}
};
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/virtualKeyboard.js
/**
...
*/
var VirtualKeyboard = class VirtualKeyboard extends StackPanel {
	constructor() {
		super(...arguments);
	...
	*/
	addKeysRow(keys, propertySets) {
		...
		for (let i = 0; i < keys.length; i++) {
			let properties = null;
			if (propertySets && propertySets.length === keys.length) properties = propertySets[i];
			const key = this._createKey(keys[i], properties);
			if (!maxKey || key.heightInPixels > maxKey.heightInPixels) maxKey = key;
	...
	*/
	connect(input) {
		if (this._connectedInputTexts.some((a) => a.input === input)) return;
		if (this._onKeyPressObserver === null) this._onKeyPressObserver = this.onKeyPressObservable.add((key) => {
			if (!this._currentlyConnectedInputText) return;
			this._currentlyConnectedInputText._host.focusedControl = this._currentlyConnectedInputText;
			switch (key) {
				case "⇧":
					this.shiftState++;
					if (this.shiftState > 2) this.shiftState = 0;
					this.applyShiftState(this.shiftState);
					return;
				case "←":
					if (this._currentlyConnectedInputText instanceof InputTextArea) this._currentlyConnectedInputText.alternativeProcessKey("Backspace");
					else this._currentlyConnectedInputText.processKey(8);
					return;
				case "↵":
					if (this._currentlyConnectedInputText instanceof InputTextArea) this._currentlyConnectedInputText.alternativeProcessKey("Enter");
					else this._currentlyConnectedInputText.processKey(13);
					return;
			}
			if (this._currentlyConnectedInputText instanceof InputTextArea) this._currentlyConnectedInputText.alternativeProcessKey("", this.shiftState ? key.toUpperCase() : key);
			else this._currentlyConnectedInputText.processKey(-1, this.shiftState ? key.toUpperCase() : key);
	...
	disconnect(input) {
		if (input) {
			...
			if (filtered.length === 1) {
				...
				if (this._currentlyConnectedInputText === input) this._currentlyConnectedInputText = null;
			}
		} else {
	...
	*/
	_parseFromContent(serializedObject, host) {
		super._parseFromContent(serializedObject, host);
		for (const row of this.children) if (row.getClassName() === "StackPanel") {
			const stackPanel = row;
			for (const key of stackPanel.children) if (key.getClassName() === "Button" && key.name) key.onPointerUpObservable.add(() => {
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/displayGrid.js
...
var DisplayGrid = class extends Control {
	...
	set displayMinorLines(value) {
		if (this._displayMinorLines === value) return;
	...
	set displayMajorLines(value) {
		if (this._displayMajorLines === value) return;
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/sliders/imageBasedSlider.js
/**
...
var ImageBasedSlider = class extends BaseSlider {
	...
	*/
	...
	set backgroundImage(value) {
		if (this._backgroundImage === value) return;
		this._backgroundImage = value;
		if (value && !value.isLoaded) value.onImageLoadedObservable.addOnce(() => this._markAsDirty());
		this._markAsDirty();
	}
	/**
	...
	*/
	...
	set valueBarImage(value) {
		if (this._valueBarImage === value) return;
	...
	*/
	...
	set thumbImage(value) {
		if (this._thumbImage === value) return;
		this._thumbImage = value;
		if (value && !value.isLoaded) value.onImageLoadedObservable.addOnce(() => this._markAsDirty());
		this._markAsDirty();
	}
	...
	*/
	...
	_draw(context) {
		...
		if (this._backgroundImage) {
			this._tempMeasure.copyFromFloats(left, top, width, height);
			if (this.isThumbClamped && this.displayThumb) if (this.isVertical) this._tempMeasure.height += this._effectiveThumbThickness;
			else this._tempMeasure.width += this._effectiveThumbThickness;
			this._backgroundImage._currentMeasure.copyFrom(this._tempMeasure);
			this._backgroundImage._draw(context);
		}
		if (this._valueBarImage) {
			if (this.isVertical) if (this.isThumbClamped && this.displayThumb) this._tempMeasure.copyFromFloats(left, top + thumbPosition, width, height - thumbPosition + this._effectiveThumbThickness);
			else this._tempMeasure.copyFromFloats(left, top + thumbPosition, width, height - thumbPosition);
			else if (this.isThumbClamped && this.displayThumb) this._tempMeasure.copyFromFloats(left, top, thumbPosition + this._effectiveThumbThickness / 2, height);
			else this._tempMeasure.copyFromFloats(left, top, thumbPosition, height);
			this._valueBarImage._currentMeasure.copyFrom(this._tempMeasure);
			this._valueBarImage._draw(context);
		}
		if (this.displayThumb) {
			if (this.isVertical) this._tempMeasure.copyFromFloats(left - this._effectiveBarOffset, this._currentMeasure.top + thumbPosition, this._currentMeasure.width, this._effectiveThumbThickness);
			else this._tempMeasure.copyFromFloats(this._currentMeasure.left + thumbPosition, this._currentMeasure.top, this._effectiveThumbThickness, this._currentMeasure.height);
			this._thumbImage._currentMeasure.copyFrom(this._tempMeasure);
			this._thumbImage._draw(context);
		}
		context.restore();
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/statics.js
/**
...
Control.AddHeader = function(control, text, size, options) {
	...
	header.text = text;
	header.textHorizontalAlignment = Control.HORIZONTAL_ALIGNMENT_LEFT;
	if (isHorizontal) header.width = size;
	else header.height = size;
	if (controlFirst) {
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/gradient/BaseGradient.js
/**
...
var BaseGradient = class {
	...
	_addColorStopsToCanvasGradient() {
		for (const stop of this._colorStops) this._canvasGradient.addColorStop(stop.offset, stop.color);
	}
	/**
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/gradient/LinearGradient.js
/**
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/controls/gradient/RadialGradient.js
/**
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/style.js
/**
...
var Style = class {
	...
	*/
	...
	set fontSize(value) {
		if (this._fontSize.toString(this._host) === value) return;
		if (this._fontSize.fromString(value)) this.onChangedObservable.notifyObservers(this);
	}
	/**
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/advancedDynamicTexture.js
/**
* Class used to create texture to support 2D GUI elements
* @see https://doc.babylonjs.com/features/featuresDeepDive/gui/gui
*/
var AdvancedDynamicTexture = class AdvancedDynamicTexture extends DynamicTexture {
	...
	*/
	...
	set adjustToEngineHardwareScalingLevel(value) {
		if (this._adjustToEngineHardwareScalingLevel === value) return;
	...
	*/
	...
	set renderScale(value) {
		if (value === this._renderScale) return;
	...
	*/
	...
	set idealWidth(value) {
		if (this._idealWidth === value) return;
	...
	*/
	...
	set idealHeight(value) {
		if (this._idealHeight === value) return;
	...
	*/
	...
	set useSmallestIdeal(value) {
		if (this._useSmallestIdeal === value) return;
	...
	*/
	...
	set renderAtIdealSize(value) {
		if (this._renderAtIdealSize === value) return;
	...
	* */
	get idealRatio() {
		let rwidth = 0;
		let rheight = 0;
		if (this._idealWidth) rwidth = this.getSize().width / this._idealWidth;
		if (this._idealHeight) rheight = this.getSize().height / this._idealHeight;
		if (this._useSmallestIdeal && this._idealWidth && this._idealHeight) return window.innerWidth < window.innerHeight ? rwidth : rheight;
		if (this._idealWidth) return rwidth;
		if (this._idealHeight) return rheight;
		return 1;
	}
	/**
	...
	*/
	...
	set focusedControl(control) {
		...
		if (this._focusedControl) this._focusedControl.onBlur();
	...
	*/
	...
	set isForeground(value) {
		...
		if (this.layer.isBackground === !value) return;
	...
	*/
	...
	constructor(name, widthOrOptions, _height = 0, scene, generateMipMaps = false, samplingMode = Texture.NEAREST_SAMPLINGMODE, invertY = true) {
		...
		super(name, {
			width,
			height
		}, typeof widthOrOptions === "object" && widthOrOptions !== void 0 ? widthOrOptions : scene, generateMipMaps, samplingMode, Constants.TEXTUREFORMAT_RGBA, invertY);
		...
		*/
		...
		scene = this.getScene();
		if (!scene || !this._texture) return;
		this.applyYInversionOnUpdate = invertY;
		this._rootElement = scene.getEngine().getInputElement();
		this.useStandalone = !!widthOrOptions?.useStandalone;
		if (!this.useStandalone) this._renderObserver = scene.onBeforeCameraRenderObservable.add((camera) => this._checkUpdate(camera));
		...
		this._controlAddedObserver = this._rootContainer.onControlAddedObservable.add((control) => {
			if (control) this._rootChildrenHaveChanged = true;
		});
		...
		this._preKeyboardObserver = scene.onPreKeyboardObservable.add((info) => {
			...
			if (!this._focusedControl) return;
			if (info.type === KeyboardEventTypes.KEYDOWN) this._focusedControl.processKeyboard(info.event);
	...
	*/
	executeOnAllControls(func, container) {
		if (!container) container = this._rootContainer;
		func(container);
	...
	*/
	invalidateRect(invalidMinX, invalidMinY, invalidMaxX, invalidMaxY) {
		if (!this._useInvalidateRectOptimization) return;
		if (!this._invalidatedRectangle) this._invalidatedRectangle = new Measure(invalidMinX, invalidMinY, invalidMaxX - invalidMinX + 1, invalidMaxY - invalidMinY + 1);
		else {
	...
	*/
	moveToNonOverlappedPosition(overlapGroup, deltaStep = 1, repelFactor = 1) {
		...
		if (Array.isArray(overlapGroup)) controlsForGroup = overlapGroup;
		else {
		...
		controlsForGroup.forEach((control1) => {
			...
			controlsForGroup.forEach((control2) => {
				if (control1 !== control2 && AdvancedDynamicTexture._Overlaps(control1, control2)) {
					...
					if (diffLength > 0) velocity = velocity.add(diff.normalize().scale(repelFactor / diffLength));
				}
			});
	...
	*/
	dispose() {
		...
		if (this._resizeObserver) scene.getEngine().onResizeObservable.remove(this._resizeObserver);
		if (this._prePointerObserver) scene.onPrePointerObservable.remove(this._prePointerObserver);
		if (this._sceneRenderObserver) scene.onBeforeRenderObservable.remove(this._sceneRenderObserver);
		if (this._pointerObserver) scene.onPointerObservable.remove(this._pointerObserver);
		if (this._preKeyboardObserver) scene.onPreKeyboardObservable.remove(this._preKeyboardObserver);
		if (this._canvasPointerOutObserver) scene.getEngine().onCanvasPointerOutObservable.remove(this._canvasPointerOutObserver);
		if (this._canvasBlurObserver) scene.getEngine().onCanvasBlurObservable.remove(this._canvasBlurObserver);
		if (this._controlAddedObserver) this._rootContainer.onControlAddedObservable.remove(this._controlAddedObserver);
		if (this._controlRemovedObserver) this._rootContainer.onControlRemovedObservable.remove(this._controlRemovedObserver);
	...
	_onResize() {
		...
		if (this.adjustToEngineHardwareScalingLevel) this._renderScale = engine.getHardwareScalingLevel();
		...
		if (textureSize.width !== renderWidth || textureSize.height !== renderHeight) {
			...
			this.markAsDirty();
			if (this._idealWidth || this._idealHeight) this._rootContainer._markAllAsDirty();
	...
	*/
	...
	_checkUpdate(camera, skipUpdate) {
		if (this._layerToDispose && camera) {
			if ((camera.layerMask & this._layerToDispose.layerMask) === 0) return;
		}
		if (this._isFullscreen && this._linkedControls.length) {
			...
			for (const control of this._linkedControls) {
				...
				if (this.useInvalidateRectOptimization) control.invalidateRect();
				control._moveToProjectedPosition(projectedPosition);
			}
		}
		if (!this._isDirty && !this._rootContainer.isDirty) return;
		this._isDirty = false;
		this._render(skipUpdate);
		if (!skipUpdate) this.update(this.applyYInversionOnUpdate, this.premulAlpha, AdvancedDynamicTexture.AllowGPUOptimizations);
	}
	_render(skipRender) {
		const textureSize = this.getSize();
		const renderWidth = textureSize.width;
		...
		if (this.onGuiReadyObservable.hasObservers()) this._checkGuiIsReady();
		...
		if (this._invalidatedRectangle) this._clearMeasure.copyFrom(this._invalidatedRectangle);
		else this._clearMeasure.copyFromFloats(0, 0, renderWidth, renderHeight);
	...
	*/
	...
	_doPicking(x, y, pi, type, pointerId, buttonIndex, deltaX, deltaY) {
		const scene = this.getScene();
		if (!scene || this.disablePicking) return;
		const engine = scene.getEngine();
		const textureSize = this.getSize();
		...
		if (this._capturingControl[pointerId]) {
			if (this._capturingControl[pointerId].isPointerBlocker) this._shouldBlockPointer = true;
			this._capturingControl[pointerId]._processObservables(type, x, y, pi, pointerId, buttonIndex);
			return;
		}
		this._cursorChanged = false;
		if (!this._rootContainer._processPicking(x, y, pi, type, pointerId, buttonIndex, deltaX, deltaY)) {
			if (!scene.doNotHandleCursors) this._changeCursor("");
			if (type === PointerEventTypes.POINTERMOVE) {
		...
		if (!this._cursorChanged && !scene.doNotHandleCursors) this._changeCursor("");
		this._manageFocus();
	}
	/**
	* @internal
	*/
	_cleanControlAfterRemovalFromList(list, control) {
		for (const pointerId in list) {
			if (!Object.prototype.hasOwnProperty.call(list, pointerId)) continue;
			if (list[pointerId] === control) delete list[pointerId];
		}
	}
	/**
	* @internal
	...
	*/
	pick(x, y, pi = null) {
		if (this._isFullscreen && this._scene) this._translateToPicking(this._scene, new Viewport(0, 0, 0, 0), pi, x, y);
	}
	_translateToPicking(scene, tempViewport, pi, x = scene.pointerX, y = scene.pointerY) {
		...
		if (!camera) {
		...
		} else if (camera.rigCameras.length) {
			...
			camera.rigCameras.forEach((rigCamera) => {
				...
				if (transformedX < 0 || transformedY < 0 || x > rigViewport.width || y > rigViewport.height) return;
		...
		} else camera.viewport.toGlobalToRef(engine.getRenderWidth(), engine.getRenderHeight(), tempViewport);
		...
		if (pi) {
			...
			if (this._shouldBlockPointer && !(pi.type & this.skipBlockEvents) || this._capturingControl[pointerId]) pi.skipOnPointerObservable = true;
		} else this._doPicking(transformedX, transformedY, null, PointerEventTypes.POINTERMOVE, this._defaultMousePointerId, 0);
	...
	attach() {
		...
		this._prePointerObserver = scene.onPrePointerObservable.add((pi) => {
			if (scene.isPointerCaptured(pi.event.pointerId) && pi.type === PointerEventTypes.POINTERUP && !this._capturedPointerIds.has(pi.event.pointerId)) return;
			if (pi.type !== PointerEventTypes.POINTERMOVE && pi.type !== PointerEventTypes.POINTERUP && pi.type !== PointerEventTypes.POINTERDOWN && pi.type !== PointerEventTypes.POINTERWHEEL && pi.type !== PointerEventTypes.POINTERTAP) return;
			if (pi.type === PointerEventTypes.POINTERMOVE) {
				if (scene.isPointerCaptured(pi.event.pointerId)) return;
				if (pi.event.pointerId) this._defaultMousePointerId = pi.event.pointerId;
			}
	...
	_focusNextElement(forward = true) {
		...
		this.executeOnAllControls((control) => {
			if (control.isFocusInvisible || !control.isVisible || control.tabIndex < 0) return;
			sortedTabbableControls.push(control);
		});
		if (sortedTabbableControls.length === 0) return;
		...
		let nextIndex = -1;
		if (!this._focusedControl) nextIndex = forward ? 0 : sortedTabbableControls.length - 1;
		else {
			nextIndex = sortedTabbableControls.indexOf(this._focusedControl) + (forward ? 1 : -1);
			if (nextIndex < 0) nextIndex = sortedTabbableControls.length - 1;
			else if (nextIndex >= sortedTabbableControls.length) nextIndex = 0;
		}
	...
	*/
	_transformUvs(uv) {
		...
		let result;
		if (textureMatrix.isIdentityAs3x2()) result = uv;
		else {
		...
		if (this.wrapU === Texture.WRAP_ADDRESSMODE || this.wrapU === Texture.MIRROR_ADDRESSMODE) {
			if (result.x > 1) {
				...
				if (this.wrapU === Texture.MIRROR_ADDRESSMODE && Math.trunc(result.x) % 2 === 1) fX = 1 - fX;
				result.x = fX;
			}
		}
		if (this.wrapV === Texture.WRAP_ADDRESSMODE || this.wrapV === Texture.MIRROR_ADDRESSMODE) {
			if (result.y > 1) {
				...
				if (this.wrapV === Texture.MIRROR_ADDRESSMODE && Math.trunc(result.x) % 2 === 1) fY = 1 - fY;
				result.y = fY;
			}
		}
		return result;
	...
	*/
	attachToMesh(mesh, supportPointerMove = true) {
		...
		this._pointerObserver = scene.onPointerObservable.add((pi) => {
			if (pi.type !== PointerEventTypes.POINTERMOVE && pi.type !== PointerEventTypes.POINTERUP && pi.type !== PointerEventTypes.POINTERDOWN && pi.type !== PointerEventTypes.POINTERWHEEL) return;
			if (pi.type === PointerEventTypes.POINTERMOVE && pi.event.pointerId) this._defaultMousePointerId = pi.event.pointerId;
			const pointerId = pi.event.pointerId || this._defaultMousePointerId;
			if (pi.pickInfo && pi.pickInfo.hit && pi.pickInfo.pickedMesh === mesh) {
				...
				if (this._lastControlDown[pointerId]) this._lastControlDown[pointerId]._forcePointerUp(pointerId);
				delete this._lastControlDown[pointerId];
				if (this.focusedControl) {
					const friendlyControls = this.focusedControl.keepsFocusWith();
					let canMoveFocus = true;
					if (friendlyControls) for (const control of friendlyControls) {
						if (this === control._host) continue;
					...
					if (canMoveFocus) this.focusedControl = null;
				}
			} else if (pi.type === PointerEventTypes.POINTERMOVE) {
				if (this._lastControlOver[pointerId]) this._lastControlOver[pointerId]._onPointerOut(this._lastControlOver[pointerId], pi, true);
				delete this._lastControlOver[pointerId];
			}
		});
		...
		this._attachPickingToSceneRender(scene, () => {
			...
			if (pick && pick.hit && pick.pickedMesh === mesh) {
				...
				if (this._lastControlOver[pointerId]) this._lastControlOver[pointerId]._onPointerOut(this._lastControlOver[pointerId], null, true);
				delete this._lastControlOver[pointerId];
			}
		}, true);
		this._attachToOnPointerOut(scene);
	...
	*/
	...
	_attachPickingToSceneRender(scene, pickFunction, forcePicking) {
		this._sceneRenderObserver = scene.onBeforeRenderObservable.add(() => {
			...
			if (this._linkedControls.length > 0 || forcePicking) pickFunction();
		});
	}
	_attachToOnPointerOut(scene) {
		this._canvasPointerOutObserver = scene.getEngine().onCanvasPointerOutObservable.add((pointerEvent) => {
			if (this._lastControlOver[pointerEvent.pointerId]) this._lastControlOver[pointerEvent.pointerId]._onPointerOut(this._lastControlOver[pointerEvent.pointerId], null);
	...
	*/
	parseSerializedObject(serializedObject, scaleToSize, urlRewriter) {
		...
		if (scaleToSize) {
			...
			if (typeof width === "number" && typeof height === "number" && width >= 0 && height >= 0) this.scaleTo(width, height);
			else this.scaleTo(1920, 1080);
		}
	}
	/**
	...
	*/
	clone(newName, attachToMesh) {
		...
		let clone;
		if (!this._isFullscreen) if (attachToMesh) clone = AdvancedDynamicTexture.CreateForMesh(attachToMesh, size.width, size.height);
		else clone = new AdvancedDynamicTexture(newName ?? "Clone of " + this.name, size.width, size.height, scene, !this.noMipmap, this.samplingMode);
		else clone = AdvancedDynamicTexture.CreateFullscreenUI(newName ?? "Clone of " + this.name);
	...
	*/
	static async ParseFromSnippetAsync(snippetId, scaleToSize, appendToAdt, urlRewriter) {
		...
		if (snippetId === "_BLANK") return adt;
		...
		return new Promise((resolve, reject) => {
			...
			request.addEventListener("readystatechange", () => {
				if (request.readyState == 4) if (request.status == 200) {
					...
					} else gui = request.responseText;
					resolve(JSON.parse(gui));
				} else reject("Unable to load");
			});
	...
	*/
	...
	static _CreateMaterial(mesh, uniqueId, texture, onlyAlphaTesting) {
		...
		if (!internalClassType) throw "StandardMaterial needs to be imported before as it contains a side-effect required by your code.";
	...
	*/
	static CreateFullscreenUI(name, foreground = true, sceneOrOptions = null, sampling = Texture.BILINEAR_SAMPLINGMODE, adaptiveScaling = false) {
		const result = !sceneOrOptions || sceneOrOptions._isScene ? new AdvancedDynamicTexture(name, 0, 0, sceneOrOptions, false, sampling) : new AdvancedDynamicTexture(name, sceneOrOptions);
		const resultScene = result.getScene();
		const layer = new Layer(name + "_layer", null, resultScene, !foreground);
		layer.texture = result;
		result._layerToDispose = layer;
		result._isFullscreen = true;
		if (result.useStandalone) layer.layerMask = 0;
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/adtInstrumentation.js
/**
...
var AdvancedDynamicTextureInstrumentation = class {
	...
	*/
	...
	set captureRenderTime(value) {
		if (value === this._captureRenderTime) return;
	...
	*/
	...
	set captureLayoutTime(value) {
		if (value === this._captureLayoutTime) return;
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/FrameGraph/guiTask.js
/**
...
var FrameGraphGUITask = class extends FrameGraphTask {
	...
	*/
	constructor(name, frameGraph, adt) {
		...
		if (adt) {
			if (!adt.useStandalone) throw new Error(`AdvancedDynamicTexture "${name}": the texture must have been created with the useStandalone property set to true`);
		} else adt = AdvancedDynamicTexture.CreateFullscreenUI(name, void 0, { useStandalone: true });
		this._adt = adt;
	...
	record() {
		if (this.targetTexture === void 0) throw new Error("FrameGraphGUITask: targetTexture is required");
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/FrameGraph/renderGraphGUIBlock.js
/**
...
var NodeRenderGraphGUIBlock = class extends NodeRenderGraphBlock {
	...
	*/
	constructor(name, frameGraph, scene) {
		...
		this._gui = AdvancedDynamicTexture.CreateFullscreenUI(this.name, void 0, { useStandalone: true });
...
//#endregion
//#region node_modules/@babylonjs/gui/2D/xmlLoader.js
...
var XmlLoader = class {
	...
	*/
	constructor(parentClass = null) {
		...
		if (parentClass) this._parentClass = parentClass;
	}
	_getChainElement(attributeValue) {
		let element = window;
		if (this._parentClass) element = this._parentClass;
		let value = attributeValue;
		value = value.split(".");
		for (let i = 0; i < value.length; i++) element = element[value[i]];
		return element;
	}
	_getClassAttribute(attributeName) {
		const attribute = attributeName.split(".");
		return GetClass("BABYLON.GUI." + attribute[0])[attribute[1]];
	}
	_createGuiElement(node, parent, linkParent = true) {
		try {
			const guiNode = new (GetClass("BABYLON.GUI." + node.nodeName))();
			if (parent && linkParent) parent.addControl(guiNode);
			for (let i = 0; i < node.attributes.length; i++) {
				if (node.attributes[i].name.toLowerCase().includes("datasource")) continue;
				if (node.attributes[i].name.toLowerCase().includes("observable")) {
					...
					continue;
				} else if (node.attributes[i].name == "linkWithMesh") if (this._parentClass) guiNode.linkWithMesh(this._parentClass[node.attributes[i].value]);
				else guiNode.linkWithMesh(window[node.attributes[i].value]);
					...
					if (!(node.attributes[i].value.startsWith("{{") && node.attributes[i].value.endsWith("}}"))) element = node.attributes[i].value.replace(/{{.*}}/, `${element}`);
					guiNode[node.attributes[i].name] = element;
				} else if (!this._objectAttributes[node.attributes[i].name]) if (node.attributes[i].value == "true" || node.attributes[i].value == "false") guiNode[node.attributes[i].name] = node.attributes[i].value == "true";
				else guiNode[node.attributes[i].name] = !isNaN(Number(node.attributes[i].value)) ? Number(node.attributes[i].value) : node.attributes[i].value;
				else guiNode[node.attributes[i].name] = this._getClassAttribute(node.attributes[i].value);
			}
			...
			if (id.startsWith("{{") && id.endsWith("}}")) id = this._getChainElement(id.substring(2, id.length - 2));
			if (!this._nodes[id]) this._nodes[id] = guiNode;
			else throw "XmlLoader Exception : Duplicate ID, every element should have an unique ID attribute";
			return guiNode;
		} catch (exception) {
	...
	_parseGrid(node, guiNode, parent) {
		...
		for (let i = 0; i < rows.length; i++) {
			if (rows[i].nodeType != this._nodeTypes.element) continue;
			if (rows[i].nodeName != "Row") throw "XmlLoader Exception : Expecting Row node, received " + rows[i].nodeName;
			rowNumber += 1;
			columns = rows[i].children;
			if (!rows[i].attributes.getNamedItem("height")) throw "XmlLoader Exception : Height must be defined for grid rows";
			...
			for (let j = 0; j < columns.length; j++) {
				if (columns[j].nodeType != this._nodeTypes.element) continue;
				if (columns[j].nodeName != "Column") throw "XmlLoader Exception : Expecting Column node, received " + columns[j].nodeName;
				columnNumber += 1;
				if (rowNumber > 0 && columnNumber > totalColumnsNumber) throw "XmlLoader Exception : In the Grid element, the number of columns is defined in the first row, do not add more columns in the subsequent rows.";
				if (rowNumber == 0) {
					if (!columns[j].attributes.getNamedItem("width")) throw "XmlLoader Exception : Width must be defined for all the grid columns in the first row";
				...
				for (let k = 0; k < cells.length; k++) {
					if (cells[k].nodeType != this._nodeTypes.element) continue;
					cellNode = this._createGuiElement(cells[k], guiNode, false);
					guiNode.addControl(cellNode, rowNumber, columnNumber);
					if (cells[k].firstChild) this._parseXml(cells[k].firstChild, cellNode);
				}
			}
			if (rowNumber == 0) totalColumnsNumber = columnNumber;
			columnNumber = -1;
		}
		if (node.nextSibling) this._parseXml(node.nextSibling, parent);
	}
	_parseElement(node, guiNode, parent) {
		if (node.firstChild) this._parseXml(node.firstChild, guiNode);
		if (node.nextSibling) this._parseXml(node.nextSibling, parent);
	}
	_prepareSourceElement(node, guiNode, variable, source, iterator) {
		if (this._parentClass) this._parentClass[variable] = source[iterator];
		else window[variable] = source[iterator];
		if (node.firstChild) this._parseXml(node.firstChild, guiNode, true);
	}
	_parseElementsFromSource(node, guiNode, parent) {
		const dataSource = node.attributes.getNamedItem("dataSource").value;
		if (!dataSource.includes(" in ")) throw "XmlLoader Exception : Malformed XML, Data Source must include an in";
		else {
			let isArray = true;
			const splittedSource = dataSource.split(" in ");
			if (splittedSource.length < 2) throw "XmlLoader Exception : Malformed XML, Data Source must have an iterator and a source";
			let source = splittedSource[1];
			if (source.startsWith("{") && source.endsWith("}")) isArray = false;
			if (!isArray || source.startsWith("[") && source.endsWith("]")) source = source.substring(1, source.length - 1);
			if (this._parentClass) source = this._parentClass[source];
			else source = window[source];
			if (isArray) for (let i = 0; i < source.length; i++) this._prepareSourceElement(node, guiNode, splittedSource[0], source, i);
			else for (const i in source) this._prepareSourceElement(node, guiNode, splittedSource[0], source, i);
			if (node.nextSibling) this._parseXml(node.nextSibling, parent);
		}
	}
	_parseXml(node, parent, generated = false) {
		if (node.nodeType != this._nodeTypes.element) {
			if (node.nextSibling) this._parseXml(node.nextSibling, parent, generated);
			return;
		}
		if (generated) node.setAttribute("id", parent.id + (parent._children.length + 1));
		const guiNode = this._createGuiElement(node, parent);
		if (!this._rootNode) this._rootNode = guiNode;
		if (node.nodeName == "Grid") this._parseGrid(node, guiNode, parent);
		else if (!node.attributes.getNamedItem("dataSource")) this._parseElement(node, guiNode, parent);
		else this._parseElementsFromSource(node, guiNode, parent);
	}
	/**
	...
	loadLayout(xmlFile, rootNode, onSuccess = null, onError = null) {
		...
		xhttp.onload = () => {
			if (xhttp.readyState === 4 && xhttp.status === 200) {
				if (!xhttp.responseXML) if (onError) {
					onError(XmlLoaderError);
					return;
				} else throw XmlLoaderError;
		...
		xhttp.onerror = function() {
			if (onError) onError("an error occurred during loading the layout");
		};
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/vector3WithInfo.js
/**
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/control3D.js
/**
...
var Control3D = class {
	...
	*/
	addBehavior(behavior) {
		...
		if (scene.isLoading) scene.onDataLoadedObservable.addOnce(() => {
	...
	*/
	get mesh() {
		if (this._node instanceof AbstractMesh) return this._node;
		return null;
	}
	/**
	...
	*/
	linkToTransformNode(node) {
		if (this._node) this._node.parent = node;
		return this;
	}
	/**
	* @internal
	*/
	_prepareNode(scene) {
		if (!this._node) {
			...
			if (!this.node) return;
			if (this._position) this.node.position = this._position;
			if (this._scaling) this.node.scaling = this._scaling;
	...
	*/
	_onPointerEnter(target) {
		if (this._enterCount === -1) this._enterCount = 0;
		this._enterCount++;
		if (this._enterCount > 1) return false;
	...
	*/
	_onPointerOut(target) {
		this._enterCount--;
		if (this._enterCount > 0) return;
		this._enterCount = 0;
		this.onPointerOutObservable.notifyObservers(this, -1, target, this);
		if (this.pointerOutAnimation) this.pointerOutAnimation();
	}
	/**
	* @internal
	*/
	_onPointerDown(target, coordinates, pointerId, buttonIndex) {
		...
		if (this._downCount !== 1) return false;
		this.onPointerDownObservable.notifyObservers(new Vector3WithInfo(coordinates, buttonIndex), -1, target, this);
		if (this.pointerDownAnimation) this.pointerDownAnimation();
		return true;
	}
	/**
	* @internal
	*/
	_onPointerUp(target, coordinates, pointerId, buttonIndex, notifyClick) {
		...
		if (this._downPointerIds[pointerId] <= 0) delete this._downPointerIds[pointerId];
		if (this._downCount < 0) {
			this._downCount = 0;
			return;
		}
		if (this._downCount == 0) {
			if (notifyClick && (this._enterCount > 0 || this._enterCount === -1)) this.onPointerClickObservable.notifyObservers(new Vector3WithInfo(coordinates, buttonIndex), -1, target, this);
			this.onPointerUpObservable.notifyObservers(new Vector3WithInfo(coordinates, buttonIndex), -1, target, this);
			if (this.pointerUpAnimation) this.pointerUpAnimation();
		}
	}
	/**
	* @internal
	*/
	forcePointerUp(pointerId = null) {
		if (pointerId !== null) this._onPointerUp(this, Vector3.Zero(), pointerId, 0, true);
		else {
			for (const key in this._downPointerIds) this._onPointerUp(this, Vector3.Zero(), +key, 0, true);
			if (this._downCount > 0) {
				this._downCount = 1;
	...
	*/
	_processObservables(type, pickedPoint, originMeshPosition, pointerId, buttonIndex) {
		if (this._isTouchButton3D(this) && originMeshPosition) type = this._generatePointerEventType(type, originMeshPosition, this._downCount);
		if (type === PointerEventTypes.POINTERMOVE) {
			this._onPointerMove(this, pickedPoint);
			const previousControlOver = this._host._lastControlOver[pointerId];
			if (previousControlOver && previousControlOver !== this) previousControlOver._onPointerOut(this);
			if (previousControlOver !== this) this._onPointerEnter(this);
			this._host._lastControlOver[pointerId] = this;
			return true;
		}
		...
		if (type === PointerEventTypes.POINTERUP || type === PointerEventTypes.POINTERDOUBLETAP) {
			if (this._host._lastControlDown[pointerId]) this._host._lastControlDown[pointerId]._onPointerUp(this, pickedPoint, pointerId, buttonIndex, true);
			delete this._host._lastControlDown[pointerId];
			return true;
		}
		return false;
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/contentDisplay3D.js
/**
...
var ContentDisplay3D = class extends Control3D {
	...
	*/
	...
	set content(value) {
		this._content = value;
		if (!value || !this._host || !this._host.utilityLayer) return;
		if (!this._facadeTexture) {
			this._facadeTexture = new AdvancedDynamicTexture("Facade", typeof this._contentResolution === "number" ? this._contentResolution : this._contentResolution.width, typeof this._contentResolution === "number" ? this._contentResolution : this._contentResolution.height, this._host.utilityLayer.utilityLayerScene, true, Texture.TRILINEAR_SAMPLINGMODE);
			this._setFacadeTextureScaling();
			this._facadeTexture.premulAlpha = true;
		} else this._facadeTexture.rootContainer.clearControls();
		this._facadeTexture.addControl(value);
		this._applyFacade(this._facadeTexture);
	}
	_setFacadeTextureScaling() {
		if (this._facadeTexture) {
			if (typeof this._contentResolution !== "number") this._contentScaleRatioY = this._contentResolution.height / this._contentResolution.width * this._contentScaleRatio;
	...
	*/
	...
	set contentResolution(value) {
		...
		if (incomingWidth === currentWidth && incomingHeight === currentHeight) return;
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/abstractButton3D.js
/**
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/button3D.js
/**
...
var Button3D = class extends AbstractButton3D {
	...
	*/
	constructor(name, options) {
		...
		this.pointerDownAnimation = () => {
			if (!this.mesh) return;
			this.mesh.scaling.scaleInPlace(.95);
		};
		this.pointerUpAnimation = () => {
			if (!this.mesh) return;
			this.mesh.scaling.scaleInPlace(1 / .95);
		};
	}
	/**
	* Apply the facade texture (created from the content property).
	...
	*/
	...
	_createNode(scene) {
		...
		for (let i = 0; i < 6; i++) faceUV[i] = new Vector4(0, 0, 0, 0);
		if (scene.useRightHandedSystem) faceUV[0].copyFromFloats(1, 0, 0, 1);
		else faceUV[1].copyFromFloats(0, 0, 1, 1);
	...
	*/
	dispose() {
		super.dispose();
		this._disposeFacadeTexture();
		if (this._currentMaterial) this._currentMaterial.dispose();
	}
};
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/container3D.js
/**
...
var Container3D = class extends Control3D {
	...
	*/
	...
	set blockLayout(value) {
		if (this._blockLayout === value) return;
		this._blockLayout = value;
		if (!this._blockLayout) this._arrangeChildren();
	}
	/**
	* Creates a new container
	...
	*/
	addControl(control) {
		...
		if (this._host.utilityLayer) {
			...
			if (control.node) control.node.parent = this.node;
			if (!this.blockLayout) this._arrangeChildren();
		}
		return this;
	}
	/**
	...
	*/
	dispose() {
		for (const control of this._children) control.dispose();
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/volumeBasedPanel.js
/**
...
var VolumeBasedPanel = class extends Container3D {
	...
	*/
	...
	_arrangeChildren() {
		...
		const startOffsetX = columns * .5 * this._cellWidth;
		const startOffsetY = rows * .5 * this._cellHeight;
		const nodeGrid = [];
		let cellCounter = 0;
		if (this._rowThenColum) for (let r = 0; r < rows; r++) for (let c = 0; c < columns; c++) {
			nodeGrid.push(new Vector3(c * this._cellWidth - startOffsetX + this._cellWidth / 2, r * this._cellHeight - startOffsetY + this._cellHeight / 2, 0));
			cellCounter++;
			if (cellCounter > controlCount) break;
		}
		else for (let c = 0; c < columns; c++) for (let r = 0; r < rows; r++) {
			nodeGrid.push(new Vector3(c * this._cellWidth - startOffsetX + this._cellWidth / 2, r * this._cellHeight - startOffsetY + this._cellHeight / 2, 0));
			cellCounter++;
			if (cellCounter > controlCount) break;
		}
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/cylinderPanel.js
/**
	...
	_mapGridNode(control, nodePosition) {
		...
		switch (this.orientation) {
			...
			case Container3D.FACEORIGINREVERSED_ORIENTATION:
				...
				break;
			case Container3D.FACEFORWARD_ORIENTATION: break;
			case Container3D.FACEFORWARDREVERSED_ORIENTATION:
				mesh.rotate(Axis.Y, Math.PI, 0);
				break;
		}
	}
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/fluent/shaders/fluent.vertex.js
var name$20 = "fluentVertexShader";
var shader$19 = `precision highp float;attribute vec3 position;attribute vec3 normal;attribute vec2 uv;uniform mat4 world;uniform mat4 viewProjection;varying vec2 vUV;
#ifdef BORDER
...
`;
if (!ShaderStore.ShadersStore[name$20]) ShaderStore.ShadersStore[name$20] = shader$19;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/fluent/shaders/fluent.fragment.js
var name$19 = "fluentPixelShader";
var shader$18 = `precision highp float;varying vec2 vUV;uniform vec4 albedoColor;
#ifdef INNERGLOW
...
if (!ShaderStore.ShadersStore[name$19]) ShaderStore.ShadersStore[name$19] = shader$18;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/fluent/fluentMaterial.js
/** @internal */
...
*/
var FluentMaterial = class FluentMaterial extends PushMaterial {
	/**
	...
	*/
	constructor(name, scene) {
		...
		*/
		this.innerGlowColorIntensity = .5;
		/**
		...
		*/
		this.albedoColor = new Color3(.3, .35, .4);
		/**
		...
		*/
		this.edgeSmoothingValue = .02;
		/**
		* Gets or sets the minimum value that can be applied to border width (default is 0.1)
		*/
		this.borderMinValue = .1;
		/**
		...
		*/
		this.hoverColor = new Color4(.3, .3, .3, 1);
		/**
	...
	isReadyForSubMesh(mesh, subMesh) {
		...
		if (this.isFrozen) {
			if (drawWrapper.effect && drawWrapper._wasPreviouslyReady) return true;
		}
		if (!subMesh.materialDefines) subMesh.materialDefines = new FluentMaterialDefines();
		const scene = this.getScene();
		const defines = subMesh.materialDefines;
		if (!this.checkReadyOnEveryCall && subMesh.effect) {
			if (defines._renderId === scene.getRenderId()) return true;
		}
		if (defines._areTexturesDirty) {
			defines.INNERGLOW = this.innerGlowColorIntensity > 0;
			defines.BORDER = this.renderBorders;
			defines.HOVERLIGHT = this.renderHoverLight;
			if (this._albedoTexture) if (!this._albedoTexture.isReadyOrNotBlocking()) return false;
			else defines.TEXTURE = true;
			else defines.TEXTURE = false;
		}
		const engine = scene.getEngine();
		if (defines.isDirty) {
	...
	bindForSubMesh(world, mesh, subMesh) {
		...
		if (this._mustRebind(scene, effect, subMesh)) {
			...
			if (defines.INNERGLOW) this._activeEffect.setColor4("innerGlowColor", this.innerGlowColor, this.innerGlowColorIntensity);
			if (defines.BORDER) {
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/touchHolographicMenu.js
/**
* Simple menu that can contain holographic buttons
*/
var TouchHolographicMenu = class TouchHolographicMenu extends VolumeBasedPanel {
	/**
	...
	*/
	...
	_affectMaterial(mesh) {
		...
		this._backPlateMaterial.albedoColor = new Color3(.08, .15, .55);
		...
		this._pickedPointObserver = this._host.onPickedPointChangedObservable.add((pickedPoint) => {
			...
			} else this._backPlateMaterial.hoverColor.a = 0;
		});
	...
	_updateMargins() {
		if (this._children.length > 0) {
			...
			this._backPlate.scaling.z = .001;
			for (let i = 0; i < this._children.length; i++) {
				this._children[i].position.subtractInPlace(this._currentMin).subtractInPlace(extendSize.scale(.5));
				this._children[i].position.z -= .01;
			}
		}
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/handMenu.js
/**
...
if (!ShaderStore.ShadersStore[name$18]) ShaderStore.ShadersStore[name$18] = shader$17;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/fluentBackplate/shaders/fluentBackplate.vertex.js
var name$17 = "fluentBackplateVertexShader";
var shader$16 = `uniform mat4 world;uniform mat4 viewProjection;uniform vec3 cameraPosition;attribute vec3 position;attribute vec3 normal;
#ifdef TANGENT
...
if (!ShaderStore.ShadersStore[name$17]) ShaderStore.ShadersStore[name$17] = shader$16;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/fluentBackplate/fluentBackplateMaterial.js
/** @internal */
...
*/
var FluentBackplateMaterial = class FluentBackplateMaterial extends PushMaterial {
	constructor(name, scene) {
		super(name, scene);
		/**
		...
		*/
		this.baseColor = new Color4(.0392157, .0666667, .207843, 1);
		/**
		* Gets or sets the line color of the backplate.
		*/
		this.lineColor = new Color4(.14902, .133333, .384314, 1);
		/**
		* Gets or sets the intensity of the fluent hover glow effect.
		*/
		this.blobIntensity = .98;
		/**
		...
		*/
		this.highlightColor = new Color4(.98, .98, .98, 1);
		/**
		* Gets or sets the width of the highlights on the backplate line.
		*/
		this.highlightWidth = .25;
		/** @internal */
	...
	isReadyForSubMesh(mesh, subMesh) {
		...
		if (!subMesh.materialDefines) subMesh.materialDefines = new FluentBackplateMaterialDefines();
		const defines = subMesh.materialDefines;
		const scene = this.getScene();
		...
		if (defines.isDirty) {
			...
			if (defines.UV1) attribs.push(VertexBuffer.UVKind);
			if (defines.UV2) attribs.push(VertexBuffer.UV2Kind);
	...
	bindForSubMesh(world, mesh, subMesh) {
		if (!subMesh.materialDefines) return;
		const effect = subMesh.effect;
		if (!effect) return;
		this._activeEffect = effect;
		this.bindOnlyWorldMatrix(world);
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/holographicBackplate.js
/**
* Class used to create a holographic backplate in 3D
* @since 5.0.0
*/
var HolographicBackplate = class HolographicBackplate extends Control3D {
	/**
	...
	*/
	...
	_createNode(scene) {
		...
		SceneLoader.ImportMeshAsync(void 0, baseUrl, HolographicBackplate.MODEL_FILENAME, scene).then((result) => {
			...
			if (this._material) importedModel.material = this._material;
	...
	_affectMaterial(mesh) {
		if (this._shareMaterials) if (!this._host._touchSharedMaterials["fluentBackplateMaterial"]) {
			this._createMaterial(mesh);
			this._host._touchSharedMaterials["fluentBackplateMaterial"] = this._material;
		} else this._material = this._host._touchSharedMaterials["fluentBackplateMaterial"];
		else this._createMaterial(mesh);
	}
	/**
	* Releases all associated resources
	*/
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/holographicButton.js
/**
...
var HolographicButton = class extends Button3D {
	_disposeTooltip() {
		...
		if (this._tooltipTextBlock) this._tooltipTextBlock.dispose();
		if (this._tooltipTexture) this._tooltipTexture.dispose();
		if (this._tooltipMesh) this._tooltipMesh.dispose();
	...
	*/
	set renderingGroupId(id) {
		...
		if (this._tooltipMesh) this._tooltipMesh.renderingGroupId = id;
	}
	get renderingGroupId() {
	...
	*/
	set tooltipText(text) {
		...
		if (!this._tooltipFade) {
			...
			tooltipBackground.position = Vector3.Forward(rightHandedScene).scale(.05);
			this._tooltipMesh.scaling.y = 1 / 3;
			this._tooltipMesh.position = Vector3.Up().scale(.7).add(Vector3.Forward(rightHandedScene).scale(-.15));
			...
			this._tooltipHoverObserver = this.onPointerEnterObservable.add(() => {
				if (this._tooltipFade) this._tooltipFade.fadeIn(true);
			});
			this._tooltipOutObserver = this.onPointerOutObservable.add(() => {
				if (this._tooltipFade) this._tooltipFade.fadeIn(false);
			});
		}
		if (this._tooltipTextBlock) this._tooltipTextBlock.text = text;
	}
	get tooltipText() {
		if (this._tooltipTextBlock) return this._tooltipTextBlock.text;
		return null;
	}
	/**
	...
	*/
	...
	_rebuildContent() {
		...
		if (this._frontPlate) this.content = panel;
	}
	_createNode(scene) {
		...
		this._frontPlate.position = Vector3.Forward(scene.useRightHandedSystem).scale(-.08);
		this._frontPlate.isPickable = false;
		this._frontPlate.setEnabled(false);
		this._textPlate = super._createNode(scene);
		this._textPlate.parent = this._backPlate;
		this._textPlate.position = Vector3.Forward(scene.useRightHandedSystem).scale(-.08);
	...
	_affectMaterial(mesh) {
		if (this._shareMaterials) {
			...
			} else this._backMaterial = this._host._sharedMaterials["backFluentMaterial"];
			if (!this._host._sharedMaterials["frontFluentMaterial"]) {
				this._createFrontMaterial(mesh);
				this._host._sharedMaterials["frontFluentMaterial"] = this._frontMaterial;
			} else this._frontMaterial = this._host._sharedMaterials["frontFluentMaterial"];
		} else {
			this._createBackMaterial(mesh);
			this._createFrontMaterial(mesh);
		}
...
if (!ShaderStore.ShadersStore[name$15]) ShaderStore.ShadersStore[name$15] = shader$14;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/fluentButton/fluentButtonMaterial.js
/** @internal */
...
* @since 5.0.0
*/
var FluentButtonMaterial = class FluentButtonMaterial extends PushMaterial {
	constructor(name, scene) {
		super(name, scene);
		/**
		...
		*/
		...
		this.backFaceCulling = false;
		this._blobTexture = new Texture(Tools.GetAssetUrl(FluentButtonMaterial.BLOB_TEXTURE_URL), this.getScene(), true, false, Texture.NEAREST_SAMPLINGMODE);
	}
	needAlphaBlending() {
		return true;
	}
	...
	isReadyForSubMesh(mesh, subMesh) {
		...
		if (!subMesh.materialDefines) subMesh.materialDefines = new FluentButtonMaterialDefines();
		const defines = subMesh.materialDefines;
		const scene = this.getScene();
		if (this._isReadyForSubMesh(subMesh)) return true;
		const engine = scene.getEngine();
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/touchButton3D.js
/**
...
var TouchButton3D = class extends Button3D {
	...
	*/
	constructor(name, collisionMesh) {
		...
		*/
		...
		if (collisionMesh) this.collisionMesh = collisionMesh;
	}
	/**
	...
	*/
	set collisionMesh(collisionMesh) {
		if (this._collisionMesh) {
			...
			if (this._collisionMesh.reservedDataStore?.GUI3D) this._collisionMesh.reservedDataStore.GUI3D = {};
			this._collisionMesh.getChildMeshes().forEach((mesh) => {
				mesh.isNearPickable = false;
				if (mesh.reservedDataStore?.GUI3D) mesh.reservedDataStore.GUI3D = {};
			});
		}
	...
	*/
	set isToggleButton(value) {
		if (value === this._isToggleButton) return;
		this._isToggleButton = value;
		if (value) this.onPointerUpObservable.add(this._toggleButtonCallback);
		else {
			this.onPointerUpObservable.removeCallback(this._toggleButtonCallback);
			if (this._toggleState) this._onToggle(false);
		}
	}
	get isToggleButton() {
	...
	*/
	set isToggled(newState) {
		if (this._isToggleButton && this._toggleState !== newState) this._onToggle(newState);
	}
	get isToggled() {
	...
	*/
	...
	_getInteractionHeight(interactionPos, basePos) {
		...
		if (frontDir.length() === 0) return Vector3.Distance(interactionPos, basePos);
		const d = Vector3.Dot(basePos, frontDir);
		return Vector3.Dot(interactionPos, frontDir) - d;
	}
	/**
	* @internal
	*/
	_generatePointerEventType(providedType, nearMeshPosition, activeInteractionCount) {
		if (providedType === PointerEventTypes.POINTERDOWN || providedType === PointerEventTypes.POINTERMOVE) if (!this._isInteractionInFrontOfButton(nearMeshPosition)) return PointerEventTypes.POINTERMOVE;
		else {
		...
		if (providedType === PointerEventTypes.POINTERUP) if (activeInteractionCount == 0) return PointerEventTypes.POINTERMOVE;
		else this._isNearPressed = false;
		return providedType;
	}
	_getTypeName() {
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/touchHolographicButton.js
/**
* Class used to create a holographic button in 3D
* @since 5.0.0
*/
var TouchHolographicButton = class TouchHolographicButton extends TouchButton3D {
	_disposeTooltip() {
		this._tooltipFade = null;
		if (this._tooltipTextBlock) this._tooltipTextBlock.dispose();
		if (this._tooltipTexture) this._tooltipTexture.dispose();
	...
	*/
	set isBackplateVisible(isVisible) {
		if (this.mesh && !!this._backMaterial) {
			if (isVisible && !this._isBackplateVisible) this._backPlate.visibility = 1;
			else if (!isVisible && this._isBackplateVisible) this._backPlate.visibility = 0;
		}
	...
	*/
	constructor(name, shareMaterials = true) {
		...
		this._frontPlateDepth = .5;
		this._backPlateDepth = .04;
		this._backplateColor = new Color3(.08, .15, .55);
		this._backplateToggledColor = new Color3(.25, .4, .95);
		this._shareMaterials = shareMaterials;
		this.pointerEnterAnimation = () => {
		...
		this.pointerDownAnimation = () => {
			if (this._frontPlate && !this.isActiveNearInteraction) {
				this._frontPlate.scaling.z = this._frontPlateDepth * .2;
				this._frontPlate.position = Vector3.Forward(this._frontPlate._scene.useRightHandedSystem).scale((this._frontPlateDepth - .2 * this._frontPlateDepth) / 2);
				this._textPlate.position = Vector3.Forward(this._textPlate._scene.useRightHandedSystem).scale(-(this._backPlateDepth + .2 * this._frontPlateDepth) / 2);
			}
		};
		this.pointerUpAnimation = () => {
			if (this._frontPlate) {
		...
		this.onPointerMoveObservable.add((position) => {
			if (this._frontPlate && this.isActiveNearInteraction) {
				...
				if (this._backPlate.getWorldMatrix().decompose(scale, void 0, void 0)) {
					...
					interactionHeight = Scalar.Clamp(interactionHeight - this._backPlateDepth / 2, .2 * this._frontPlateDepth, this._frontPlateDepth);
	...
	_createNode(scene) {
		...
		SceneLoader.ImportMeshAsync(void 0, baseUrl, TouchHolographicButton.MODEL_FILENAME, scene).then((result) => {
			...
			if (this._frontMaterial) importedFrontPlate.material = this._frontMaterial;
	...
	_applyFacade(facadeTexture) {
		this._plateMaterial.emissiveTexture = facadeTexture;
		this._plateMaterial.opacityTexture = facadeTexture;
		this._plateMaterial.diffuseColor = new Color3(.4, .4, .4);
	}
	_createBackMaterial(mesh) {
	...
	_onToggle(newState) {
		if (this._backMaterial) if (newState) this._backMaterial.albedoColor = this._backplateToggledColor;
		else this._backMaterial.albedoColor = this._backplateColor;
	...
	_affectMaterial(mesh) {
		if (this._shareMaterials) {
			...
			} else this._backMaterial = this._host._touchSharedMaterials["backFluentMaterial"];
			...
			} else this._frontMaterial = this._host._touchSharedMaterials["frontFluentMaterial"];
		} else {
			this._createBackMaterial(mesh);
			this._createFrontMaterial(mesh);
		}
		...
		this._backPlate.material = this._backMaterial;
		this._textPlate.material = this._plateMaterial;
		if (!this._isBackplateVisible) this._backPlate.visibility = 0;
		if (this._frontPlate) this._frontPlate.material = this._frontMaterial;
		this._rebuildContent();
	}
	/**
	* Releases all associated resources
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/behaviors/defaultBehavior.js
/**
...
var DefaultBehavior = class {
	...
	*/
	attach(ownerMesh, draggablesMeshes, sceneUnderstandingMeshes) {
		...
		if (sceneUnderstandingMeshes) this._surfaceMagnetismBehavior.meshes = sceneUnderstandingMeshes;
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/handle/shaders/handle.vertex.js
var name$14 = "handleVertexShader";
var shader$13 = `precision highp float;attribute vec3 position;uniform vec3 positionOffset;uniform mat4 worldViewProjection;uniform float scale;void main(void) {vec4 vPos=vec4((vec3(position)+positionOffset)*scale,1.0);gl_Position=worldViewProjection*vPos;}`;
if (!ShaderStore.ShadersStore[name$14]) ShaderStore.ShadersStore[name$14] = shader$13;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/handle/shaders/handle.fragment.js
var name$13 = "handlePixelShader";
var shader$12 = `uniform vec3 color;void main(void) {gl_FragColor=vec4(color,1.0);}`;
if (!ShaderStore.ShadersStore[name$13]) ShaderStore.ShadersStore[name$13] = shader$12;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/handle/handleMaterial.js
/**
...
var HandleMaterial = class extends ShaderMaterial {
	...
	*/
	constructor(name, scene) {
		...
		*/
		this.hoverColor = new Color3(0, .467, .84);
		/**
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/gizmos/gizmoHandle.js
/**
...
var GizmoHandle = class {
	...
	*/
	constructor(gizmo, scene) {
		...
		this.node.reservedDataStore = { handle: this };
	}
	_createMaterial(positionOffset) {
		const mat = new HandleMaterial("handle", this._scene);
		if (positionOffset) mat._positionOffset = positionOffset;
		return mat;
	}
	_updateMaterial() {
		...
		if (state & 2) for (const mat of this._materials) mat.drag = true;
		else if (state & 1) for (const mat of this._materials) mat.hover = true;
	}
	/**
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/gizmos/slateGizmo.js
/**
...
var SlateGizmo = class extends Gizmo {
	...
	*/
	set attachedSlate(control) {
		...
		} else if (this._attachedSlate) this._attachedSlate._host.onPickingObservable.remove(this._pickedPointObserver);
	...
	constructor(utilityLayer) {
		...
		*/
		...
		this._renderObserver = this.gizmoLayer.originalScene.onBeforeRenderObservable.add(() => {
			if (this.attachedMesh && !this._existingSlateScale.equals(this.attachedMesh.scaling)) this.updateBoundingBox();
		});
	}
	_createNode() {
	...
	_attachedNodeChanged(value) {
		if (value) this.updateBoundingBox();
	}
	/**
	...
	*/
	updateBoundingBox() {
		if (this.attachedMesh) {
			...
			this._update();
			if (!this.attachedMesh.rotationQuaternion) this.attachedMesh.rotationQuaternion = Quaternion.RotationYawPitchRoll(this.attachedMesh.rotation.y, this.attachedMesh.rotation.x, this.attachedMesh.rotation.z);
	...
	_updateHandlesPosition() {
		...
		const center = min.add(max).scaleInPlace(.5);
	...
	_updateHandlesScaling() {
		if (this._attachedSlate && this._attachedSlate.mesh) {
			...
			for (let index = 0; index < this._corners.length; index++) this._corners[index].node.scaling.setAll(scale);
			for (let index = 0; index < this._sides.length; index++) this._sides[index].node.scaling.setAll(scale);
		}
	}
	_update() {
		super._update();
		if (!this.gizmoLayer.utilityLayerScene.activeCamera) return;
		if (this._attachedSlate && this._attachedSlate.mesh) {
			if (this.fixedScreenSize) {
				...
				for (let i = 0; i < this._corners.length; i++) this._corners[i].node.scaling.set(distanceFromCamera, distanceFromCamera, distanceFromCamera);
				for (let i = 0; i < this._sides.length; i++) this._sides[i].node.scaling.set(distanceFromCamera, distanceFromCamera, distanceFromCamera);
			}
			this._updateHandlesPosition();
		}
	}
	dispose() {
		...
		super.dispose();
		for (const corner of this._corners) corner.dispose();
		for (const side of this._sides) side.dispose();
	}
};
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/holographicSlate.js
/**
* Class used to create a holographic slate
* @since 5.0.0
*/
var HolographicSlate = class HolographicSlate extends ContentDisplay3D {
	/**
	...
	*/
	...
	set dimensions(value) {
		...
		if (value.x < this.minDimensions.x || value.y < this.minDimensions.y) {
			...
			if (this.minDimensions.x / this.minDimensions.y > newRatio) scale = this.minDimensions.x / value.x;
			else scale = this.minDimensions.y / value.y;
		}
	...
	*/
	set title(title) {
		...
		if (this._titleTextComponent) this._titleTextComponent.text = title;
	}
	get title() {
	...
	*/
	constructor(name) {
		...
		*/
		...
		this._contentDragBehavior = new PointerDragBehavior({ dragPlaneNormal: new Vector3(0, 0, -1) });
	}
	/**
	* Apply the facade texture (created from the content property).
	* This function can be overloaded by child classes
	...
	*/
	...
	_addControl(control) {
		control._host = this._host;
		if (this._host.utilityLayer) control._prepareNode(this._host.utilityLayer.utilityLayerScene);
	}
	_getTypeName() {
	...
	*/
	_positionElements() {
		...
		if (followButton && closeButton && titleBar) {
			...
			this._applyContentViewport();
			if (this._gizmo) this._gizmo.updateBoundingBox();
		}
	}
	...
	*/
	_updatePivot() {
		if (!this.mesh) return;
		const center = new Vector3(this.dimensions.x * .5, -this.dimensions.y * .5, Epsilon);
	...
	_createNode(scene) {
		...
		this._followButton.onToggleObservable.add((isToggled) => {
			...
			if (this._defaultBehavior.followBehaviorEnabled) this._defaultBehavior.followBehavior.recenter();
		});
	...
	_attachContentPlateBehavior() {
		...
		this._contentDragBehavior.onDragObservable.add((event) => {
			if (this.fitContentToDimensions) return;
	...
	*/
	resetDefaultAspectAndPose(resetAspect = true) {
		if (!this._host || !this._host.utilityLayer || !this.node) return;
		...
		if (camera) {
			...
			if (this.node.position.equalsToFloats(0, 0, 0)) this.node.position.copyFrom(camera.position).subtractInPlace(backward).subtractInPlace(pivot);
			this.node.rotationQuaternion = Quaternion.FromLookDirectionLH(backward, new Vector3(0, 1, 0));
			if (resetAspect) this.dimensions = this.defaultDimensions;
		}
	}
	/**
	* Releases all associated resources
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/meshButton3D.js
/**
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/nearMenu.js
/**
* NearMenu that displays buttons and follows the camera
* @since 5.0.0
*/
var NearMenu = class NearMenu extends TouchHolographicMenu {
	/**
	...
	*/
	...
	set isPinned(value) {
		...
		if (value) this._defaultBehavior.followBehaviorEnabled = false;
		else this._defaultBehavior.followBehaviorEnabled = true;
	}
	_createPinButton(parent) {
		const control = new TouchHolographicButton("pin" + this.name, false);
		control.imageUrl = Tools.GetAssetUrl(NearMenu._ASSETS_BASE_URL) + NearMenu._PIN_ICON_FILENAME;
		control.parent = this;
		control._host = this._host;
		...
		if (this._host.utilityLayer) {
			...
			if (control.node) control.node.parent = parent;
		}
		return control;
	}
	_createNode(scene) {
		...
		this._defaultBehavior.followBehavior.minimumDistance = .3;
		this._defaultBehavior.followBehavior.defaultDistance = .4;
		this._defaultBehavior.followBehavior.maximumDistance = .6;
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/planePanel.js
/**
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/scatterPanel.js
/**
	...
	*/
	...
	_finalProcessing() {
		...
		for (let count = 0; count < this._iteration; count++) {
			...
			for (let i = 0; i < meshes.length - 1; i++) for (let j = i + 1; j < meshes.length; j++) if (i != j) {
				meshes[j].position.subtractToRef(meshes[i].position, difference);
				difference2D.x = difference.x;
				difference2D.y = difference.y;
				const combinedRadius = cellSize;
				let distance = difference2D.lengthSquared() - radiusPaddingSquared;
				distance -= Math.min(distance, radiusPaddingSquared);
				if (distance < Math.pow(combinedRadius, 2)) {
					difference2D.normalize();
					difference.scaleInPlace((combinedRadius - Math.sqrt(distance)) * .5);
...
if (!ShaderStore.ShadersStore[name$12]) ShaderStore.ShadersStore[name$12] = shader$11;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/mrdl/shaders/mrdlSliderBar.vertex.js
var name$11 = "mrdlSliderBarVertexShader";
var shader$10 = `uniform mat4 world;uniform mat4 viewProjection;uniform vec3 cameraPosition;attribute vec3 position;attribute vec3 normal;attribute vec2 uv;
#ifdef TANGENT
attribute vec3 tangent;
#else
const vec3 tangent=vec3(0.);
...
if (!ShaderStore.ShadersStore[name$11]) ShaderStore.ShadersStore[name$11] = shader$10;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/mrdl/mrdlSliderBarMaterial.js
/** @internal */
...
*/
var MRDLSliderBarMaterial = class MRDLSliderBarMaterial extends PushMaterial {
	constructor(name, scene) {
		super(name, scene);
		/**
		...
		*/
		this.indirectDiffuse = .658;
		/**
		* Gets or sets the base albedo.
		*/
		this.albedo = new Color4(.0117647, .505882, .996078, 1);
		/**
		...
		*/
		this.leftGradientColor = new Color4(.0117647, .505882, .996078, 1);
		/**
		* Gets or sets the right gradient color.
		*/
		this.rightGradientColor = new Color4(.0117647, .505882, .996078, 1);
		/**
		...
		*/
		this.skyColor = new Color4(.0117647, .964706, .996078, 1);
		/**
		* Gets or sets the horizon color.
		*/
		this.horizonColor = new Color4(.0117647, .333333, .996078, 1);
		/**
		* Gets or sets the ground color.
		*/
		this.groundColor = new Color4(0, .254902, .996078, 1);
		/**
		...
		*/
		this.blobPosition = new Vector3(0, 0, .1);
		/**
		...
		* Gets or sets the position of the hover glow effect.
		*/
		this.blobPosition2 = new Vector3(.2, 0, .1);
		/**
		...
		* @internal
		*/
		this.globalLeftIndexTipPosition = new Vector4(.5, 0, -.55, 1);
		/**
		* @internal
		*/
		...
		* @internal
		*/
		this.globalLeftThumbTipPosition = new Vector4(.5, 0, -.55, 1);
		/**
		* @internal
		*/
		...
		* @internal
		*/
		this.globalLeftIndexMiddlePosition = new Vector4(.5, 0, -.55, 1);
		/**
		* @internal
		*/
		...
		this.alphaMode = Constants.ALPHA_DISABLE;
		this.backFaceCulling = false;
		this._blueGradientTexture = new Texture(Tools.GetAssetUrl(MRDLSliderBarMaterial.BLUE_GRADIENT_TEXTURE_URL), this.getScene(), true, false, Texture.NEAREST_SAMPLINGMODE);
	...
	isReadyForSubMesh(mesh, subMesh) {
		...
		if (!subMesh.materialDefines) subMesh.materialDefines = new MRDLSliderBarMaterialDefines();
		const defines = subMesh.materialDefines;
		const scene = this.getScene();
		if (this._isReadyForSubMesh(subMesh)) return true;
		const engine = scene.getEngine();
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/mrdl/shaders/mrdlSliderThumb.fragment.js
var name$10 = "mrdlSliderThumbPixelShader";
var shader$9 = `uniform vec3 cameraPosition;varying vec3 vPosition;varying vec3 vNormal;varying vec2 vUV;varying vec3 vTangent;varying vec3 vBinormal;varying vec4 vColor;varying vec4 vExtra1;varying vec4 vExtra2;varying vec4 vExtra3;uniform float _Radius_;uniform float _Bevel_Front_;uniform float _Bevel_Front_Stretch_;uniform float _Bevel_Back_;uniform float _Bevel_Back_Stretch_;uniform float _Radius_Top_Left_;uniform float _Radius_Top_Right_;uniform float _Radius_Bottom_Left_;uniform float _Radius_Bottom_Right_;uniform bool _Bulge_Enabled_;uniform float _Bulge_Height_;uniform float _Bulge_Radius_;uniform float _Sun_Intensity_;uniform float _Sun_Theta_;uniform float _Sun_Phi_;uniform float _Indirect_Diffuse_;uniform vec4 _Albedo_;uniform float _Specular_;uniform float _Shininess_;uniform float _Sharpness_;uniform float _Subsurface_;uniform vec4 _Left_Color_;uniform vec4 _Right_Color_;uniform float _Reflection_;uniform float _Front_Reflect_;uniform float _Edge_Reflect_;uniform float _Power_;uniform vec4 _Sky_Color_;uniform vec4 _Horizon_Color_;uniform vec4 _Ground_Color_;uniform float _Horizon_Power_;uniform sampler2D _Reflection_Map_;uniform sampler2D _Indirect_Environment_;uniform float _Width_;uniform float _Fuzz_;uniform float _Min_Fuzz_;uniform float _Clip_Fade_;uniform float _Hue_Shift_;uniform float _Saturation_Shift_;uniform float _Value_Shift_;uniform vec3 _Blob_Position_;uniform float _Blob_Intensity_;uniform float _Blob_Near_Size_;uniform float _Blob_Far_Size_;uniform float _Blob_Near_Distance_;uniform float _Blob_Far_Distance_;uniform float _Blob_Fade_Length_;uniform float _Blob_Pulse_;uniform float _Blob_Fade_;uniform sampler2D _Blob_Texture_;uniform vec3 _Blob_Position_2_;uniform float _Blob_Near_Size_2_;uniform float _Blob_Pulse_2_;uniform float _Blob_Fade_2_;uniform vec3 _Left_Index_Pos_;uniform vec3 _Right_Index_Pos_;uniform vec3 _Left_Index_Middle_Pos_;uniform vec3 _Right_Index_Middle_Pos_;uniform sampler2D _Decal_;uniform vec2 _Decal_Scale_XY_;uniform bool _Decal_Front_Only_;uniform float _Rim_Intensity_;uniform sampler2D _Rim_Texture_;uniform float _Rim_Hue_Shift_;uniform float _Rim_Saturation_Shift_;uniform float _Rim_Value_Shift_;uniform float _Iridescence_Intensity_;uniform sampler2D _Iridescence_Texture_;uniform bool Use_Global_Left_Index;uniform bool Use_Global_Right_Index;uniform vec4 Global_Left_Index_Tip_Position;uniform vec4 Global_Right_Index_Tip_Position;uniform vec4 Global_Left_Thumb_Tip_Position;uniform vec4 Global_Right_Thumb_Tip_Position;uniform vec4 Global_Left_Index_Middle_Position;uniform vec4 Global_Right_Index_Middle_Position;uniform float Global_Left_Index_Tip_Proximity;uniform float Global_Right_Index_Tip_Proximity;void Blob_Fragment_B180(
sampler2D Blob_Texture,
vec4 Blob_Info1,
vec4 Blob_Info2,
out vec4 Blob_Color)
...
if (!ShaderStore.ShadersStore[name$10]) ShaderStore.ShadersStore[name$10] = shader$9;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/mrdl/shaders/mrdlSliderThumb.vertex.js
var name$9 = "mrdlSliderThumbVertexShader";
var shader$8 = `uniform mat4 world;uniform mat4 viewProjection;uniform vec3 cameraPosition;attribute vec3 position;attribute vec3 normal;attribute vec2 uv;
#ifdef TANGENT
attribute vec3 tangent;
#else
const vec3 tangent=vec3(0.);
...
if (!ShaderStore.ShadersStore[name$9]) ShaderStore.ShadersStore[name$9] = shader$8;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/mrdl/mrdlSliderThumbMaterial.js
/** @internal */
...
*/
var MRDLSliderThumbMaterial = class MRDLSliderThumbMaterial extends PushMaterial {
	constructor(name, scene) {
		super(name, scene);
		/**
		...
		* Gets or sets the sky color.
		*/
		this.skyColor = new Color4(.0117647, .960784, .996078, 1);
		/**
		* Gets or sets the horizon color.
		*/
		this.horizonColor = new Color4(.0117647, .333333, .996078, 1);
		...
		*/
		...
		this.alphaMode = Constants.ALPHA_DISABLE;
		this.backFaceCulling = false;
		this._blueGradientTexture = new Texture(Tools.GetAssetUrl(MRDLSliderThumbMaterial.BLUE_GRADIENT_TEXTURE_URL), scene, true, false, Texture.NEAREST_SAMPLINGMODE);
		this._decalTexture = new Texture("", this.getScene());
		this._reflectionMapTexture = new Texture("", this.getScene());
		this._indirectEnvTexture = new Texture("", this.getScene());
	}
	...
	isReadyForSubMesh(mesh, subMesh) {
		...
		if (!subMesh.materialDefines) subMesh.materialDefines = new MRDLSliderThumbMaterialDefines();
		const defines = subMesh.materialDefines;
		const scene = this.getScene();
		if (this._isReadyForSubMesh(subMesh)) return true;
		const engine = scene.getEngine();
...
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "radius", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "bevelFront", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "bevelFrontStretch", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "bevelBack", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "bevelBackStretch", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "radiusTopLeft", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "radiusTopRight", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "radiusBottomLeft", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "radiusBottomRight", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "bulgeEnabled", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "bulgeHeight", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "bulgeRadius", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "sunIntensity", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "sunTheta", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "sunPhi", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "indirectDiffuse", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "albedo", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "specular", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "shininess", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "sharpness", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "subsurface", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "leftGradientColor", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "rightGradientColor", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "reflection", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "frontReflect", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "edgeReflect", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "power", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "skyColor", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "horizonColor", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "groundColor", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "horizonPower", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "width", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "fuzz", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "minFuzz", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "clipFade", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "hueShift", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "saturationShift", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "valueShift", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "blobPosition", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "blobIntensity", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "blobNearSize", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "blobFarSize", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "blobNearDistance", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "blobFarDistance", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "blobFadeLength", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "blobPulse", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "blobFade", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "blobPosition2", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "blobNearSize2", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "blobPulse2", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "blobFade2", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "blobTexture", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "leftIndexPosition", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "rightIndexPosition", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "leftIndexMiddlePosition", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "rightIndexMiddlePosition", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "decalScaleXY", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "decalFrontOnly", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "rimIntensity", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "rimHueShift", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "rimSaturationShift", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "rimValueShift", void 0);
__decorate([serialize()], MRDLSliderThumbMaterial.prototype, "iridescenceIntensity", void 0);
RegisterClass("BABYLON.GUI.MRDLSliderThumbMaterial", MRDLSliderThumbMaterial);
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/mrdl/shaders/mrdlBackplate.fragment.js
var name$8 = "mrdlBackplatePixelShader";
var shader$7 = `uniform vec3 cameraPosition;varying vec3 vPosition;varying vec3 vNormal;varying vec2 vUV;varying vec3 vTangent;varying vec3 vBinormal;varying vec4 vExtra1;varying vec4 vExtra2;uniform float _Radius_;uniform float _Line_Width_;uniform bool _Absolute_Sizes_;uniform float _Filter_Width_;uniform vec4 _Base_Color_;uniform vec4 _Line_Color_;uniform float _Radius_Top_Left_;uniform float _Radius_Top_Right_;uniform float _Radius_Bottom_Left_;uniform float _Radius_Bottom_Right_;uniform float _Rate_;uniform vec4 _Highlight_Color_;uniform float _Highlight_Width_;uniform vec4 _Highlight_Transform_;uniform float _Highlight_;uniform float _Iridescence_Intensity_;uniform float _Iridescence_Edge_Intensity_;uniform vec4 _Iridescence_Tint_;uniform sampler2D _Iridescent_Map_;uniform float _Angle_;uniform bool _Reflected_;uniform float _Frequency_;uniform float _Vertical_Offset_;uniform vec4 _Gradient_Color_;uniform vec4 _Top_Left_;uniform vec4 _Top_Right_;uniform vec4 _Bottom_Left_;uniform vec4 _Bottom_Right_;uniform float _Edge_Width_;uniform float _Edge_Power_;uniform float _Line_Gradient_Blend_;uniform float _Fade_Out_;void FastLinearTosRGB_B353(
vec4 Linear,
out vec4 sRGB)
{sRGB.rgb=sqrt(clamp(Linear.rgb,0.0,1.0));sRGB.a=Linear.a;}
...
if (!ShaderStore.ShadersStore[name$8]) ShaderStore.ShadersStore[name$8] = shader$7;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/mrdl/shaders/mrdlBackplate.vertex.js
var name$7 = "mrdlBackplateVertexShader";
var shader$6 = `uniform mat4 world;uniform mat4 viewProjection;uniform vec3 cameraPosition;attribute vec3 position;attribute vec3 normal;attribute vec3 tangent;uniform float _Radius_;uniform float _Line_Width_;uniform bool _Absolute_Sizes_;uniform float _Filter_Width_;uniform vec4 _Base_Color_;uniform vec4 _Line_Color_;uniform float _Radius_Top_Left_;uniform float _Radius_Top_Right_;uniform float _Radius_Bottom_Left_;uniform float _Radius_Bottom_Right_;uniform float _Rate_;uniform vec4 _Highlight_Color_;uniform float _Highlight_Width_;uniform vec4 _Highlight_Transform_;uniform float _Highlight_;uniform float _Iridescence_Intensity_;uniform float _Iridescence_Edge_Intensity_;uniform vec4 _Iridescence_Tint_;uniform sampler2D _Iridescent_Map_;uniform float _Angle_;uniform bool _Reflected_;uniform float _Frequency_;uniform float _Vertical_Offset_;uniform vec4 _Gradient_Color_;uniform vec4 _Top_Left_;uniform vec4 _Top_Right_;uniform vec4 _Bottom_Left_;uniform vec4 _Bottom_Right_;uniform float _Edge_Width_;uniform float _Edge_Power_;uniform float _Line_Gradient_Blend_;uniform float _Fade_Out_;varying vec3 vPosition;varying vec3 vNormal;varying vec2 vUV;varying vec3 vTangent;varying vec3 vBinormal;varying vec4 vExtra1;varying vec4 vExtra2;void Object_To_World_Pos_B314(
vec3 Pos_Object,
out vec3 Pos_World)
{Pos_World=(world*vec4(Pos_Object,1.0)).xyz;}
...
if (!ShaderStore.ShadersStore[name$7]) ShaderStore.ShadersStore[name$7] = shader$6;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/mrdl/mrdlBackplateMaterial.js
/** @internal */
...
*/
var MRDLBackplateMaterial = class MRDLBackplateMaterial extends PushMaterial {
	constructor(name, scene) {
		super(name, scene);
		/**
		...
		* Gets or sets the line color of the backplate.
		*/
		this.lineColor = new Color4(.2, .262745, .4, 1);
		/**
		* Gets or sets the top left Radii Multiplier.
		*/
		this.radiusTopLeft = 1;
		...
		* Gets or sets the color of the highlights on the backplate line.
		*/
		this.highlightColor = new Color4(.239216, .435294, .827451, 1);
		/**
		* Gets or sets the width of the highlights on the backplate line.
		*/
		...
		*/
		this.gradientColor = new Color4(.74902, .74902, .74902, 1);
		/**
		* Gets or sets the top left gradient color effect on the backplate.
		*/
		this.topLeftGradientColor = new Color4(.00784314, .294118, .580392, 1);
		/**
		* Gets or sets the top right gradient color effect on the backplate.
		*/
		this.topRightGradientColor = new Color4(.305882, 0, 1, 1);
		/**
		* Gets or sets the bottom left gradient color effect on the backplate.
		*/
		this.bottomLeftGradientColor = new Color4(.133333, .258824, .992157, 1);
		/**
		* Gets or sets the bottom right gradient color effect on the backplate.
		*/
		this.bottomRightGradientColor = new Color4(.176471, .176471, .619608, 1);
		/**
		...
		* Gets or sets the edge width of the backplate.
		*/
		this.edgeLineGradientBlend = .5;
		this.alphaMode = Constants.ALPHA_DISABLE;
		this.backFaceCulling = false;
		this._iridescentMapTexture = new Texture(Tools.GetAssetUrl(MRDLBackplateMaterial.IRIDESCENT_MAP_TEXTURE_URL), this.getScene(), true, false, Texture.NEAREST_SAMPLINGMODE);
	}
	needAlphaBlending() {
		return false;
	}
	...
	isReadyForSubMesh(mesh, subMesh) {
		...
		if (!subMesh.materialDefines) subMesh.materialDefines = new MRDLBackplateMaterialDefines();
		const defines = subMesh.materialDefines;
		const scene = this.getScene();
		if (this._isReadyForSubMesh(subMesh)) return true;
		const engine = scene.getEngine();
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/slider3D.js
var SLIDER_MIN = 0;
var SLIDER_MAX = 100;
var SLIDER_VAL = 50;
var SLIDER_STEP = 0;
...
*/
var Slider3D = class Slider3D extends Control3D {
	/**
	* Creates a new slider
	* @param name defines the control name
	...
	*/
	get mesh() {
		if (this.node) return this._sliderThumb;
		return null;
	}
	/** Gets or sets minimum value */
	get minimum() {
	...
	set value(value) {
		...
		if (this._sliderThumb) this._sliderThumb.position.x = this._convertToPosition(this.value);
		this.onValueChangedObservable.notifyObservers(this._value);
	}
	get start() {
		if (!this.node) return -SLIDER_SCALING / 2;
	...
	*/
	...
	_createNode(scene) {
		...
		sliderBackplate.scaling = new Vector3(1, .5, .8);
		const baseUrl = Tools.GetAssetUrl(Slider3D.MODEL_BASE_URL);
		SceneLoader.ImportMeshAsync(void 0, baseUrl, Slider3D.MODEL_FILENAME, scene).then((result) => {
			...
			if (this._sliderBackplateVisible) {
				...
				sliderBackplateModel.scaling.z = .2;
				sliderBackplateModel.parent = sliderBackplate;
				if (this._sliderBackplateMaterial) sliderBackplateModel.material = this._sliderBackplateMaterial;
				this._sliderBackplate = sliderBackplateModel;
			}
			if (sliderBarModel) {
				sliderBarModel.parent = sliderBackplate;
				sliderBarModel.position.z = -.1;
				sliderBarModel.scaling = new Vector3(SLIDER_SCALING - SLIDER_MARGIN, .04, .3);
				if (this._sliderBarMaterial) sliderBarModel.material = this._sliderBarMaterial;
				this._sliderBar = sliderBarModel;
			}
			if (sliderThumbModel) {
				sliderThumbModel.parent = sliderBackplate;
				sliderThumbModel.isPickable = true;
				sliderThumbModel.position.z = -.115;
				sliderThumbModel.scaling = new Vector3(.025, .3, .6);
				sliderThumbModel.position.x = this._convertToPosition(this.value);
				sliderThumbModel.addBehavior(this._createBehavior());
				if (this._sliderThumbMaterial) sliderThumbModel.material = this._sliderThumbMaterial;
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/spherePanel.js
/**
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/stackPanel3D.js
/**
	...
	*/
	...
	_arrangeChildren() {
		...
		for (const child of this._children) {
			...
			if (this._isVertical) height += extendSize.y;
			else width += extendSize.x;
		}
		if (this._isVertical) height += (controlCount - 1) * this.margin / 2;
		else width += (controlCount - 1) * this.margin / 2;
		let offset;
		if (this._isVertical) offset = -height;
		else offset = -width;
		let index = 0;
		for (const child of this._children) {
			if (!child.mesh) continue;
...
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/touchMeshButton3D.js
/**
...
if (!ShaderStore.ShadersStore[name$6]) ShaderStore.ShadersStore[name$6] = shader$5;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/mrdl/shaders/mrdlBackglow.vertex.js
var name$5 = "mrdlBackglowVertexShader";
var shader$4 = `uniform mat4 world;uniform mat4 viewProjection;uniform vec3 cameraPosition;attribute vec3 position;attribute vec3 normal;attribute vec2 uv;attribute vec3 tangent;uniform float _Bevel_Radius_;uniform float _Line_Width_;uniform bool _Absolute_Sizes_;uniform float _Tuning_Motion_;uniform float _Motion_;uniform float _Max_Intensity_;uniform float _Intensity_Fade_In_Exponent_;uniform float _Outer_Fuzz_Start_;uniform float _Outer_Fuzz_End_;uniform vec4 _Color_;uniform vec4 _Inner_Color_;uniform float _Blend_Exponent_;uniform float _Falloff_;uniform float _Bias_;varying vec3 vNormal;varying vec2 vUV;void main()
...
if (!ShaderStore.ShadersStore[name$5]) ShaderStore.ShadersStore[name$5] = shader$4;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/mrdl/mrdlBackglowMaterial.js
/** @hidden */
...
var MRDLBackglowMaterial = class MRDLBackglowMaterial extends PushMaterial {
	constructor(name, scene) {
		super(name, scene);
		/**
	...
	isReadyForSubMesh(mesh, subMesh) {
		...
		if (!subMesh.materialDefines) subMesh.materialDefines = new MRDLBackglowMaterialDefines();
		const defines = subMesh.materialDefines;
		const scene = this.getScene();
		if (this._isReadyForSubMesh(subMesh)) return true;
		const engine = scene.getEngine();
...
if (!ShaderStore.ShadersStore[name$3]) ShaderStore.ShadersStore[name$3] = shader$2;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/mrdl/mrdlFrontplateMaterial.js
/** @hidden */
...
var MRDLFrontplateMaterial = class MRDLFrontplateMaterial extends PushMaterial {
	constructor(name, scene) {
		super(name, scene);
		/**
		...
		*/
		this.edgeColor = new Color4(.53, .53, .53, 1);
		/**
	...
	isReadyForSubMesh(mesh, subMesh) {
		...
		if (!subMesh.materialDefines) subMesh.materialDefines = new MRDLFrontplateMaterialDefines();
		const defines = subMesh.materialDefines;
		const scene = this.getScene();
		if (this._isReadyForSubMesh(subMesh)) return true;
		const engine = scene.getEngine();
...
`;
if (!ShaderStore.ShadersStore[name$2]) ShaderStore.ShadersStore[name$2] = shader$1;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/mrdl/shaders/mrdlInnerquad.vertex.js
var name$1 = "mrdlInnerquadVertexShader";
...
`;
if (!ShaderStore.ShadersStore[name$1]) ShaderStore.ShadersStore[name$1] = shader;
//#endregion
//#region node_modules/@babylonjs/gui/3D/materials/mrdl/mrdlInnerquadMaterial.js
...
var MRDLInnerquadMaterial = class MRDLInnerquadMaterial extends PushMaterial {
	constructor(name, scene) {
		super(name, scene);
		/**
		* Gets or sets the color of the innerquad.
		*/
		this.color = new Color4(1, 1, 1, .05);
		/**
	...
	isReadyForSubMesh(mesh, subMesh) {
		...
		if (!subMesh.materialDefines) subMesh.materialDefines = new MRDLInnerquadMaterialDefines();
		const defines = subMesh.materialDefines;
		const scene = this.getScene();
		if (this._isReadyForSubMesh(subMesh)) return true;
		const engine = scene.getEngine();
...
__decorate([serialize()], MRDLInnerquadMaterial.prototype, "color", void 0);
__decorate([serialize()], MRDLInnerquadMaterial.prototype, "radius", void 0);
__decorate([serialize()], MRDLInnerquadMaterial.prototype, "fixedRadius", void 0);
__decorate([serialize()], MRDLInnerquadMaterial.prototype, "glowFraction", void 0);
__decorate([serialize()], MRDLInnerquadMaterial.prototype, "glowMax", void 0);
__decorate([serialize()], MRDLInnerquadMaterial.prototype, "glowFalloff", void 0);
RegisterClass("BABYLON.GUI.MRDLInnerquadMaterial", MRDLInnerquadMaterial);
//#endregion
//#region node_modules/@babylonjs/gui/3D/controls/MRTK3/touchHolographicButton.js
/**
* Class used to create the mrtkv3 button
*/
var TouchHolographicButton$1 = class TouchHolographicButton$1 extends TouchButton3D {
	_disposeTooltip() {
		this._tooltipFade = null;
		if (this._tooltipTextBlock) this._tooltipTextBlock.dispose();
		if (this._tooltipTexture) this._tooltipTexture.dispose();
	...
	*/
	set tooltipText(text) {
		...
		if (!this._tooltipFade) {
			const rightHandedScene = this._backPlate._scene.useRightHandedSystem;
			this._tooltipMesh = CreatePlane("", { size: 1 }, this._backPlate._scene);
			this._tooltipMesh.position = Vector3.Down().scale(.7).add(Vector3.Forward(rightHandedScene).scale(-.15));
			this._tooltipMesh.isPickable = false;
			this._tooltipMesh.parent = this._frontPlateCollisionMesh;
			this._tooltipTexture = AdvancedDynamicTexture.CreateForMesh(this._tooltipMesh);
			const tooltipBackground = new Rectangle();
			tooltipBackground.height = .25;
			tooltipBackground.width = .8;
	...
	*/
	constructor(name, shareMaterials = true) {
		...
		*/
		this.plateMaterialColor = new Color3(.4, .4, .4);
		/**
		...
		*/
		this.innerQuadToggledColor = new Color4(.5197843, .6485234, .9607843, .6);
		/**
		* Gets or sets the color for innerQuadMaterial for when it is hovered.
		*/
		this.innerQuadHoverColor = new Color4(1, 1, 1, .05);
		/**
		* Gets or sets the color for innerQuadMaterial for when it is toggled and hovered.
		*/
		this.innerQuadToggledHoverColor = new Color4(.5197843, .6485234, .9607843, 1);
		this._isBackplateVisible = true;
		this._shareMaterials = true;
		this._shareMaterials = shareMaterials;
		this.pointerEnterAnimation = () => {
			if (this._frontPlate && this._textPlate && !this.isToggleButton) this._performEnterExitAnimation(1);
			if (this.isToggleButton && this._innerQuadMaterial) if (this.isToggled) this._innerQuadMaterial.color = this.innerQuadToggledHoverColor;
			else this._innerQuadMaterial.color = this.innerQuadHoverColor;
		};
		this.pointerOutAnimation = () => {
			if (this._frontPlate && this._textPlate && !this.isToggleButton) this._performEnterExitAnimation(-.8);
			if (this.isToggleButton && this._innerQuadMaterial) this._onToggle(this.isToggled);
		};
		this.pointerDownAnimation = () => {};
		this.pointerUpAnimation = () => {};
		this._pointerClickObserver = this.onPointerClickObservable.add(() => {
			if (this._frontPlate && this._backGlow && !this.isActiveNearInteraction) this._performClickAnimation();
			if (this.isToggleButton && this._innerQuadMaterial) this._onToggle(this.isToggled);
		});
		...
		this._toggleObserver = this.onToggleObservable.add((isToggled) => {
			if (isToggled) this._innerQuadMaterial.color = this.innerQuadToggledColor;
			else this._innerQuadMaterial.color = this.innerQuadColor;
		});
	}
	_getTypeName() {
		return "TouchHolographicButton";
	...
	_rebuildContent() {
		let content;
		if (this._getAspectRatio() <= 1) content = this._alignContentVertically();
		else content = this._alignContentHorizontally();
	...
	_alignContentHorizontally() {
		...
		if (this._text) {
			...
			if (this._subtext) {
				...
				textContainer.addRowDefinition(.5);
				textContainer.addRowDefinition(.5);
				...
				subtext.fontSize = this.textSizeInPixels * .75;
	...
	_createNode(scene) {
		...
		if (backGlowMesh) this._backPlate.addChild(backGlowMesh);
		const tn = new TransformNode(`${this.name}_root`, scene);
		this._backPlate.setParent(tn);
		this.collisionMesh = collisionMesh;
		this.collidableFrontDirection = this._backPlate.forward.negate();
	...
	_createBackPlate(scene) {
		...
		backPlateMesh.scaling.z = .2;
		const baseUrl = Tools.GetAssetUrl(TouchHolographicButton$1.MRTK_ASSET_BASE_URL);
		SceneLoader.ImportMeshAsync(void 0, baseUrl, TouchHolographicButton$1.BACKPLATE_MODEL_FILENAME, scene).then((result) => {
			...
			if (this._backMaterial) backPlateModel.material = this._backMaterial;
	...
	_createFrontPlate(scene) {
		...
		const baseUrl = Tools.GetAssetUrl(TouchHolographicButton$1.MRTK_ASSET_BASE_URL);
		SceneLoader.ImportMeshAsync(void 0, baseUrl, TouchHolographicButton$1.FRONTPLATE_MODEL_FILENAME, scene).then((result) => {
			...
			frontPlateModel.position = Vector3.Forward(scene.useRightHandedSystem).scale(-.5);
			frontPlateModel.parent = collisionPlate;
			if (this.isToggleButton) frontPlateModel.visibility = 0;
			if (this._frontMaterial) frontPlateModel.material = this._frontMaterial;
	...
	_createInnerQuad(scene) {
		...
		const baseUrl = Tools.GetAssetUrl(TouchHolographicButton$1.MRTK_ASSET_BASE_URL);
		SceneLoader.ImportMeshAsync(void 0, baseUrl, TouchHolographicButton$1.INNERQUAD_MODEL_FILENAME, scene).then((result) => {
			...
			if (this._innerQuadMaterial) innerQuadModel.material = this._innerQuadMaterial;
			this._innerQuad = innerQuadModel;
		});
		return innerQuadMesh;
	}
	_createBackGlow(scene) {
		if (this.isToggleButton) return;
		...
		const baseUrl = Tools.GetAssetUrl(TouchHolographicButton$1.MRTK_ASSET_BASE_URL);
		SceneLoader.ImportMeshAsync(void 0, baseUrl, TouchHolographicButton$1.BACKGLOW_MODEL_FILENAME, scene).then((result) => {
			...
			if (this._backGlowMaterial) backGlowModel.material = this._backGlowMaterial;
	...
	_performClickAnimation() {
		...
		const animations = [
			...
			},
			{
				...
				keys: [
					...
					},
					{
						frame: 20,
						values: [
							Vector3.Forward(this._collisionPlate._scene.useRightHandedSystem).scale(this.frontPlateDepth / 2).z,
							0,
							0
						]
					},
			...
			},
			{
				...
				keys: [
					...
					{
						frame: 40,
						values: [this.frontPlateDepth, .0054]
					},
					{
						frame: 45,
		...
		for (const animation of animations) {
			...
			const animkeyFrames = [];
			for (const key of animation.keys) animkeyFrames.push({
				frame: key.frame,
				value: key.values[0],
	...
	_performEnterExitAnimation(speedRatio) {
		...
		const animations = [{
			...
			keys: [{
				...
				frame: 40,
				values: [
					Vector3.Forward(this._textPlate._scene.useRightHandedSystem).scale(-.15).z,
					0,
					0
				]
			}]
	...
	_createBackMaterial(mesh) {
		...
		this._backMaterial.lineWidth = .02;
	}
	_createFrontMaterial(mesh) {
	...
	_createBackGlowMaterial(mesh) {
		const glowRadius = this.radius + .04;
	...
	_createInnerQuadMaterial(mesh) {
		...
		if (this.isToggleButton) this._innerQuadMaterial.color = this.innerQuadColor;
	}
	_createPlateMaterial(mesh) {
	...
	_affectMaterial(mesh) {
		if (this._shareMaterials) {
			...
			} else this._backMaterial = this._host._touchSharedMaterials["mrdlBackplateMaterial"];
			...
			} else this._frontMaterial = this._host._touchSharedMaterials["mrdlFrontplateMaterial"];
			...
			} else this._backGlowMaterial = this._host._touchSharedMaterials["mrdlBackglowMaterial"];
			...
			} else this._innerQuadMaterial = this._host._touchSharedMaterials["mrdlInnerQuadMaterial"];
		} else {
			this._createBackMaterial(mesh);
			this._createFrontMaterial(mesh);
			this._createBackGlowMaterial(mesh);
		...
		if (!this._isBackplateVisible) this._backPlate.visibility = 0;
		if (this._frontPlate) this._frontPlate.material = this._frontMaterial;
		if (this._backGlow) this._backGlow.material = this._backGlowMaterial;
		if (this._innerQuad) this._innerQuad.material = this._innerQuadMaterial;
		this._rebuildContent();
	}
	/**
	* Releases all associated resources
...
*/
TouchHolographicButton$1.MRTK_ASSET_BASE_URL = "https://assets.babylonjs.com/core/MRTK/";
/**
* File name for the frontplate model.
*/
TouchHolographicButton$1.FRONTPLATE_MODEL_FILENAME = "mrtk-fluent-frontplate.glb";
/**
* File name for the backplate model.
*/
TouchHolographicButton$1.BACKPLATE_MODEL_FILENAME = "mrtk-fluent-backplate.glb";
/**
* File name for the backglow model.
*/
TouchHolographicButton$1.BACKGLOW_MODEL_FILENAME = "mrtk-fluent-button.glb";
/**
* File name for the innerquad model.
*/
TouchHolographicButton$1.INNERQUAD_MODEL_FILENAME = "SlateProximity.glb";
//#endregion
//#region node_modules/@babylonjs/gui/3D/gui3DManager.js
/**
* Class used to manage 3D user interface
* @see https://doc.babylonjs.com/features/featuresDeepDive/gui/gui3D
*/
var GUI3DManager = class GUI3DManager {
	...
	set controlScaling(newScale) {
		if (this._customControlScaling !== newScale && newScale > 0) {
			...
			this._rootContainer.children.forEach((control) => {
				...
				if (newScale !== 1) control._isScaledByManager = true;
			});
		}
	}
	...
	*/
	...
	_doPicking(pi) {
		...
		if (pickingInfo) this.onPickingObservable.notifyObservers(pickingInfo.pickedMesh);
		if (!pickingInfo || !pickingInfo.hit) {
			this._handlePointerOut(pointerId, pi.type === PointerEventTypes.POINTERUP);
			return false;
		}
		if (pickingInfo.pickedPoint) this.onPickedPointChangedObservable.notifyObservers(pickingInfo.pickedPoint);
		...
		if (!!control && !control._processObservables(pi.type, pickingInfo.pickedPoint, pickingInfo.originMesh?.position || null, pointerId, buttonIndex)) {
			if (pi.type === PointerEventTypes.POINTERMOVE) {
				if (this._lastControlOver[pointerId]) this._lastControlOver[pointerId]._onPointerOut(this._lastControlOver[pointerId]);
				delete this._lastControlOver[pointerId];
			}
		}
		if (pi.type === PointerEventTypes.POINTERUP) {
			...
			if (pointerEvent.pointerType === "touch" || pointerEvent.pointerType === "xr" && this._scene.getEngine().hostInformation.isMobile) this._handlePointerOut(pointerId, false);
		}
		return true;
	}
	/**
	...
	*/
	dispose() {
		...
		for (const materialName in this._sharedMaterials) {
			if (!Object.prototype.hasOwnProperty.call(this._sharedMaterials, materialName)) continue;
			this._sharedMaterials[materialName].dispose();
		}
		this._sharedMaterials = {};
		for (const materialName in this._touchSharedMaterials) {
			if (!Object.prototype.hasOwnProperty.call(this._touchSharedMaterials, materialName)) continue;
		...
		if (this._utilityLayer) this._utilityLayer.dispose();
	}
};
GUI3DManager.MRTK_REALISTIC_SCALING = .032;
//#endregion
export { AbstractButton3D, AdvancedDynamicTexture, AdvancedDynamicTextureInstrumentation, BaseGradient, BaseSlider, Button, Button3D, Checkbox, CheckboxGroup, ColorPicker, Container, Container3D, Control, Control3D, CornerHandle, CylinderPanel, DisplayGrid, Ellipse, FluentBackplateMaterial, FluentButtonMaterial, FluentMaterial, FluentMaterialDefines, FocusableButton, FrameGraphGUITask, GUI3DManager, GizmoHandle, Grid, HandMenu, HandleMaterial, HandleState, HolographicBackplate, HolographicButton, HolographicSlate, Image, ImageBasedSlider, ImageScrollBar, InputPassword, InputText, InputTextArea, KeyPropertySet, Line, LinearGradient, MRDLBackplateMaterial, MRDLSliderBarMaterial, MRDLSliderThumbMaterial, MathTools, Matrix2D, Measure, MeshButton3D, MultiLine, MultiLinePoint, NearMenu, NodeRenderGraphGUIBlock, PlanePanel, RadialGradient, RadioButton, RadioGroup, Rectangle, ScatterPanel, ScrollBar, ScrollViewer, SelectionPanel, SelectorGroup, SideHandle, SlateGizmo, Slider, Slider3D, SliderGroup, SpherePanel, StackPanel, StackPanel3D, Style, TextBlock, TextWrapper, TextWrapping, ToggleButton, TouchButton3D, TouchHolographicButton, TouchHolographicButton$1 as TouchHolographicButtonV3, TouchHolographicMenu, TouchMeshButton3D, ValueAndUnit, Vector2WithInfo, Vector3WithInfo, VirtualKeyboard, VolumeBasedPanel, XmlLoader, name };
