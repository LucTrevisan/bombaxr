...
import { b as RichTypeString, t as FlowGraphBlock, u as RichTypeAny } from "./flowGraphBlock-Cu7z1xvN.js";
...
var FlowGraphFunctionReferenceBlock = class extends FlowGraphBlock {
	...
	_updateOutputs(context) {
		...
		if (object && functionName) {
			...
			if (func && typeof func === "function") this.output.setValue(func.bind(contextValue), context);
		}
	}
	getClassName() {
...
//#endregion
export { FlowGraphFunctionReferenceBlock as t };

//# sourceMappingURL=flowGraphFunctionReferenceBlock-Dgv6u0nT.js.map