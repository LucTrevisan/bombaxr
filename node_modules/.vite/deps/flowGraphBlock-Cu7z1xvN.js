...
//#endregion
//#region node_modules/@babylonjs/core/FlowGraph/flowGraphRichTypes.js
/**
...
RichTypeQuaternion.typeTransformer = (value) => {
	if (value.getClassName && value.getClassName() === "Vector4") return Quaternion.FromArray(value.asArray());
	else if (value.getClassName && value.getClassName() === "Vector3") return Quaternion.FromEulerVector(value);
	else if (value.getClassName && value.getClassName() === "Matrix") return Quaternion.FromRotationMatrix(value);
	return value;
};
...
function defaultValueSerializationFunction(key, value, serializationObject) {
	...
	else if (typeof value !== "object") serializationObject[key] = value;
	else throw new Error(`Could not serialize value ${value}`);
}
/**
...
function defaultValueParseFunction(key, serializationObject, assetsContainer, scene) {
	...
	if (isMeshClassName(className)) {
		...
		if (nodes.length === 0) nodes = scene.transformNodes.filter((m) => intermediateValue.id ? m.id === intermediateValue.id : m.name === intermediateValue.name);
	...
	else if (Array.isArray(intermediateValue)) finalValue = intermediateValue.reduce((acc, val) => {
...
//#endregion
//#region node_modules/@babylonjs/core/FlowGraph/flowGraphDataConnection.js
/**
...
//#endregion
export { FlowGraphInteger as A, RichTypeVector4 as C, getRichTypeFromValue as D, getRichTypeByFlowGraphType as E, FlowGraphMatrix2D as O, RichTypeVector3 as S, getRichTypeByAnimationType as T, RichTypeMatrix3D as _, defaultValueParseFunction as a, RichTypeString as b, FlowGraphTypes as c, RichTypeBoolean as d, RichTypeColor3 as f, RichTypeMatrix2D as g, RichTypeMatrix as h, FlowGraphConnectionType as i, FlowGraphMatrix3D as k, RichType as l, RichTypeFlowGraphInteger as m, FlowGraphDataConnection as n, defaultValueSerializationFunction as o, RichTypeColor4 as p, FlowGraphConnection as r, needsPathConverter as s, FlowGraphBlock as t, RichTypeAny as u, RichTypeNumber as v, getAnimationTypeByFlowGraphType as w, RichTypeVector2 as x, RichTypeQuaternion as y };

//# sourceMappingURL=flowGraphBlock-Cu7z1xvN.js.map