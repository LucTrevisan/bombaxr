import { t as Clamp, u as WithinEpsilon } from "./math.scalar.functions-7SKaVf9_.js";
	...
	*/
	...
	_compute(firstNormal, alignTangentsWithPath = false) {
		...
		for (let i = 1; i < l; i++) {
			...
			if (!this._raw) if (this._normals[i].length() === 0) {
...
var Curve3 = class Curve3 {
	...
	*/
	static ArcThru3Points(first, second, third, steps = 32, closed = false, fullCircle = false) {
		...
		const a = -.5 * len2_sq * dot1 / len4_sq;
		const b = -.5 * len3_sq * dot2 / len4_sq;
		const c = -.5 * len1_sq * dot3 / len4_sq;
...
//#endregion
export { Orientation as a, Curve3 as i, Arc2 as n, Path2 as o, BezierCurve as r, Path3D as s, Angle as t };

//# sourceMappingURL=math.path-BzHoeMp5.js.map