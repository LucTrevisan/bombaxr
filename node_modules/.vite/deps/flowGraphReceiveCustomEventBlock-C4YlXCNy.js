...
var FlowGraphReceiveCustomEventBlock = class extends FlowGraphEventBlock {
	constructor(config) {
		...
		this.config = config;
		this.initPriority = 1;
		for (const key in this.config.eventData) this.registerDataOutput(key, this.config.eventData[key].type);
	}
...
//#endregion
export { FlowGraphReceiveCustomEventBlock as t };

//# sourceMappingURL=flowGraphReceiveCustomEventBlock-C4YlXCNy.js.map