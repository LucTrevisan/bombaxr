...
import { o as IsWindowObjectExist } from "./precisionDate-CuAZ8wH-.js";
import { A as getStateObject, C as _isRenderingStateCompiled, D as createRawShaderProgram, E as createPipelineContext, H as _getGlobalDefines, O as createShaderProgram, S as _finalizePipelineContext, T as _setProgram, V as _ConcatenateShader, b as _createShaderProgram, d as InternalTexture, k as deleteStateObject, n as GetExponentOfTwo, o as AbstractEngine, v as Effect, w as _preparePipelineContext, x as _executeWhenRenderingStateIsCompiled, y as resetCachedPipeline } from "./tools.functions-Bl8BhFJU.js";
import { t as DataBuffer } from "./dataBuffer-C9X6MZ-y.js";
//#region node_modules/@babylonjs/core/Materials/drawWrapper.functions.js
/**
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGL/webGLShaderProcessors.js
/** @internal */
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGL/webGL2ShaderProcessors.js
...
var WebGL2ShaderProcessor = class {
	...
	postProcessor(code, defines, isFragment) {
		...
		} else if (defines.indexOf("#define MULTIVIEW") !== -1) return "#extension GL_OVR_multiview2 : require\nlayout (num_views = 2) in;\n" + code;
		return code;
	}
};
//#endregion
//#region node_modules/@babylonjs/core/Meshes/WebGL/webGLDataBuffer.js
/** @internal */
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGL/webGLHardwareTexture.js
/** @internal */
...
//#endregion
//#region node_modules/@babylonjs/core/Materials/Textures/textureHelper.functions.js
/**
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/thinEngine.js
var thinEngine_exports = /* @__PURE__ */ __exportAll({ ThinEngine: () => ThinEngine });
/**
...
var ThinEngine = class ThinEngine extends AbstractEngine {
	...
	*/
	...
	_initGLContext() {
		...
		if (this._caps.astc) this._gl.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR = this._caps.astc.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR;
		...
		if (this._gl.getShaderPrecisionFormat) {
			...
			if (vertexhighp && fragmenthighp) this._caps.highPrecisionShaderSupported = vertexhighp.precision !== 0 && fragmenthighp.precision !== 0;
		}
	...
	*/
	unBindFramebuffer(texture, disableGenerateMipMaps = false, onBeforeUnbind) {
		...
		if (!webglRTWrapper.disableAutomaticMSAAResolve) if (texture.isMulti) this.resolveMultiFramebuffer(texture);
		else this.resolveFramebuffer(texture);
		if (!disableGenerateMipMaps) if (texture.isMulti) this.generateMipMapsMultiFramebuffer(texture);
	...
	*/
	...
	_createVertexBuffer(data, usage) {
		...
		if (typeof data !== "number") if (data instanceof Array) {
	...
	*/
	...
	_normalizeIndexData(indices) {
		...
		if (this._caps.uintIndices) if (indices instanceof Uint32Array) return indices;
		else {
	...
	*/
	_deletePipelineContext(pipelineContext) {
		...
		if (webGLPipelineContext && webGLPipelineContext.program) {
			...
			if (this._gl) this._gl.deleteProgram(webGLPipelineContext.program);
		}
	}
	/**
	* @internal
	...
	*/
	_createInternalTexture(size, options, delayGPUTextureCreation = true, source = 0) {
		...
		if (isDepthTexture && this.webGLVersion > 1) if (comparisonFunction === 0) {
	...
	*/
	static isSupported() {
		...
		if (this._IsSupported === null) try {
			...
			this._IsSupported = (tempcanvas.getContext("webgl") || tempcanvas.getContext("experimental-webgl")) != null && !!window.WebGLRenderingContext;
		} catch (e) {
	...
	*/
	static get HasMajorPerformanceCaveat() {
		if (this._HasMajorPerformanceCaveat === null) try {
			const tempcanvas = AbstractEngine._CreateCanvas(1, 1);
			this._HasMajorPerformanceCaveat = !(tempcanvas.getContext("webgl", { failIfMajorPerformanceCaveat: true }) || tempcanvas.getContext("experimental-webgl", { failIfMajorPerformanceCaveat: true }));
		} catch (e) {
...
//#endregion
export { IsDepthTexture as a, WebGL2ShaderProcessor as c, HasStencilAspect as i, IsWrapper as l, thinEngine_exports as n, WebGLHardwareTexture as o, GetTypeForDepthTexture as r, WebGLDataBuffer as s, ThinEngine as t };

//# sourceMappingURL=thinEngine-89RB5ABk.js.map